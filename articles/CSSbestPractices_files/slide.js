(function (h, g, k) {
    h.SPR || (h.SPR = {provide: function (a, b) {d[a] || (d[a] = b, "function" === typeof d[a].init && d[a].init())}});
    var d = h.SPR;
    d.provide("Common", {random: function () {return Math.floor(Math.random() * 8675309)}, isArray: function (a) {return Array.isArray ? Array.isArray(a) : Object.prototype.toString.call(a) === "[object Array]"}, isString: function (a) {return Object.prototype.toString.call(a) === "[object String]"}, hasOwnProperty: function (a, b) {return Object.prototype.hasOwnProperty.call(a, b)}});
    d.provide("DOM", {init: function () {
        ...
        b.src = a;
        d.DOM.onReady(function () {setTimeout(function () {d.DOM.$("HEAD")[0].appendChild(b)}, 1)});
        return b
        ...
        return a
    }, top: function (a) {return a ? a.y ? a.y : a.offsetTop + d.DOM.top(a.offsetParent) : 0}, left: function (a) {return a ? a.x ? a.x : a.offsetLeft + d.DOM.left(a.offsetParent) : 0}, height: function (a) {
        return Math.max(a.scrollHeight || 0, a.offsetHeight || 0, a.clientHeight ||
            0)
    }, width: function (a) {return Math.max(a.scrollWidth || 0, a.offsetWidth || 0, a.clientWidth || 0)}, scroll: function () {
        var a = 0;
        ...
        return{w: a, h: b}
    }, getsupportedprop: function (a) {for (var b = g.documentElement, c = 0; c < a.length; c++)if (typeof b.style[a[c]] == "string")return a[c]},
        $: function (a) {
            var b = [], c, d = 0, f;
            if (!a)return[];
    ...
    d.provide("QS", {escape: function (a) {return encodeURIComponent(a)}, unescape: function (a) {return decodeURIComponent(a)}, encode: function (a, b) {
        var c = d.QS, e = [];
        ...
        else if (typeof a === "object" && a !== null && !("nodeType"in a))for (f in a)Object.prototype.hasOwnProperty.call(a, f) && (b ? e.push(c.encode(a[f], b + "[" + f + "]")) : e.push(c.encode(a[f], f)));
        else e.push(c.escape(b) + "=" + c.escape(a));
        return e.join("&")
    }, decode: function (a) {
    ...
    d.provide("API", {callbacks: {}, jsonp: function (a, b, c, e, f) {
        ...
        j.callbacks[i] = function (a) {
            setTimeout(function () {h.parentNode.removeChild(h)}, 0);
            e(a);
            try {delete j.callbacks[i]}
            catch (b) {j.callbacks[i] = null}
        }
    }});
    d.provide("XD", {callbacks: {}, xport: null, init: function () {
    ...
    }, PM: {init: function () {d.DOM.attachEvent(h, "message", function (a) {d.XD.recv(a.data)})},
        send: function (a, b, c) {a.postMessage(c, g.location.protocol + "//" + (b.host || b))}}, Fragment: {init: function () {
        function a() {
        ...
        b = /.*&\d{11,15}data:/;
        a()
    }, delay: 100, queue: [], send: function (a) {d.XD.Fragment.queue.push(arguments)}, setHash: function (a, b, c) {
        var d;
        d = (b.hash || "").replace(/^#+/, "");
        b = b.location ||
            "";
    ...
    d.provide("Cookie", {patterns: {}, get: function (a) {
        ...
        g.cookie = a + "=" + b + d + "; path=/"
    }, del: function (a) {d.Cookie.set(a, "", new Date(1982, 5, 13))}});
    d.provide("FX", {init: function () {
        ...
        d.FX.Tween.prototype = {func: function (a, b, c, d) {return c * a / d + b}, setTime: function (a) {
            ...
            this.fixTime();
            this.update()
        }, update: function () {this.setPosition(this.getPosition(this._time))}, onEnterFrame: function () {
            var a = this;
            if (a.isPlaying) {
                a.nextFrame();
                setTimeout(function () {a.onEnterFrame()}, 0)
            }
        }, nextFrame: function () {this.setTime((this.getTimer() - this._startTime) / 1E3)}, stop: function () {this.isPlaying = false}, fixTime: function () {this._startTime = this.getTimer() - this._time * 1E3}, getTimer: function () {return(new Date).getTime() - this._time}}
    ...
    }, Easing: {none: function (a, b, c, d) {return c * a / d + b}, ease: function (a, b, c, d) {return(a = a / (d / 2)) < 1 ? c / 2 * a * a * a * a * a + b : c / 2 * ((a = a - 2) * a * a * a * a + 2) + b}, bounce: function (a, b, c, d) {
        var f = 0.867;
    ...
    d.provide("de", {api: "feeds.delicious.com", apiPath: "/v2/json/urlinfo/data", collect: function (a) {
        ...
        d.API.jsonp(b.api, b.apiPath,
            {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "de", data: b})}, "callback")
    }});
    d.provide("dg", {api: "services.digg.com", apiPath: "/stories/", collect: function (a) {
        var b = d.dg, c = d.Reach.config;
        d.API.jsonp(b.api, b.apiPath, {type: "javascript", link: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "dg", data: b})}, "callback")
    }});
    d.provide("fb", {api: "graph.facebook.com", apiPath: "/fql", collect: function (a) {
        var b =
            d.fb, c = d.Reach.config;
        d.API.jsonp(b.api, b.apiPath, {q: 'SELECT url,total_count,share_count,comment_count,like_count,click_count,commentsbox_count FROM link_stat WHERE url in ("' + c.url + '")'}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "fb", data: b})}, "callback")
    }});
    ...
    d.provide("li", {api: "www.linkedin.com", apiPath: "/countserv/count/share", collect: function (a) {
        ...
        d.API.jsonp(b.api, b.apiPath, {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "li", data: b})}, "callback")
    }});
    d.provide("rd", {api: "www.reddit.com", apiPath: "/api/info.json", collect: function (a) {
        var b = d.rd, c = d.Reach.config;
        d.API.jsonp(b.api, b.apiPath, {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "rd", data: b})}, "jsonp")
    }});
    d.provide("pi", {api: "api.pinterest.com", apiPath: "/v1/urls/count.json",
        collect: function (a) {
            var b = d.pi, c = d.Reach.config;
            d.API.jsonp(b.api, b.apiPath, {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "pi", data: b})}, "callback")
        }});
    d.provide("su", {api: "www.stumbleupon.com", apiPath: "/services/1.01/badge.getinfo", collect: function (a) {
        var b = d.su, c = d.Reach.config;
        d.API.jsonp(b.api, b.apiPath, {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "su", data: b})})
    }});
    d.provide("tw",
        {api: "urls.api.twitter.com", apiPath: "/1/urls/count.json", collect: function (a) {
            var b = d.tw, c = d.Reach.config;
            d.API.jsonp(b.api, b.apiPath, {url: c.url}, function (b) {d.API.jsonp("cc.simplereach.com", "/event", {event: "s", url: c.url, cid: a.id, pid: c.pid, sn: "tw", data: b})}, "callback")
        }});
    d.provide("Reach", {api: "cc.simplereach.com", cdn: "d8rk54i4mohrb.cloudfront.net", config: {}, init: function () {
        ...
        if (!e.pid || !e.url || !e.date)try {console.log("SPR-ERROR: Please provide pid, url and date in the configuration")}
        catch (f) {}
    ...
    d.provide("Slide", {domain: d.Reach.cdn, api: "slide.simplereach.com", template: "/slides/slide.html?" +
        ...
        function a(a) {d.XD.on(a, function (c) {b[a](c)})}
        ...
        d.Slide.config =
            c
    }, enable: function (a) {d.DOM.onReady(function () {d.Slide.remoteInit(a)})}, localInit: function () {
        ...
        if (a.isHost) {
            ...
            b.on(b.$("#simplereach-slide-close-button")[0],
                "click", function () {a.close({detach: true})});
            b.on(b.$("#simplereach-slide-open-button")[0], "click", function () {a.open()});
            b.on(b.$("#simplereach-slide-help-button")[0], "click", function () {a.help()});
        ...
        if (b.isHost) {
            ...
            b.close({detach: true}, function () {b.optedOut || b.open()})
        }
        else b.xd("setOptOut",
                {})
    }, show_fb: function () {
        if (!(navigator.appVersion.indexOf("MSIE 7.") !== -1 || navigator.appVersion.indexOf("MSIE 8.") !== -1)) {
            ...
            if (!a.isHost) {
                ...
                h.fbAsyncInit = function () {h.FB.init({appId: "200433859985229", status: true, cookie: true, xfbml: true})}
            }
        }
    },
        show_tw: function () {
            ...
            else for (var b = 0; b < a.hl.st.length; b = b + 1)a["show_" + a.hl.st[b]]()
        }, slideIn: function () {
            var a = d.Slide;
            if (a.isHost) {
                if (!a.inMotion) {
