...
(function () {
    ...
    var M = q, N = t, oa = M[F], pa = function () {}, qa = /\[native code\]/, O = function (a, b, c) {return a[b] = a[b] || c}, ra = function (a) {
        for (var b = 0; b < this[C]; b++)if (this[b] === a)return b;
        return-1
    }, sa = /&/g, ta = /</g, ua = />/g, va = /"/g, wa = /'/g, xa = function (a) {return s(a)[x](sa, "&amp;")[x](ta, "&lt;")[x](ua, "&gt;")[x](va, "&quot;")[x](wa, "&#39;")}, R = function () {
        var a;
        if ((a = ba.create) && qa[w](a))a = a(m);
        else {
            a = {};
            for (var b in a)a[b] = j
        }
        return a
    }, S = function (a, b) {return ba.prototype.hasOwnProperty[ka](a, b)}, T = function (a, b) {
        var a = a || {}, c;
        for (c in a)S(a,
            c) && (b[c] = a[c])
    }, U = O(M, "gapi", {});
    ...
    O(V, "I", 0);
    O(V, "hel", 10);
    var Da = function (a) {return!V.dpo ? ya(a, "jsh", V.h) : V.h}, Ea = function (a) {return O(O(V, "H", R()), a, R())};
    ...
    var Ma = function (a) {return a[K](",")[x](/\./g, "_")[x](/-/g, "_")}, Na = function (a, b) {
    ...
    var Sa = function (a) {
        ...
        catch (b) {V.hel--, Ta("debug_error", function () {q.___jsl.hefn(b)})}
        else return a()
    };
    U.load = function (a, b) {return Sa(function () {return Ta(a, b)})};
    var Ua = function () {return q.___jsl = q.___jsl || {}}, Va = function (a) {
        var b = Ua();
        b[a] = b[a] || [];
        return b[a]
    }, Y = function (a) {
        ...
        b.cfg = !a && b.cfg || {};
        return b.cfg
    }, Wa = function (a) {return"object" === typeof a && /\[native code\]/[w](a[u])}, Xa = function (a, b) {if (b)for (var c in b)b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !Wa(a[c]) && !Wa(b[c]) ? Xa(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = Wa(b[c]) ? [] : {}, Xa(a[c], b[c])) : a[c] = b[c])}, $ = function (a) {
        if (!a)return Y();
        for (var a =
    ...
    var Ya = ["left", "right"], Za = "inline bubble none only pp vertical-bubble".split(" "), $a = function (a) {
        ...
        }, ab = function () {return q[F].origin || q[F].protocol + "//" + q[F].host}, bb = function (a, b, c, e) {
            if (a)a = $a(a);
            else a:{
                a = e || "canonical";
                b = t[ia]("link");
    ...
    var Cb, Db = /(?:^|\s)g-((\S)*)(?:$|\s)/, Eb = R(), Fb = O(V, "FW", []), Hb = function (a, b) {Gb(j, n, a, b)}, Gb = function (a, b, c, e) {
        W("ps0", l);
        var c = ("string" === typeof c ? t[fa](c) : c) || N, d, f = N.documentMode;
        if (c.querySelectorAll && (!f || 8 < f)) {
            if (e)d = [e];
            else if (qa[w](ba.keys))d = ba.keys(Eb);
            else {
                f = [];
    ...
    }, Ib = function () {return n}, Kb = function () {};
    O(U, "platform", {}).go = Hb;
    Ib = function (a) {
    ...
    Kb = function (a, b) {
        var c = function () {Ca(e, "remove", "de")}, e = function (e) {
    ...
    Ka[u]([X.o, function (a, b, c) {
        ...
        if ("explicit" != $("parsetags")) {
            ...
            if (c) {
                var D = c[X.b];
                D && (r = function () {M.setTimeout(D, 0)}, delete c[X.b])
            }
            if ("complete" !== N[ga])try {Gb(j, l)}
            catch (z) {}
            var ha = function () {Gb(r, l)};
            if ("complete" === N[ga])ha();
            else {
                var Z = n, E = function () {if (!Z)return Z = l, ha[J](this, arguments)};
                M.addEventListener ? (M.addEventListener("load", E, n), M.addEventListener("DOMContentLoaded", E, n)) : M.attachEvent &&
                    (M.attachEvent("onreadystatechange", function () {"complete" === N[ga] && E[J](this, arguments)}), M.attachEvent("onload", E))
            }
        }
    }]);
