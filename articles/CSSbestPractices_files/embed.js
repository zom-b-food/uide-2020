var DISQUS = function (a) {
    var h = {AssertionError: function (a) {this.message = a}};
    h.AssertionError.prototype.toString = function () {return"Assertion Error: " + (this.message || "[no message]")};
    h.assert = function (a, e) {if (!a)throw new h.AssertionError(e);};
    var e = [];
    h.define = function (k, j) {
        typeof k === "function" && (j = k, k = "");
        for (var d = k.split("."), c = d.shift(), f = h, r = (j || function () {return{}}).call({overwrites: function (c) {
            c.__overwrites__ = !0;
            return c
        }}, a); c;)f = f[c] ? f[c] : f[c] = {}, c = d.shift();
        for (var q in r)r.hasOwnProperty(q) &&
        (r.__overwrites__ || f[q] !== null && h.assert(!f.hasOwnProperty(q), "Unsafe attempt to redefine existing module with " + q), f[q] = r[q], e.push(function (c, d) {return function () {delete c[d]}}(f, q)));
        return f
    };
    h.use = function (a) {return h.define(a)};
    h.cleanup = function () {for (var a = 0; a < e.length; a++)e[a]()};
    return h
}(this);
DISQUS.define(function (a, h) {
    ...
    DISQUS.each = function (d, c) {
        ...
        if (isNaN(f))for (var e in d)d.hasOwnProperty(e) && c(d[e], e, d);
        else if (a)a.call(d,
            c);
        else for (a = 0; a < f; a++)c(d[a], a, d)
    };
    DISQUS.extend = function (d) {
        DISQUS.each(Array.prototype.slice.call(arguments, 1), function (c) {for (var f in c)d[f] = c[f]});
        return d
    };
    DISQUS.serializeArgs = function (d) {
        var c = [];
        DISQUS.each(d, function (d, a) {d !== h && c.push(a + (d !== null ? "=" + encodeURIComponent(d) : ""))});
        return c.join("&")
    };
    DISQUS.isString = function (d) {return Object.prototype.toString.call(d) === "[object String]"};
    ...
    DISQUS.require = function (d, c, f, a, h) {
        function j(b) {if (b.type == "load" || /^(complete|loaded)$/.test(b.target.readyState))a && a(), n && clearTimeout(n), DISQUS.bean.remove(b.target, s, j)}
    ...
    DISQUS.requireSet = function (d, c, f) {
        var a = d.length;
        DISQUS.each(d, function (d) {DISQUS.require(d, {}, c, function () {--a === 0 && f()})})
    };
...
DISQUS.define(function (a, h) {
    ...
    DISQUS.settings.get = function (d, c) {
        ...
        if (f.values && !f.values.length) {
            var e = {};
            DISQUS.each(f.values, function (c, d) {e[c] = d});
            return e[a]
        }
        return a
    };
    ...
    DISQUS.api = function (d, c) {
        ...
        else DISQUS.once("loader.onDefaultChannelReady", function () {DISQUS.api(d, c)})
    };
    ...
    DISQUS.extend = function () {
        ...
        arguments.length <= 1 ? (d = DISQUS, c = [arguments[0] || {}]) : (d = arguments[0] || {}, c = Array.prototype.slice.call(arguments,
            1));
        DISQUS.each(c, function (c) {DISQUS.each(c, function (c, a) {d[a] = c})});
        return d
    };
    DISQUS.getGuid = function () {return k++};
    ...
    DISQUS.ready = function (a) {
        ...
        if (DISQUS.status == "ready")a();
        else DISQUS.once("loader.onFilesReady", function () {a()});
    ...
    DISQUS.window = {getSize: function () {return typeof a.innerWidth == "number" ? [a.innerWidth, a.innerHeight] : e.documentElement ? [e.documentElement.clientWidth || e.body.clientWidth, e.documentElement.clientHeight || e.body.clientHeight] : [-1, -1]}, getScrollPosition: function () {
...
(function (a) {
    ...
    var e = 1, k = {}, j = {}, d = /over|out/, c = /[^\.]*(?=\..*)\.|.*/, f = /\..*/, r = ((a.document || {}).documentElement || {}).addEventListener, q = r ? "addEventListener" : "attachEvent", y = function (a, b) {return a.__uid = b || a.__uid || e++}, m = function (a) {
        a = y(a);
        return k[a] = k[a] || {}
    }, s = r ? function (a, b, c, d) {a[d ? "addEventListener" : "removeEventListener"](b, c, !1)} : function (a, b, c, d, g) {
    ...
    }, b = function (a, b, c, d, g) {return function (i) {if (d ? d.apply(this, arguments) : r || i && i.propertyName == "_on" + c || !i)b.apply(a, Array.prototype.slice.call(arguments, i ? 0 : 1).concat(g))}}, p = function (a, d, g, e) {
        var h =
        ...
        l = r || l;
        if (h == "unload")var w = g, g = function () {t(a, h, g) && w()};
        ...
        return a
    }, u = function (a, b, c) {return function (d) {for (var g = typeof a == "string" ? c(a, this) : a, i = d.target; i && i != this; i = i.parentNode)for (var e = g.length; e--;)if (g[e] == i)return b.apply(i, arguments)}}, v = function (a, b, c, d, g) {
        if (typeof b == "object" && !c)for (var i in b)b.hasOwnProperty(i) && v(a, i, b[i]);
        else {
            i = typeof c == "string";
        ...
        if (typeof d == "function")o(a, i, d);
        else if (j)o(a, b);
        else for (g in o = i ? o : z, b = h && i, i = i ? d || l[i] || i : l, i)i.hasOwnProperty(g) && (o(a, b || g, i[g]), delete i[g]);
        return a
    }, C = r ? function (b, c, g) {
        evt = document.createEvent(b ? "HTMLEvents" : "UIEvents");
        evt[b ? "initEvent" : "initUIEvent"](c, !0, !0, a, 1);
        g.dispatchEvent(evt)
    } : function (a, b, c) {a ? c.fireEvent("on" + b, document.createEventObject()) : c["_on" + b]++}, A = function (a, b, c) {
        var g = m(b), d;
        y(a);
        g = c ? g[c] : g;
    ...
    g.preventDefault = function (a) {return function () {a.preventDefault ? a.preventDefault() : a.returnValue = !1}};
    g.stopPropagation = function (a) {return function () {a.stopPropagation ? a.stopPropagation() : a.cancelBubble = !0}};
    var i = {click: 1, dblclick: 1, mouseup: 1, mousedown: 1, contextmenu: 1, mousewheel: 1, DOMMouseScroll: 1, mouseover: 1, mouseout: 1, mousemove: 1, selectstart: 1, selectend: 1, keydown: 1, keypress: 1, keyup: 1, orientationchange: 1, touchstart: 1, touchmove: 1, touchend: 1, touchcancel: 1, gesturestart: 1, gesturechange: 1,
        ...
        for (e = h.length; e--;) {
            ...
            else if (!g && a[q])C(j, b, a);
            else for (d in l)l.hasOwnProperty(d) && l[d].apply(a, [!1].concat(g))
        }
        return a
    }};
...
(function (a, h) {
    ...
    function c(a) {return G.g(a) || G.s(a, a.replace(P, "\\$1"))}
    ...
    var s, n, b, p, t, u, v, z, C, A, g, i = h.documentElement, o = /#([\w\-]+)/, l = /\.[\w\-]+/g, w = /^#([\w\-]+$)/, J = /^\.([\w\-]+)$/, K = /^([\w\-]+)$/, L = /^([\w]+)?\.([\w\-]+)$/,
        M = /\s*([\s\+\~>])\s*/g, E = /[\s\>\+\~]/, B = /(?![\s\w\-\/\?\&\=\:\.\(\)\!,@#%<>\{\}\$\*\^'"]*\])/, N = RegExp("(" + E.source + ")" + B.source, "g"), O = RegExp(E.source + B.source), P = /([.*+?\^=!:${}()|\[\]\/\\])/g, F = RegExp(/^([a-z0-9]+)?(?:([\.\#]+[\w\-\.#]+)?)/.source + "(" + /\[([\w\-]+)(?:([\|\^\$\*\~]?\=)['"]?([ \w\-\/\?\&\=\:\.\(\)\!,@#%<>\{\}\$\*\^]+)["']?)?\]/.source + ")?(" + /:([\w\-]+)(\(['"]?(\w+)['"]?\))?/.source + ")?"), Q = {" ": function (a) {return a && a !== i && a.parentNode}, ">": function (a, b) {
            return a && a.parentNode == b.parentNode &&
                a.parentNode
        }, "~": function (a) {return a && a.previousSibling}, "+": function (a, b, c, g) {
            if (!a)return!1;
            c = j(a);
            g = j(b);
            return c && g && c == g && c
        }};
    e.prototype = {g: function (a) {return this.c[a] || void 0}, s: function (a, b) {return this.c[a] = b}};
    var D = new e, G = new e, x = new e, H = new e, I = "compareDocumentPosition"in i ? function (a, b) {return(b.compareDocumentPosition(a) & 16) == 16} : "contains"in i ? function (a, b) {
        b = b == h || b == window ? i : b;
...
(function () {
    DISQUS.extend({bean: bean.noConflict(), qwery: qwery.noConflict(), throttle: function (a, h, e, k) {
        ...
        function j(a) {
            d && clearTimeout(d);
            d = setTimeout(function () {e(a, c)}, k)
        }

        var d, c;
        c = function () {DISQUS.bean.remove(a, h, j)};
...
DISQUS.define("ga", function (a) {
    var h, e = function (e) {h ? h(e) : a._gaq.push(e)}, k = {component: 1, "package": 2, forum: 3, version: 4, userType: 5};
    return{setCaller: function (a) {h = a}, setAccount: function (a) {e(["_setAccount", a])}, setCustomVar: function (a, d) {e(["_setCustomVar", k[a], a, d])}, trackPageview: function () {e(["_trackPageview"])}, trackEvent: function (a, d, c) {e(["_trackEvent", d, a, c, 1])}, setDomainName: function (a) {e(["_setDomainName", a])}}
});
DISQUS.define("juggler", function (a) {
    ...
    return{load: function (d) {
        a.location.href.slice(0, 5) == "https" ? h = function () {} : (e = d.url, DISQUS.each(j, function (a) {k[a] = d[a]}), k.imp = f, k.prev_imp = DISQUS.cookies.read("__jid"), DISQUS.cookies.create("__jid", f, {expiresIn: 18E5}), h = function (a) {
            DISQUS.each(k, function (c, d) {a[d] = k[d]});
            DISQUS.require(e,
                a, !1)
        }, DISQUS.each(c, function (a) {h(a)}))
    }, emit: function (a, e) {
        DISQUS.each(d, function (a) {if (e[a] != null)throw"Error: cannot overwrite event context '" + a + "'";});
        e.event = a;
        h == null ? c.push(e) : h(e)
    }, impId: f}
});
(function (a) {
    function h(a, b) {return a.hasAttribute ? a.hasAttribute(b) : a.getAttribute(b) !== null}
    ...
    function c(a) {
        if (!(typeof p != "function" && typeof a != "function")) {
            ...
            b.config.callbacks = {};
            b.config.page = {};
            b.each(c, function (a, c) {b.config.callbacks[c] = []});
            try {(a || p).call(b.config)}
            catch (d) {}
            b.each(b.config.callbacks, function (a, d) {a.length !== 0 && b.each(a, function (a) {b.bind(c[d], a)})});
    ...
    function f() {
        ...
        }, function (c, d) {a[d] != null && b.settings.set(c, a[d])});
        ...
        b.config && b.config.page && (b.config.page.remote_auth_s3 !=
            null && b.settings.set("request.sso.data", b.config.page.remote_auth_s3), b.config.page.api_key != null && b.settings.set("forum.apiKey", b.config.page.api_key), b.each(c, function (a, c) {b.config.page[c] != null && b.settings.set(a, b.config.page[c])}))
    }
    ...
    function r() {
        ...
        typeof w == "function" && b.bind("thread.onReady", function () {w(a.disqus_callback_params || null)});
    ...
    function q(a) {return Date.UTC(a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate(), a.getUTCHours(), a.getUTCMinutes(), a.getUTCSeconds(), a.getUTCMilliseconds())}
    ...
    function y() {
        ...
        b.once("thread.bottomViewed", function () {b.comm.Default.recover().log("viewed:comments", 1)});
    ...
    function m() {
        function a(b, c, d, e, g, f) {return'<img width="' + b + '" height="' + c + '" alt="' + e + '" src="data:image/' + d + ";base64," + g + '"' + (f ? 'style="' + f + '"' : "") + "/>"}

        b.jsonData = {ready: !1};
        var c;
        b.require(b.config.json_url, b.config.page, !0, null, function () {c.innerHTML = 'There was a problem loading Disqus. For more information, please visit <a href="http://status.disqus.com">status.disqus.com</a>.'});
        ...
        e.appendChild(c);
        y();
        b.ready(function () {b.initThread(function () {c.style.display = "none"})})
    }

    function s(c) {
        function d() {b.trigger("loader.onDefaultChannelReady")}
        ...
        if (b.browser.mobile && !b.jsonData.forum.mobile_theme_disabled)k = b.jsonData.forum.template.mobile.css, m = b.jsonData.forum.template.mobile.url, b.states.isMobile = !0;
        else if (r)k = r.styles, m = r.source;
    ...
    b.settings.add("disqus.developer", {type: "bool"}).add("disqus.preview",
        {type: "obj", rule: function (a) {return a != null && typeof a.source == "string" && typeof a.styles == "string"}}).add("thread.category", {type: ["str", "int"]}).add("thread.slug", {type: "str"}).add("thread.title", {type: "str"}).add("thread.url", {type: "str"}).add("thread.identifier", {type: ["str", "int"]}).add("thread.postsPerPage", {type: ["str", "int"]}).add("thread.moderatePosts", {type: "str", values: ["all", "none", "anon"]}).add("thread.skipAuthRequest", {type: "bool"}).add("thread.sort", {type: "str", values: {oldest: 1, newest: 2,
    ...
    b.extend({cache: {postboxBusy: {}, buttonsToRestore: [], popupProfileCache: {}, popupStatusCache: {}, toggledReplies: {}, postSharing: {}, realtime: {interval: null, ongoing_request: null, prev_script: null, last_checked: null, newPosts: []}}, states: {edit: {}, realtime: !1, noThirdPartyCookies: null, useLoginWindow: !1, loginDisabled: !1, metaViewport: function () {
        ...
        v.push(a);
        b.defer(function () {return b.resettable}, function () {
        ...
        function e() {
            var c, d;
            if (b.isReady) {if (h && clearInterval(h), n.getElementById(b.settings.get("ui-fluid")), c = n.getElementsByTagName("iframe"), d = n.getElementById("dsq-content"))for (var f = 0, g = c.length; f < g; f++)c[f].style.width = d.offsetWidth}
        ...
        try {b.browser.ie6 && n.execCommand("BackgroundImageCache", !1, !0)}
        catch (j) {}
        ...
        b.defer(function () {
            ...
            b.once("thread.topViewed", function () {m()})
        })
    }
    });
    c();
    ...
    (function () {
        function c(a, f) {
            var g = j(e)[1];
            if (e && d(g))return b.ready(function () {b.trigger("thread.topViewed")}), typeof f == "function" ? f() : !0;
            return !1
        }
