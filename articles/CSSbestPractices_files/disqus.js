DISQUS.define("strings", function () {
    var b = {}, d = function () {this.value = (this.ie = DISQUS.isBrowser("ie")) ? [] : ""};
    d.prototype = {put: function (b) {this.ie ? this.value.push(b) : this.value += b}, esc: function (b) {return b}, compile: function () {
        if (this.ie)this.value = this.value.join("");
        return this.value
    }};
    return{translations: b, get: function (f) {return b[f] || f}, interpolate: function (b, a) {
        return b.replace(/%\(\w+\)s/g, function (b) {
            b = b.slice(2, -2);
            if (a[b] !== void 0)b = a[b].toString();
            else throw"Key " + b + " not found in context";
            return b
        })
    }, pluralize: function (b, a, g) {return b != 1 ? g || "s" : a || ""}, trim: function (b) {
        for (var b = b.replace(/^\s\s*/, ""), a = /\s/, g = b.length; a.test(b.charAt(--g)););
        return b.slice(0, g + 1)
    }, capitalize: function (b) {return b.charAt(0).toUpperCase() + b.slice(1)}, isUTF8: function (b) {
...
DISQUS.define("dtpl", function () {
    var b = function () {};
    b.prototype = {
        container: function () {return this._container}, textareaContainer: function () {return this._textareaContainer}, show: function () {
            var a = this - fluid();
    ...
    var d = function (a, b) {
        ...
        c.rpc = DISQUS.comm.Reply.create(e, a, function () {
            ...
            c.rpcReady = !0;
            c.focusCalled && setTimeout(function () {c.focus()}, 0)
        });
    ...
    d.get = function (a) {return d.instances[a]};
    DISQUS.extend(d.prototype, b.prototype, {focus: function () {this.rpcReady ? this.rpc.focus() : this.focusCalled = !0}, render: function (a) {
        var b = this.id;
        if (typeof a === "string") {
    ...
    var f = function (a, b) {
        ...
        c.rpc = DISQUS.comm.Edit.create(e, a, function () {c.rpc.focus()});
        c._container = b;
    ...
    f.get = function (a) {return f.instances[a]};
    ...
    DISQUS.once("thread.onReady", function () {
        ...
        a.context.switches.embed_labs && DISQUS.requireSet(a.labs.files, !0, function () {DISQUS.trigger("labs.onReady")})
    });
    DISQUS.once("loader.onActionsReady", function () {
        DISQUS.dtpl.actions.fire("mentions.render", DISQUS.jsonData.posts);
        DISQUS.bind("loader.onDataReady", function () {DISQUS.dtpl.actions.fire("mentions.render", DISQUS.jsonData.posts)})
    });
    ...
    return{getAction: function (a, b) {
        ...
        function e(b) {return a.getAttribute("data-dsq-" + b)}

        var f =
            a.getAttribute("data-dsq-action"), d = DISQUS.jsonData.posts[a.getAttribute("data-dsq-comment")] || null, k = DISQUS.jsonData.request;
        if (b.type != "click") {if (b.type == "change" && f == "thread:sort")return c("thread.sort", a.value)}
        else switch (f) {
            case "media:expand":
    ...
    }, append: function (a, b) {a.innerHTML = b}, replaceHtml: function (a, b) {a.innerHTML = b}, getGuestFields: function (a) {
        function b(c) {return DISQUS.nodes.get("#" + c + (a ? "-" + a : ""))}
...
DISQUS.define("dtpl.actions", function () {
    ...
    function d(a, b, c) {
        ...
        try {return a.apply({}, b)}
        catch (e) {return window.console && window.console.log && (c && window.console.log("Exception in " + c), window.console.log(e), typeof printStackTrace !== "undefined" && window.console.log(printStackTrace({e: e}).join("\n"))), !1}
    }

    function f(a, b) {
        if (j[a])if (typeof b === "undefined")return delete j[a],
            !0;
        else DISQUS.lang.forEach(j[a], function (c, e) {if (b.guid && b.guid == c.guid)return delete j[a][e], !0});
        return!1
    }
    ...
    function g(q, b) {return!!a(q, b)}

    function c(a, b, c) {return!!j[a] || (b ? !1 : g(a, c))}
    ...
    function e() {
        ...
        j[q] && DISQUS.lang.forEach(j[q], function (a) {e = e && !!d(a, b, q)});
        g(q, f) && e && d(a(q, f), b, q);
        return!1
    }

    function i(a) {
        var b = function (b) {return"#" + a + (b ? "-" + b : "")};
    ...
    function k(a, b) {
        ...
        else if (a.attributes)return!!a.attributes[b];
        return!1
    }

    function l(a, b, c) {if (b = b ? c == "up" ? b.previousSibling : b.nextSibling : a.firstChild) {do if (k(b, "data-dsq-username"))return b; while (b = c == "up" ? b.previousSibling : b.nextSibling)}}

    var o = {}, j = {}, h = null, p = 0, s = ["1.0", "1.1"], u = s[s.length - 1];
    b("__.comments.reply.media.upload", function (a) {e("comments.reply.media.upload.onLoadingStart", a)});
    b("__.comments.reply.media.upload.onResponse", function (a, b) {
        if (a &&
            a.constructor === Array)for (var c = a.length - 1; c >= 0; --c)e("comments.reply.media.upload.onLoadingEnd", b), e("comments.reply.media.upload.onSuccess", a[c], b);
        else a && a.success && a.media ? (b = b || "", c = DISQUS.comm.Upload.recover(b), a.forum_id = DISQUS.jsonData.forum.id, a.thread_id = DISQUS.jsonData.thread.id, a.id = b, c.media("set", a), e("comments.reply.media.upload.onLoadingEnd", b), e("comments.reply.media.upload.onSuccess", a.media, b)) : a.silence || (a.message && e("message.error", a.message, a.title || "Error"), e("comments.reply.media.upload.onLoadingEnd",
            b))
    });
    ...
    b("message.error", function (a, b) {DISQUS.popup.popModal(a, b || DISQUS.strings.get("Error"))});
    b("message.error.onField", function (a, b) {
        if (DISQUS.jsonData.forum.revert_new_login_flow)e("message.error", DISQUS.strings.get(a), DISQUS.strings.get("Oops..."));
        else if (b) {
    ...
    b("comments.validate", function (a) {
        DISQUS.comm.Reply.recover(a).validate(function (b) {
            b ? DISQUS.comm.ensureLoggedIn(function () {
                e("comments.send",
                    a)
            }, "postas", {onGuest: function () {e("comments.send", a, null, {fields: DISQUS.dtpl.getGuestFields(null)})}}) : (e("message.error", DISQUS.strings.get("Please enter a comment to post.")), e("private.setLoadingButton"))
        })
    });
    b("auth.login", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()})});
    b("auth.disqus", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "disqus")});
    b("auth.twitter", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "twitter")});
    b("auth.yahoo",
        function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "yahoo")});
    b("auth.openid", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "openid")});
    b("auth.google", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "google")});
    b("auth.facebook", function () {DISQUS.comm.ensureLoggedIn(function () {DISQUS.redraw()}, "facebook")});
    b("auth.sso", function () {
        var a = window.open(DISQUS.config.sso.url, "ssoWindow", "location=0,status=0,width=" + (DISQUS.config.sso.width || 800) + ",height=" +
            (DISQUS.config.sso.height || 400)), b = setInterval(function () {DISQUS.window.isClosed(a) && (clearInterval(b), window.location.reload())}, 500)
    });
    ...
    b("__.comments.insert.onSuccess", function (a, b) {DISQUS.dtpl.actions.fire("comments.insert.onSuccess", a, b)});
    b("comments.insert.onSuccess", function () {});
    b("comments.blacklist", function (a, b) {
        ...
        }), f < 1)alert(DISQUS.strings.get("Please select something to add to the blacklist."));
        else {
            if (c.user)c.user = "username:" + c.user;
            DISQUS.api("blacklists/add", {data: c, type: "POST", success: function () {DISQUS.popup.close(null, !0)}, failure: function () {
    ...
    b("comments.outline", function (a) {
        ...
        b && (DISQUS.nodes.addClass(b, "dsq-comment-outline"), setTimeout(function () {DISQUS.nodes.removeClass(b, "dsq-comment-outline")}, 3E3))
    });
    ...
    b("comments.send", function (a, b, c) {
        if (!DISQUS.cache.postboxBusy[a || null]) {
            ...
            var f = DISQUS.comm.Reply.recover(a), c = c || {}, d = function (b) {
                try {return+(DISQUS.cache.postSharing[a || null][b] || 0)}
                catch (c) {return 0}
    ...
    b("comments.send.onSuccess", function (a, b) {
        ...
        a.message.fb_callback && a.message.fb_callback[0] && DISQUS.FB.init(function () {DISQUS.FB.streamPublish("", a.message.fb_callback[1])});
        e("private.setLoadingButton");
        DISQUS.trigger("comment.onCreate", {id: a.message.id, text: a.message.post_meta.message})
    });
    b("comments.showUserVotes", function (a) {DISQUS.request.get(DISQUS.jsonData.urls.show_user_votes, {post_id: a}, !0)});
    b("comments.highlight", function (a) {DISQUS.api("posts/highlight", {data: {post: a}, type: "POST", success: function (a) {DISQUS.dtpl.actions.fire("comments.highlight.onSuccess", a[0])}})});
    b("comments.highlight.onSuccess", function () {});
    b("comments.unhighlight", function (a) {
        DISQUS.api("posts/unhighlight", {data: {post: a},
            type: "POST", success: function (a) {DISQUS.dtpl.actions.fire("comments.unhighlight.onSuccess", a[0])}})
    });
    ...
    b("captcha.init", function (a) {
        ...
        DISQUS.addJob(function () {return!!window.Recaptcha}, a)
    });
    b("captcha.open", function (a) {
        function b() {
            ...
            DISQUS.events.add(e, "keypress", function (a) {(a.keyCode || a.which) == 13 && c()});
        ...
        DISQUS.popup.popModal(DISQUS.renderBlock("recaptcha"), DISQUS.strings.get("One More Step ..."), null, null, null, {onReady: function () {Recaptcha.create(DISQUS.jsonData.settings.recaptcha_public_key, "dsq-captcha-form", {theme: "clean", callback: b})}, onClose: function () {
            Recaptcha.destroy();
            e("private.setLoadingButton")
        }})
    });
    ...
    b("comments.edit.show", "= 1.0", function (a) {return e("comments.edit", a)});
    ...
    b("comments.edit.send", function (a) {
        ...
        }, function (b) {e("comments.edit.onFailure", b, a)})
    });
    ...
    b("comments.spam", function (a) {
        DISQUS.popup.close(null,
            !0);
        DISQUS.api("posts/spam", {data: {post: a}, type: "POST", success: function (a) {DISQUS.dtpl.actions.fire("comments.spam.onSuccess", a[0].id)}})
    });
    ...
    b("comments.like.updateCache", function (a, b, c) {DISQUS.updatePost(a, {up_voted: !!c})});
    ...
    b("comments.reply", function (a, b) {DISQUS.cache.toggledReplies[a] ? (DISQUS.dtpl.actions.fire("comments.reply.cancel", a, b), DISQUS.cache.toggledReplies[a] = !1) : (DISQUS.dtpl.actions.fire("comments.reply.new", a, b), DISQUS.cache.toggledReplies[a] = !0)});
    ...
    b("comments.delete", function (a) {
        DISQUS.popup.close(null,
            !0);
        DISQUS.api("posts/remove", {data: {post: a}, type: "POST", success: function (a) {DISQUS.each(a, function (a) {e("comments.delete.onSuccess", a.id)})}, failure: function () {
    ...
    b("comments.restore", function (a) {DISQUS.api("posts/restore", {data: {post: a}, type: "POST", success: function (a) {DISQUS.each(a, function (a) {e("comments.restore.onSuccess", a.id)})}})});
    b("comments.restore.onSuccess",
        "= 1.0", function (a) {if (DISQUS.nodes.get("#comment-" + a) && DISQUS.nodes.get("#dsq-comment-" + a))DISQUS.nodes.get("#comment-" + a).innerHTML = "", DISQUS.nodes.get("#comment-" + a).className = "", DISQUS.nodes.get("#dsq-comment-" + a).style.display = "block"});
    ...
    b("profile.dashboard", function () {window.location.href = "http://disqus.com/dashboard"});
    b("profile.edit", function () {(new (DISQUS.states.noThirdPartyCookies ? DISQUS.ui.ProfileEditNewWindow : DISQUS.ui.ProfileEditModal)).open({lang: DISQUS.jsonData.forum.language})});
    b("profile.displayDeferredAvatars", function () {
        ...
        if (f.length) {
            ...
            e = function () {
                for (var b = f.length, c = 0, e, d; c < b;)if (d = parseInt((c + b) / 2, 10), e = a(f[d]), e === -1)c = d + 1;
                else if (e ===
                    1)b = d;
                else return d;
                return-1
    ...
    b("messagesx.init", function () {
        ...
        if (a.context.switches.realtime && a.request.is_authenticated) {
            var c = !1, e = function () {c || (c = !0, b.realtimePoll(a.thread.id))};
            document.readyState != "complete" ? DISQUS.bean.add(window, "load", e) : e();
            setTimeout(function () {e()}, 15E3)
        }
    });
    ...
    b("messagesx.newEvent", function (a) {a.type == "message" && e("messagesx.newMessage", a.message)});
    ...
    b("messagesx.markRead", function () {
        ...
        DISQUS.each(DISQUS.cache.messagesx.unread, function (b) {a.push(b.id)});
    ...
    b("thread.initialize", function () {
        ...
        DISQUS.events.debounce(window, "scroll", function () {DISQUS.dtpl.actions.fire("profile.displayDeferredAvatars")},
            250);
    ...
    b("thread.ready", function () {
        ...
        }, function () {DISQUS.trigger("thread.onReady")})
    });
    ...
    b("thread.update", function () {
        function a(b) {if (c)c.innerHTML = b}
        ...
        if (DISQUS.jsonData.thread.pagination_type ==
            "num")DISQUS.dtpl.replaceHtml(b, DISQUS.renderBlock("comments")), DISQUS.ui.applyTooltips(b), DISQUS.jsonData.thread.total_posts > d ? (f = DISQUS.jsonData.thread.offset_posts, a(f + 1 + "-" + (f + d))) : a(d);
        else if (DISQUS.jsonData.thread.pagination_type == "append")DISQUS.jsonData.request.page == 1 ? (b.innerHTML = DISQUS.renderBlock("comments"), a(d)) : (f = document.createElement("div"), f.innerHTML = DISQUS.renderBlock(function (a) {
            var b = "";
            DISQUS.each(a.comments, function (a) {b += DISQUS.renderBlock("comment", {comment: a})});
            return b
        }),
    ...
    b("thread.sort.onLoadingStart", "= 1.0", function () {DISQUS.nodes.get("#dsq-comments").innerHTML = '<img src="' + DISQUS.jsonData.settings.media_url + '/images/loading.gif"/>'});
    ...
    b("thread.vote", function (a) {
        ...
        if (c.request.is_authenticated || c.forum.allow_anon_votes) {
            ...
            DISQUS.api("threads/vote",
                {data: {thread: c.thread.id, vote: a}, type: "POST", success: function (b) {DISQUS.dtpl.actions.fire("thread.vote.onSuccess", a, b.thread.likes)}})
        }
    ...
    b("thread.help", function () {DISQUS.jsonData.request.is_moderator && DISQUS.popup.popModal(DISQUS.renderBlock("moderatorHelpPopup"), DISQUS.strings.get("Help"))});
    b("thread.settings", function () {DISQUS.jsonData.request.is_moderator && DISQUS.popup.popModal(DISQUS.renderBlock("threadSettingsPopup"), DISQUS.strings.get("Moderator Settings"))});
    ...
    b("thread.close", function () {
        ...
        DISQUS.api("threads/close", {data: {forum: a.forum.url, thread: a.thread.id}, type: "POST", success: function () {
            ...
            DISQUS.reload(function () {DISQUS.redraw()})
        }})
    });
    ...
    b("thread.updateModerationSettings", function (a) {
        ...
        DISQUS.extend(b, a);
        DISQUS.api("threads/updateModerationSettings", {data: b, type: "POST", success: function (a) {DISQUS.dtpl.actions.fire("thread.updateModerationSettings.onSuccess", a)}})
    });
    ...
    b("thread.updateDaysAlive", function () {
        ...
        setTimeout(function () {a.innerHTML = ""}, 1E3)
    });
    ...
    b("thread.expandMediaEmbed", function (a) {
        var b;
        DISQUS.lang.forEach(DISQUS.jsonData.mediaembed, function (c) {c.id == a && (b = c)});
    ...
    b("thread.share.send", function () {
        function a(b) {
            DISQUS.addJob(function () {return!b || b.closed}, function () {DISQUS.dtpl.actions.fire("thread.share.nextJob")});
            p++
        }
    ...
    b("thread.share", function () {e("thread.share.send")});
    b("thread.share.new", function () {
        if (h) {
            var a = DISQUS.nodes.get("div.dsq-share-step", h - fluid);
            DISQUS.lang.forEach(a, function (a) {DISQUS.nodes.hide(a, !0)});
            DISQUS.nodes.show(a[0], !0);
            h.show()
        }
    });
    b("thread.share.cancel", function () {h && h.hide()});
    b("thread.share.nextJob", function () {h && (--p || DISQUS.dtpl.actions.fire("thread.share.onSuccess"))});
    ...
    b("realtime.update", function (a, b, c) {
        ...
        f.last_checked = a;
        c && DISQUS.lang.forEach(c, function (a, b) {DISQUS.jsonData.users[b] || (DISQUS.jsonData.users[b] = a)});
        b && (DISQUS.lang.forEach(b, function (a, b) {DISQUS.jsonData.posts[b] || (DISQUS.updatePost(b, a), f.newPosts.push(b))}), DISQUS.jsonData.forum.streaming_realtime ?
            e("realtime.insertNewPosts") : e("realtime.updateCount"))
    });
    b("community.show", function () {(new DISQUS.ui.ForumCommunityModal).open({url: DISQUS.jsonData.urls.community, lang: DISQUS.jsonData.forum.language})});
    b("reactions.hide", function (a) {DISQUS.api("reactions/remove", {data: {reaction: a, forum: DISQUS.jsonData.forum.url}, type: "POST", success: function (a) {DISQUS.dtpl.actions.fire("reactions.hide.onSuccess", a[0].id)}})});
    b("reactions.hide.onSuccess", function (a) {
        DISQUS.nodes.hide(DISQUS.nodes.get("#dsq-reaction-" +
            a))
    });
    b("reactions.hide.onSuccess", function (a) {DISQUS.nodes.get("#dsq-reaction-" + a).style.display = "none"});
    b("reactions.loadMore", function () {DISQUS.request.get(DISQUS.jsonData.urls.embed_more_reactions, {t: DISQUS.jsonData.thread.id, s: DISQUS.jsonData.reactions_start, l: DISQUS.jsonData.reactions_limit}, !0)});
    ...
    b("reactions.showRetweets", function (a) {
        var b;
        DISQUS.lang.forEach(DISQUS.jsonData.reactions, function (c) {c.id == a && (b = c)});
    ...
    b("toolbar.initialize", function () {
        if (DISQUS.nodes.get("#dsq-global-toolbar")) {
            ...
            var b =
                ...
                var a = !1;
                DISQUS.lang.forEach(b, function (b) {b && (a = a || b.checked)});
            ...
            DISQUS.lang.forEach(b, function (a) {a && DISQUS.events.add(a, "click", c)});
    ...
    b("help.login", function () {DISQUS.popup.popModal(DISQUS.renderBlock("helpLogin"), DISQUS.strings.get("Help: Enabling cookies"))});
    ...
    b("comments.reply.mentions.suggest", function (a, b) {
        function c(a) {
            ...
            DISQUS.each(a, function (a) {
                ...
                DISQUS.events.add(a, "mouseover", function (a) {
                    ...
                    if (a && !DISQUS.nodes.hasClass(a, "dsq-mentions") && (a = k(a, "data-dsq-username") ? a : DISQUS.nodes.closest(a, "li")) && k(a, "data-dsq-username"))b = DISQUS.nodes.get("li", a.parentNode), DISQUS.each(b, function (a) {DISQUS.nodes.removeClass(a, "dsq-mentions-highlighted")}), DISQUS.nodes.addClass(a,
        ...
        if (!a || !a.sections)DISQUS.dtpl.actions.fire("comments.reply.mentions.clear", b);
        else {
            var d = !1, g = "", h, p, i, j;
...
DISQUS.define("dtpl.validators", function () {
    return{email: function (b) {
        ...
        else if (b.value == d)return b.value = "", !0;
...
DISQUS.define("events", function () {
    ...
    return{execOnReady: function (f) {b() ? f() : d.timer ? d.queue.push(f) : (DISQUS.events.add(window, "load", b), d.queue.push(f), d.timer = setInterval(b, 13))}}
});
DISQUS.define("request", function () {
    return{get: function (b, d, f, a) {
        ...
        g.action = b;
        if (!f)g.target = c;
        try {e = document.createElement('<iframe name="' + c + '">')}
        catch (i) {e = document.createElement("iframe"), e.name = c}
        e.style.display =
            "none";
        e.id = c;
        a.appendChild(e);
...
DISQUS.define("popup", function () {
    return{popModal: function (b, d, f, a, g, c) {
        ...
        return!1
    }, close: function () {DISQUS.ui.Modal.closeAll()}, adjustPosition: function () {
...
DISQUS.define("window", function () {
    return {
        anchor: function (b) {window.location.hash = b}, isClosed: function (b) {
            if (!b)return !0;
            try {return b.closed || b.closed === void 0}
            catch (d) {return !0}
        }
    }
});
...
DISQUS.define("db", function () {
    ...
    f ? (b = function (a) {
        ...
        try {return a ? d.parse(a) : {}}
        catch (b) {return {}}
    }, b.prototype._saveObject = function (a) {
        try {return localStorage.setItem(this.key, d.stringify(a))}
        catch (b) {return !1}
        ...
        b.prototype.get = function (a) {return this._getObject()[a]}) : (b = function () {this.store = {}}, b.prototype = {set: function (a, b) {this.store[a] = b}, get: function (a) {return this.store[a]}});
    return{available: f, Store: b}
});
DISQUS.define("nodes", function () {
    function b(a) {return RegExp("(^|\\s)" + a + "(\\s|$)")}
    ...
    function a(a, c) {return a.nodeType !== 1 ? !1 : c.slice(0, 1) == "#" ? a.id == c.slice(1) : c.indexOf(".") != -1 ? b(c.slice(1)).test(a.className) : a.tagName.toLowerCase().indexOf(c) != -1}
    ...
    function i(a, c) {return b(c).test(a.className)}
    ...
    return{container: o, head: j, query: DISQUS.qwery, get: d, siblings: f, children: function (a) {return f(a.firstChild)}, is: a, body: function () {
        if (p)return p;
        ...
        var f, d, g;
        g = e();
        b && DISQUS.lang.forEach(b, function (a, b) {g[b] = a});
        d = {marginwidth: 0, marginheight: 0,
            hspace: 0, vspace: 0, frameborder: 0, allowtransparency: "true", src: DISQUS.getResourceURL(a, g, !0)};
        c && DISQUS.lang.forEach(c, function (a, b) {d[b] = a});
        f = document.createElement("iframe");
        DISQUS.lang.forEach(d, function (a, b) {f.setAttribute(b, a)});
        return f
    }, getPosition: function (a) {
        var b = 0, c = 0;
        if (a.offsetParent) {do b += a.offsetLeft, c += a.offsetTop, a = a.offsetParent; while (a)}
        return[b, c]
    }, getStyle: g, getBasicStyles: c, hasClass: i, addClass: m, removeClass: k, toggleClass: function (a, b) {i(a, b) ? k(a, b) : m(a, b)}, remove: function (a) {
        if (a)l(a),
            typeof a.outerHTML != "undefined" ? a.outerHTML = "" : a.parentNode && a.parentNode.removeChild(a)
    }, removeChildren: l, insertBefore: function (a, b) {a.parentNode.insertBefore(b, a)}, insertAfter: function (a, b) {a.parentNode.insertBefore(b, a.nextSibling)}, firstChild: function (a) {
        ...
        b ? a.style.cssText = "display:none !important" :
            a.style.display = "none"
    }, show: function (a, b) {b ? a.style.cssText = "display:block !important" : a.style.display = "block"}, scrollTo: function (a) {
        ...
        for (var e = a.childNodes[0], f = 0; e !== null;) {
            ...
            if (e.childNodes.length > 0)e = e.childNodes[0];
            else if (e.nextSibling !== null)e = e.nextSibling;
            else if (e.parentNode === a)break;
            else {
...
DISQUS.define("sandbox", function () {
    function b() {
        ...
        a.context.sharing = [];
        DISQUS.lang.forEach(a.request.sharing, function (b, c) {if (!(a.request.is_remote && a.request.remote_domain != c))b.key = c, b.checked = b.auto === !0 || a.request.remote_domain == c, a.context.sharing.push(b)});
        ...
        DISQUS.lang.forEach(d.ordered_posts, function (b) {
            ...
            if (j === 0)c.isFirst = !0;
            else if (b = a.comments[j - 1], b.depth < c.depth)c.isFirst = !0;
            else if (b.depth > c.depth)b.isLast = !0;
            a.comments.push(c);
            j++
        });
    ...
    function d() {
        var b = {};
        DISQUS.lang.forEach(a, function (a) {typeof a != "undefined" && DISQUS.lang.extend(b, a)});
        return b
    }
    ...
    return{wrap: function (c, g, m) {
        ...
        (a[c] = void 0);
        return g
    }, invalidateGlobals: function () {f = void 0}}
});
DISQUS.define("tooltip", function () {
    ...
    b.prototype = {init: function () {
        ...
        if (d.trigger === "click") {
            ...
            i = function () {
                ...
                setTimeout(function () {e = DISQUS.events.add(document, "click", m)}, 0)
            };
        ...
        else d.trigger && (DISQUS.events.add(a, "mouseout", function () {b.leave()}), DISQUS.events.add(a, "mouseover", function () {b.enter()}))
    }, show: function () {
        var b = this.getTitle();
        ...
        return this._outer
    }, validate: function () {this.$element[0].parentNode || this.hide()}, enable: function () {this.enabled = !0}, disable: function () {this.enabled = !1}, toggleEnabled: function () {this.enabled = !this.enabled}, leave: function () {if (this.hoverState !== "out")this.hoverState = "out", this.options.delayOut === 0 ? this.hide() : setTimeout(function () {this.hoverState == "out" && this.hide()}, this.options.delayOut)},
        enter: function () {if (this.hoverState !== "in")this.hoverState = "in", this.options.delayIn === 0 ? this.show() : setTimeout(function () {this.hoverState == "in" && this.show()}, this.options.delayIn)}};
    ...
    var d = function (d, a) {b.call(this, d, a)};
...
DISQUS.define("comm", function () {
    ...
    return{Default: {create: function (a) {
        ...
        b = DISQUS.net.rpc(c, {local: {realtimeNotify: function (a) {DISQUS.dtpl.actions.fire("messagesx.newEvent", a)}}, remote: {api: {},
            echo: {}, enable: {}, flushLog: {}, addMeta: {}, log: {}, setApiKey: {}, realtimePoll: {}, darkRealtimePoll: {}, gaPush: {}}});
        return f.Default = b
    }, recover: function () {return f.Default}}, Reply: {create: function () {
        ...
        var h = DISQUS.net.rpc({
            ...
            }, appendElement: !0}, {local: {cookieFailure: function () {DISQUS.dtpl.actions.fire("cookies.onFailure")}, resizeFrame: function (a, b) {DISQUS.dtpl.actions.fire("comments.reply.onResize", b, a)}, onFocus: function () {DISQUS.dtpl.actions.fire("comments.reply.onFocus", m)}, onBlur: function () {DISQUS.dtpl.actions.fire("comments.reply.onBlur", m)}, onUploadAdd: function (a) {DISQUS.dtpl.actions.fire("__.comments.reply.media.upload.onResponse", a, m)}, onUploadRemove: function (a) {
            DISQUS.dtpl.actions.fire("__.comments.reply.media.remove.onResponse",
                a, m)
        }, onSuggest: function (a, b) {DISQUS.dtpl.actions.fire("comments.reply.mentions.suggest", a, b || void 0)}, onSuggestMove: function (a, b) {DISQUS.dtpl.actions.fire("comments.reply.mentions.move", a, b || void 0)}, onSuggestSelect: function (a) {DISQUS.dtpl.actions.fire("comments.reply.mentions.selectActive", a || void 0)}, onSuggestClear: function (a) {DISQUS.dtpl.actions.fire("comments.reply.mentions.clear", a || void 0)}}, remote: {show: {}, post: {}, postAsGuest: {}, validate: {}, setState: {}, focus: {}, setupResize: {}, setData: {}, selectUser: {}}});
        g && h.setupResize();
        return f.Reply[m] = h
    }, recover: function (a) {return f.Reply[a || null]}, reset: function () {f.Reply = {}}}, Auth: {create: function (a, g, c) {
        if (typeof b == "undefined")b = DISQUS.jsonData, d = DISQUS.nodes.getBasicStyles();
        ...
        var e = DISQUS.getResourceURL(b.urls.channels.auth,
            ...
            i.isReady = !0;
            c && c()
        }, container: a}, {local: {onAuth: function (a) {DISQUS.states.loginDisabled ? DISQUS.popup.close(null, !0) : DISQUS.reload(function () {g(a)})}, onSignupViewed: function () {DISQUS.trigger("signup.viewed")}}, remote: {focus: {}}});
        return f.Auth.def = i
    }, recover: function () {return f.Auth.def}}, Edit: {create: function (a, g, c) {
        if (typeof b == "undefined")b = DISQUS.jsonData, d = DISQUS.nodes.getBasicStyles();
        ...
        return i
    }, recover: function (a) {return f.Edit[a]}}, Twitter: {create: function (a, b, c) {
        var d = DISQUS.net.rpc({remote: DISQUS.jsonData.urls.channels.tweetbox, container: a, onReady: function () {
            d.isReady = !0;
            b && b()
        }}, {local: {onTweet: function () {c && c()}}, remote: {setContent: {}}});
        return f.Twitter = d
    }, recover: function () {return f.Twitter}}, Facebook: {create: function (a, b) {
        ...
        }}, {local: {onSuccess: function () {if (b.onSuccess)b.onSuccess()}, onBusy: function () {if (b.onBusy)b.onBusy()}, onFailure: function () {if (b.onFailure)b.onFailure()}},
            remote: {authenticatePublisherSession: {}, authenticatePublicSessionData: {}, init: {}, streamPublish: {}}});
        return f.Facebook = d
    }, recover: function () {return f.Facebook}}, SSO: {create: function (a, b) {
        var c = DISQUS.net.rpc({remote: DISQUS.jsonData.urls.channels.sso, onReady: function () {
            c.isReady = !0;
            a !== void 0 && a()
        }}, {local: {onSuccess: function () {b !== void 0 && b()}}, remote: {authenticate: {}}});
        return f.SSO = c
    }, recover: function () {return f.SSO}}, Upload: {create: function (a, d) {
        if (a) {
            ...
            var e = new DISQUS.net.rpc({remote: c, container: a, props: {scrolling: "no", allowTransparency: "true"}, onReady: function () {
                ...
                e.isReady = !0
            }}, {local: {onUploadStart: function () {DISQUS.dtpl.actions.fire("__.comments.reply.media.upload", d)}, onUpload: function (a) {
                DISQUS.dtpl.actions.fire("__.comments.reply.media.upload.onResponse",
                    a, d)
            }}, remote: {setupUpload: {}, media: {}}});
            return f.Upload[d] = e
        }
    }, recover: function (a) {return f.Upload[a || null]}}, reset: function (a) {
        function g(a) {a && a.destroy()}

        DISQUS.each(f, function (b, d) {d === "Default" && a || b !== null && (b.origin && b.destroy ? g(b) : DISQUS.each(b, g))});
        b = d = void 0
    }, ensureLoggedIn: function (a, b, c) {
        c = c || {};
        if (DISQUS.jsonData.request.is_authenticated)a();
        else {
            switch (b) {
                case "disqus":
...
DISQUS.define("ui", function () {
    ...
    DISQUS.extend(f, {closeAll: function () {DISQUS.lang.forEach(b, function (a) {a.close()})}, last: function () {return b[d]}});
    f.prototype = {
        init: function () {
            var a = this, b = a - fluid;
            b.className = "dsq-popup dsq-popup-message " + (a.extra || "");
            DISQUS.browser.ie6 || DISQUS.browser.ie7 ? DISQUS.events.execOnReady(function () {a._onContentReady()}) : a._onContentReady();
            (b = DISQUS.nodes.get(".dsq-popup-close", b)) && b.length && DISQUS.events.add(b[0],
                "mouseup", function () {a.close()});
            a.mouseUpListener = function (b) {DISQUS.nodes.closest(b.target || b.srcElement, "#" + a - fluid.id) || a.close()};
            a.keyUpListener = function (b) {b.keyCode == 27 && a.close()};
    ...
    DISQUS.extend(a.prototype, f.prototype, {
        open: function (a) {
            ...
            b.appendChild(c);
            c.onreadystatechange = c.onload = function () {c.style.visibility = "visible"};
            return b
        }
    });
    var g = function () {f.call(this)};
    ...
    DISQUS.extend(c.prototype, f.prototype, {open: function (a) {
        var b = this, a = a || {};
        DISQUS.extend(a, {strict: !0, title: DISQUS.strings.get("Edit your profile"), extra: "dsq-profile-edit-modal", onClose: b.onClose, onReady: function () {b.onContentReady(a.selectedTab)}});
        b.lang = a.lang || "en";
    ...
    var i = function () {this.name = "disqus_edit_profile_" + DISQUS.getGuid()};
    ...
    m.prototype = {
        open: function () {
            ...
            a.window && DISQUS.defer(function () {return DISQUS.window.isClosed(a.window)}, function () {a.reload()})
        }, reload: function () {
            var a = this;
            DISQUS.reload(function () {a.onClose()})
        }, close: function () {this.window && window.close()}
    };
    var k = function (a, b) {
        this.opts = b || {};
    ...
    k.prototype =
    {
        ...
        }, hide: function () {DISQUS.nodes.hide(this - fluid, !0)}
    };
    var l = function (a, b, c) {
        ...
        DISQUS.events.add(c, "click", function () {DISQUS.dtpl.validators.guestFields(a) && b(this)})
    };
    ...
    var j = function (a, b) {
        ...
        c.rpc = DISQUS.comm.Facebook.create(g, {
            onReady: function () {c.rpc.init()}, onBusy: function () {
            ...
            }, onSuccess: function () {DISQUS.reload(function () {a.close()})}
        })
    };
    ...
    var h = function (a, b) {
        ...
        DISQUS.events.add(d, "click", function () {
            ...
            DISQUS.comm.ensureLoggedIn(function () {a.close()}, b, {
                onFailure: function () {
    ...
    var p = function (a) {h.call(this, a, "yahoo")};
    DISQUS.extend(p.prototype, h.prototype);
    var s = function (a) {h.call(this, a, "twitter")};
    DISQUS.extend(s.prototype, h.prototype);
    var u = function (a) {h.call(this, a, "facebook")};
    DISQUS.extend(u.prototype, h.prototype);
    var q = function (a) {h.call(this, a, "google")};
    ...
    var C = function (a) {
        ...
        DISQUS.events.add(b,
            "click", function () {
                ...
                /^\s*$/.test(e) || (d = DISQUS.getResourceURL(d, {url: e, username: DISQUS.nodes.get("#dsq-openid-username").value}), b = window.open(d, "openidWindow", "location=0,status=0,width=800,height=500"), c = setInterval(function () {DISQUS.window.isClosed(b) && (clearInterval(c), DISQUS.reload(function () {a.close()}))}, 500))
            })
    };
    DISQUS.extend(C.prototype, k.prototype);
    var v = function (a) {h.call(this, a, "sso")};
    ...
    DISQUS.extend(B.prototype, f.prototype, {open: function (a) {
        ...
        DISQUS.extend(a, {strict: !0, title: b.title, body: DISQUS.renderBlock("loginPopup", {guestTab: b.guestTab}),
            extra: "dsq-login-box", onClose: b.onClose, onReady: function () {b.onContentReady(a.selectedTab)}});
    ...
    DISQUS.extend(G.prototype, f.prototype, {open: function (a) {
        ...
        if (DISQUS.states.useLoginWindow) {
            ...
            var d = setInterval(function () {DISQUS.window.isClosed(c) && (clearInterval(d), DISQUS.reload(function () {b.onClose()}))}, 500)
        }
    ...
    var H = function () {m.call(this, {url: DISQUS.jsonData.urls.twitter_connect, width: 800, height: 698})};
    ...
    var A = function () {m.call(this, {url: DISQUS.jsonData.urls.yahoo_connect, width: 800, height: 400})};
    DISQUS.extend(A.prototype, m.prototype);
    var n = function () {
        var a = DISQUS.config.sso;
        m.call(this, {url: a.url, width: a.width || 800, height: a.height || 400})
    };
    DISQUS.extend(n.prototype, m.prototype, {reload: function () {window.location.reload()}});
    var K = function () {};
    DISQUS.extend(K.prototype, f.prototype, {open: function () {
        var a =
            this, b = {title: DISQUS.strings.get("Sign in with OpenID"), body: DISQUS.renderBlock("openidForm"), onClose: a.onClose, onReady: function () {a.content = new C(a)}};
        f.prototype.open.call(a, b)
    }});
    var x = function () {};
    DISQUS.extend(x.prototype, f.prototype, {open: function () {
        var a = this;
        f.prototype.open.call(this, {title: DISQUS.strings.get("Sign in using Facebook"), body: DISQUS.renderBlock("facebookLoginForm", {title: !1}), onClose: a.onClose, onReady: function () {a.content = new j(a)}})
    }});
    var D = function () {};
    D.prototype.open = function () {
        var a =
            this;
        DISQUS.FB.init(function () {DISQUS.FB.login(function () {DISQUS.FB.authenticateViaPublisherKey(function () {DISQUS.reload(function () {if (a.onClose)a.onClose()})})}, function () {if (a.onClose)a.onClose()})})
    };
    return{Modal: f, IframeModal: a, ProfileModal: g, ProfileEditModal: c, ProfileEditNewWindow: i, ForumCommunityModal: e, NewWindowModal: m, ContentBase: k, GuestLoginContent: l, DisqusLoginContent: o, DefaultFacebookLoginContent: j, ExternalLoginContent: h, YahooLoginContent: p, TwitterLoginContent: s, PublisherFacebookLoginContent: u,
        GoogleLoginContent: q, OpenIdLoginContent: C, SSOLoginContent: v, iFrameContent: r, LoginBoxTab: I, LoginBox: B, DisqusLoginBox: G, TwitterLoginBox: H, GoogleLoginBox: J, YahooLoginBox: A, SSOLoginBox: n, OpenIDLoginBox: K, DefaultFacebookLoginBox: x, PublisherFacebookLoginBox: D, applyTooltips: function (a) {
            ...
            DISQUS.lang.forEach(a, function (a) {new DISQUS.tooltip.Tooltip(a, {gravity: "s", trigger: "hover", opacity: 0.96, html: !0, contentId: a.getAttribute("data-dsq-content-id")})})
        },
        truncateComments: function (a) {
            var a = DISQUS.nodes.get(".dsq-comment-message", a), b = DISQUS.jsonData.forum.comment_max_words;
            DISQUS.lang.forEach(a, function (a) {(a = a.id.match(/\d+$/)) && a.length && b > 0 && DISQUS.dtpl.actions.fire("comments.text.collapse", a[0])})
        }
    }
});
(function () {
...
DISQUS.define("sso", function () {return {auth: function (b) {var d = DISQUS.comm.SSO.create(function () {d.authenticate(b)}, function () {if (b.onSuccess)b.onSuccess()})}}});
...
DISQUS.ReplyFrame.prototype = {setState: function () {}, init: function () {this.frame = this._type == "edit" ? DISQUS.comm.Edit.create(this - fluid.id, this.id) : DISQUS.comm.Reply.create(this - fluid.id, this.id)}};
DISQUS.TweetFrame = function (b, d) {
    var f = DISQUS.comm.Twitter.create(b, d.onReady, d.onSuccess);
    this.init = function () {};
    this.setContent = function (a) {f.setContent(a)}
};
DISQUS.define("FB", function () {
    ...
    function d(b) {return function () {a[b].apply(a, arguments)}}

    var f = [], a = null, g = function () {this.authResponse = null};
    g.prototype = {
        init: function (a, b) {FB.init({apiKey: a, channelUrl: b, status: !0, cookie: !0, oauth: !0})}, login: function (a, b) {
            var c = this;
            FB.login(function (d) {
                d.authResponse ? (c.authResponse = d.authResponse, a()) : (c.session = null,
                    b())
            })
        }, authenticateViaPublisherKey: function (a) {FB.login(function (b) {var c = DISQUS.comm.Facebook.create(null, {onReady: function () {c.authenticatePublisherSession(b.authResponse)}, onSuccess: a})})}, streamPublish: function (a, b, c) {FB.ui({method: "stream.publish", message: a, attachment: b}, function (a, b) {typeof c === "function" && c(a, b)})}, streamShare: function (a, b, c) {FB.ui({method: "stream.share", u: b.href}, function (a) {typeof c === "function" && c(a.post_id)})}};
    var c = function (a) {this.rpc = a};
    c.prototype = {init: function () {this.rpc.init()},
    ...
    return{init: function () {
        ...
        DISQUS.FB.init();
        if (DISQUS.FB.publisherKeySupported())b(), window.FB || DISQUS.require("http://connect.facebook.net/en_US/all.js"), DISQUS.addJob(function () {return window.FB && FB.init}, function () {
            a = new g;
    ...
    }, publisherKeySupported: function () {return(DISQUS.config.facebook_key || DISQUS.jsonData.context.forum_facebook_key) && !(window.FB && FB.dynData)}, authenticateViaPublisherKey: d("authenticateViaPublisherKey"), login: d("login"), streamShare: d("streamShare"), streamPublish: d("streamPublish")}
});
(function () {
    function b(a) {DISQUS.each(a, function (a) {k.push(a)})}
    ...
    function f() {
        ...
        a("thread.vote", function (a) {a == 1 ? j("like_thread") : a == -1 && j("dislike_thread")});
        a("comments.like", function () {j("like_comment")});
        a("comments.report", function (a, b) {b && j("flag_comment")});
        a("comments.send", function (a) {
            e ==
                "not_logged_in" && l("userType", "guest");
            j(a === null ? "post_comment" : "post_comment_reply")
        });
        DISQUS.bind("thread.onShare", function (a) {DISQUS.each(a, function (a, b) {a && j("share_thread_" + b)})});
        DISQUS.bind("comments.share", function (a) {
            ...
            DISQUS.each(a, function (a, c) {a && j("share_comment_" + b[c])})
        });
        DISQUS.once("thread.bottomViewed", function () {j("view_bottom_embed")});
        a("realtime.show", function () {j("load_rtcomments")});
        a("comments.moderate.options", function () {j("moderate_comment_open")});
        a("profile.show", function () {j("open_profile")});
        a("community.show", function () {j("open_community")});
        a("auth.login", function () {j("open_login")});
        DISQUS.bind("signup.viewed", function () {j("open_signup")});
        a("thread.paginate", function () {j("load_comments")});
        a("comments.edit.send", function () {j("edit_comment")});
        a("thread.subscribe", function (a) {(a || DISQUS.jsonData.request.is_authenticated) && j("subscribe_thread")});
        a("thread.initialize",
            function () {
                var a = e;
                e = d();
    ...
    function a() {
        DISQUS.once("discovery.onDisplay", function () {for (var a = DISQUS.nodes.get("#dsq-related a.redirect"), b = 0; b < a.length; b++)DISQUS.bean.add(a[b], "click", function () {j("click_link_discovery")})});
        DISQUS.once("discovery.onView", function () {j("view_discovery")});
        DISQUS.once("discovery.onClose", function () {j("close_discovery")})
    }
    ...
    var g, c, e, i, m, k = [], l = DISQUS.ga.setCustomVar, o = DISQUS.ga.trackPageview, j = function (a) {
        !g || !c ? (j.queue.push(a),
            ...
            }(o)) : (j = function (a) {DISQUS.ga.trackEvent(a, g, c)}, j(a))
    };
    j.queue = [];
    DISQUS.ga.setCaller(function () {arguments.length !== 0 && (m ? m.apply(null, arguments) : b(arguments))});
    DISQUS.once("thread.topViewed", function () {j("view_embed")});
    DISQUS.once("loader.onFilesReady", function () {f()});
    ...
    DISQUS.once("thread.onReady", function () {
        ...
        if (a.context.switches.juggler_thread_onReady) {
            var b = [];
            DISQUS.each(a.context.switches, function (a, c) {a === !0 && b.push(c)});
...
(function (b, d, f, a, g, c) {
    ...
    function m(a, b) {F ? a.call(b) : L.push(function () {a.call(b)})}
    ...
    function p() {
        ...
        if (typeof String.prototype.evalJSON === "function" && (b = '{"a":[1,2,3]}'.evalJSON(), b.a && b.a.length === 3 && b.a[2] === 3))a.parse = function (a) {return a.evalJSON()};
        if (a.stringify && a.parse)return p = function () {return a}, a;
        return null
    }
    ...
    function q(a) {
        ...
        if (a.isHost) {
            if (a.remote = o(a.remote), a.channel = a.channel || "default" + I++, a.secret =
                Math.random().toString(16).substring(2), h(c))if (r.parent == r && l(f.href) == l(a.remote))c = "4";
            else if (e(b, "postMessage") || e(d, "postMessage"))c = "1";
            else {
                if (c = e(b, "ActiveXObject"))try {new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), c = !0}
                catch (W) {c = !1}
    ...
    function C(a) {
        for (var b, c = {incoming: function (a, b) {this.up.incoming(a, b)}, outgoing: function (a, b) {this.down.outgoing(a, b)}, callback: function (a) {this.up.callback(a)}, init: function () {this.down.init()}, destroy: function () {this.down.destroy()}}, d = 0, e = a.length; d < e; d++) {
            b = a[d];
            s(b, c, !0);
            if (d !== 0)b.down = a[d - 1];
            if (d !== e - 1)b.up = a[d + 1]
    ...
    if (e(b, "addEventListener"))z = function (a, b, c) {a.addEventListener(b, c, !1)}, E = function (a, b, c) {a.removeEventListener(b, c, !1)};
    else if (e(b, "attachEvent"))z = function (a, b, c) {a.attachEvent("on" + b, c)}, E = function (a, b, c) {a.detachEvent("on" + b, c)};
    ...
    "readyState"in d ? (M = d.readyState, F = M == "complete" || ~navigator.userAgent.indexOf("AppleWebKit/") && (M == "loaded" || M == "interactive")) :
        F = !!d.body;
    F || (e(b, "addEventListener") ? z(d, "DOMContentLoaded", i) : (z(d, "readystatechange", function () {d.readyState == "complete" && i()}), d.documentElement.doScroll && b === top && function R() {
        if (!F) {
    ...
    n.DomHelper = {on: z, un: E, requiresJSON: function (a) {typeof b.JSON == "object" && b.JSON || d.write('<script type="text/javascript" src="' + a + '"><\/script>')}};
    (function () {
        var a = {};
        n.Fn = {set: function (b, c) {a[b] = c}, get: function (b, c) {
            var d = a[b];
            c && delete a[b];
            return d
        }}
    ...
    n.Socket = function (a) {
        var b = C(q(a).concat([
            {incoming: function (b, c) {a.onMessage(b, c)}, callback: function (b) {if (a.onReady)a.onReady(b)}}
        ])), c =
            l(a.remote);
        this.origin = l(a.remote);
        this.destroy = function () {b.destroy()};
        this.postMessage = function (a) {b.outgoing(a, c)};
        b.init()
    };
    n.Rpc = function (a, b) {
        ...
        var e = C(q(a).concat([new n.stack.RpcBehavior(this, b), {callback: function (b) {if (a.onReady)a.onReady(b)}}]));
        this.origin = l(a.remote);
    ...
    n.stack.SameOriginTransport = function (b) {
        ...
        return c = {outgoing: function (a, b, c) {
            e(a);
            c && c()
        }, destroy: function () {d && (d.parentNode.removeChild(d), d = null)}, onDOMReady: function () {
            g = l(b.remote);
            b.isHost ? (s(b.props, {src: j(b.remote, {xdm_e: f.protocol + "//" + f.host + f.pathname, xdm_c: b.channel, xdm_p: 4}), name: x + b.channel + "_provider"}), d = u(b), n.Fn.set(b.channel, function (b) {
                e = b;
                a(function () {c.up.callback(!0)}, 0);
                return function (a) {c.up.incoming(a, g)}
            })) : (e = k().Fn.get(b.channel, !0)(function (a) {c.up.incoming(a, g)}), a(function () {c.up.callback(!0)}, 0))
        }, init: function () {
            m(c.onDOMReady,
                c)
        }}
    ...
    n.stack.FlashTransport = function (b) {
        function c(b) {a(function () {f.up.incoming(b, h)}, 0)}
        ...
        return f = {outgoing: function (a, c, d) {
            ...
            try {i.destroyChannel(b.channel)}
            catch (a) {}
            i =
                null;
            ...
            n.Fn.set("flash_" + b.channel + "_init", function () {a(function () {f.up.callback(!0)})});
            ...
            i ? d() : e(d)
        }, init: function () {m(f.onDOMReady, f)}}
    };
    n.stack.PostMessageTransport = function (c) {
        function d(a) {
            var b;
            if (a.origin)b = l(a.origin);
            else if (a.uri)b = l(a.uri);
            else if (a.domain)b = f.protocol + "//" + a.domain;
        ...
        return e = {outgoing: function (a, b, d) {
            ...
            onDOMReady: function () {
                t = l(c.remote);
                c.isHost ? (z(b, "message", function S(f) {f.data == c.channel + "-ready" && (h = "postMessage"in g.contentWindow ? g.contentWindow : g.contentWindow.document, E(b, "message", S), z(b, "message", d), a(function () {e.up.callback(!0)}, 0))}), s(c.props, {src: j(c.remote, {xdm_e: l(f.href), xdm_c: c.channel, xdm_p: 1}), name: x + c.channel + "_provider"}), g = u(c)) : (z(b, "message", d), h = "postMessage"in b.parent ? b.parent : b.parent.document, h.postMessage(c.channel + "-ready", t), a(function () {e.up.callback(!0)}, 0))
            },
            init: function () {m(e.onDOMReady, e)}}
    };
    n.stack.FrameElementTransport = function (c) {
        ...
        return e = {outgoing: function (a, b, c) {
            h.call(this, a);
            c && c()
        }, destroy: function () {g && (g.parentNode.removeChild(g), g = null)}, onDOMReady: function () {
            i = l(c.remote);
            if (c.isHost)s(c.props, {src: j(c.remote, {xdm_e: l(f.href), xdm_c: c.channel, xdm_p: 5}), name: x + c.channel + "_provider"}), g = u(c), g.fn = function (b) {
                delete g.fn;
                h = b;
                a(function () {e.up.callback(!0)}, 0);
                return function (a) {e.up.incoming(a, i)}
            };
            else {
                if (d.referrer && l(d.referrer) !=
                    y.xdm_e)b.top.location = y.xdm_e;
                h = b.frameElement.fn(function (a) {e.up.incoming(a, i)});
                e.up.callback(!0)
            }
        }, init: function () {m(e.onDOMReady, e)}}
    };
            ...
            if (c.isHost) {
                try {
                    e(b, "getNixProxy") || b.execScript("Class NixProxy\n    Private m_parent, m_child, m_Auth\n\n    Public Sub SetParent(obj, auth)\n        If isEmpty(m_Auth) Then m_Auth = auth\n        SET m_parent = obj\n    End Sub\n    Public Sub SetChild(obj)\n        SET m_child = obj\n        m_parent.ready()\n    End Sub\n\n    Public Sub SendToParent(data, auth)\n        If m_Auth = auth Then m_parent.send(CStr(data))\n    End Sub\n    Public Sub SendToChild(data, auth)\n        If m_Auth = auth Then m_child.send(CStr(data))\n    End Sub\nEnd Class\nFunction getNixProxy()\n    Set GetNixProxy = New NixProxy\nEnd Function\n",
                        "vbscript"), t = getNixProxy(), t.SetParent({send: function (a) {g.up.incoming(a, k)}, ready: function () {a(function () {g.up.callback(!0)}, 0)}}, c.secret), i = function (a) {t.SendToChild(a, c.secret)}
                }
                catch (m) {throw Error("Could not set up VBScript NixProxy:" + m.message);}
                ...
                t.SetChild({send: function (a) {r.setTimeout(function () {g.up.incoming(a, k)}, 0)}});
                i = function (a) {t.SendToParent(a, c.secret)};
                a(function () {g.up.callback(!0)}, 0)
            }
        }, init: function () {m(g.onDOMReady, g)}}
    };
    n.stack.NameTransport = function (b) {
        function c(a) {i.contentWindow.sendMessage(a, b.remoteHelper + (h ? "#_3" : "#_2") + b.channel)}

        function d() {h ? (++p === 2 || !h) && g.up.callback(!0) : (c("ready"), g.up.callback(!0))}

        function e(a) {g.up.incoming(a, r)}

        function f() {O && a(function () {O(!0)}, 0)}
        ...
        return g = {outgoing: function (a, b, d) {
            ...
            r = l(b.remote);
            b.local = o(b.local);
            h ? (n.Fn.set(b.channel, function (a) {h && a === "ready" && (n.Fn.set(b.channel, e), d())}), q = j(b.remote, {xdm_e: b.local, xdm_c: b.channel, xdm_p: 2}), s(b.props, {src: q + "#" + b.channel, name: x + b.channel + "_provider"}), k = u(b)) : (b.remoteHelper = b.remote, n.Fn.set(b.channel, e));
            i = u({props: {src: b.local + "#_4" + b.channel}, onLoad: function T() {
                var c = i ||
                    this;
                E(c, "load", T);
                n.Fn.set(b.channel + "_load", f);
                (function V() {typeof c.contentWindow.sendMessage == "function" ? d() : a(V, 50)})()
            }})
        }, init: function () {m(g.onDOMReady, g)}}
    };
    n.stack.HashTransport = function (c) {
        ...
        return e = {outgoing: function (a) {if (p)a = c.remote + "#" + i++ + "_" + a, (f || !n ? p.contentWindow : p).location = a}, destroy: function () {
            b.clearInterval(g);
            ...
            if (f) {
                ...
                if (n)c.onLoad = function () {
                    ...
                    (function U() {
                        ...
                        try {k = p.contentWindow.frames[x + c.channel + "_consumer"]}
                        catch (b) {}
                ...
                h), n ? (p = parent, e.up.callback(!0)) : (s(c, {props: {src: c.remote + "#" + c.channel + new Date, name: x + c.channel + "_consumer"}, onLoad: function () {e.up.callback(!0)}}), p = u(c))
        }, init: function () {m(e.onDOMReady, e)}}
    };
    ...
    n.stack.QueueBehavior = function (b) {
        function d() {
            if (b.remove && f.length === 0)v(e);
            else if (!j && !(f.length === 0 || k)) {
                j = !0;
                var c = f.shift();
                e.down.outgoing(c.data, c.origin, function (b) {
                    j = !1;
                    c.callback && a(function () {c.callback(b)}, 0);
                    d()
                })
            }
        }
    ...
    n.stack.VerifyBehavior = function (a) {
        ...
        }, outgoing: function (a, b, e) {c.down.outgoing(d + "_" + a, b, e)}, callback: function () {a.initiate && b()}}
    };
    n.stack.RpcBehavior = function (a, b) {
        ...
        return f = {incoming: function (a) {
            a = g.parse(a);
            if (a.method)b.handle ? b.handle(a, c) : e(a.method, a.id, b.local[a.method], a.params);
            else {
                var d = i[a.id];
...
(function () {
    function b(a) {return a < 10 ? "0" + a : a}
    ...
    var a = {}, g = !1;
    if (typeof Date.prototype.toJSON !== "function")Date.prototype.toJSON = function () {return isFinite(this.valueOf()) ? this.getUTCFullYear() + "-" + b(this.getUTCMonth() + 1) + "-" + b(this.getUTCDate()) + "T" + b(this.getUTCHours()) + ":" + b(this.getUTCMinutes()) + ":" + b(this.getUTCSeconds()) + "Z" : null}, String.prototype.toJSON = Number.prototype.toJSON = Boolean.prototype.toJSON = function () {return this.valueOf()};
    var c = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        e = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, i, m, k = {"\u0008": "\\b", "\t": "\\t", "\n": "\\n", "\u000c": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"}, l;
    a.stringify = function (a, b, c) {
        var d;
        m = i = "";
        if (typeof c === "number")for (d = 0; d < c; d += 1)m += " ";
        else typeof c === "string" && (m = c);
    ...
    if (typeof String.prototype.evalJSON === "function" && (o = '{"a":[1,2,3]}'.evalJSON(), o.a && o.a.length === 3 && o.a[2] === 3))DISQUS.json.parse = function (a) {return a.evalJSON()};
    (function () {
        var a = [1, 2, 3];
...
DISQUS.addBlocks("defaults")(function (b) {
        ...
        with (g) {
            ...
            if (request.is_authenticated) {
                ...
                if (request.sharing.twitter.enabled ||
                    request.sharing.facebook.enabled)a.put('<span class="dsq-sharing-options-label">'), a.put(trans("Share on")), a.put("</span>"), request.sharing.twitter.enabled && (a.put('<button type="button" class="dsq-share-toggle" id="dsq-share-twitter" onclick="DISQUS.dtpl.actions.fire(\'share.toggle\', this, \'twitter\''), comment && (a.put(","), a.put((a.esc || function (a) {return a})(comment.id))), a.put(');"><span class="dsq-share-icon"></span><span class="dsq-share-status"></span></button>')), request.sharing.facebook.enabled &&
                    (a.put('<button type="button" class="dsq-share-toggle" id="dsq-share-facebook"onclick="DISQUS.dtpl.actions.fire(\'share.toggle\', this, \'facebook\''), comment && (a.put(","), a.put((a.esc || function (a) {return a})(comment.id))), a.put(');"><span class="dsq-share-icon"></span><span class="dsq-share-status"></span></button>')), a.put('<input style="display: none" type="checkbox" id="dsq-sharing-twitter'), comment && (a.put("-"), a.put((a.esc || function (a) {return a})(comment.id))), a.put('" />    <input style="display: none" type="checkbox" id="dsq-sharing-facebook'),
                    comment && (a.put("-"), a.put((a.esc || function (a) {return a})(comment.id))), a.put('" />');
                a.put("</div>")
            }
            return a.compile()
        }
    ...
    b.blocks.messagesxNotice = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('    <div class="dsq-messagesx-icon">    </div>    <p>        '), a.put((a.esc || function (a) {return a})(message.formatted.text)), a.put("    </p>"), a.compile()
    };
    ...
    b.blocks.facebookLoginForm = function (d, f) {
        ...
        with (g) {
            ...
            a.put((a.esc || function (a) {return a})(settings.media_url));
    ...
    b.blocks.reportConfirmation = function (d, f) {
        ...
        with (g)return a.put('  <div style="text-align: center">  <button type="button" class="dsq-button" onclick="DISQUS.dtpl.actions.fire(\'comments.report\', '),
            a.put((a.esc || function (a) {return a})(id)), a.put(', true);">     '), a.put(trans("Yes, flag as inappropriate")), a.put('  </button>  <a href="#" onclick="DISQUS.popup.close(null, true); return false;" style="margin: 0 0 0 10px">    '), a.put(trans("Cancel")), a.put("  </a>  <br/><br/>  </div>  "), a.put(trans("This will flag comments for moderators to take action.")), a.compile()
    };
    b.blocks.globalToolbarDropdown = function (d, f) {
        ...
        with (g)return a.put("  "), a.put('  <div id="dsq-toolbar-dropdown">    <a href="#" class="dsq-toolbar-logo dsq-toolbar-item dsq-clearfix"><span class="dsq-toolbar-icon">Disqus</span></a>    <div id="dsq-toolbar-dropdown-wrap" style="display: none">      <ul class="dsq-clearfix">        '),
            request.is_authenticated ? (a.put("            "), !request.is_remote && !forum.disqus_auth_disabled ? (a.put('                <li class="dsq-dashboard-link"><a href="#" onclick="DISQUS.dtpl.actions.fire(\'profile.dashboard\'); return false"><span class="dsq-toolbar-icon"></span><span class="dsq-toolbar-label">'), a.put(trans("Dashboard")), a.put('</span></a></li>                <li class="dsq-editprofile-link"><a href="#" onclick="DISQUS.dtpl.actions.fire(\'profile.edit\'); return false"><span class="dsq-toolbar-icon"></span><span class="dsq-toolbar-label">'),
                ...
                a.put((a.esc || function (a) {return a})(config.sso.logout))) : (a.put('              <li class="dsq-logout-link"><a href="'), a.put((a.esc || function (a) {return a})(urls.logout)), a.put("?ctkn="), a.put((a.esc || function (a) {return a})(context.csrf_token))), a.put('"><span class="dsq-toolbar-icon"></span><span class="dsq-toolbar-label">'), a.put(trans("Logout")), a.put("</span></a></li>            "), a.put("        ")) : (a.put('            <li class="dsq-login-link"><a href="#" onclick="DISQUS.dtpl.actions.fire(\'auth.login\'); return false"><span class="dsq-toolbar-icon"></span><span class="dsq-toolbar-label">'),
    ...
    b.blocks.messagesxReply = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('    <div class="dsq-messagesx-icon">        <img src="'), a.put((a.esc || function (a) {return a})(settings.media_url)),
            a.put('/img/disqus-bar/icons/reply.png" />    </div>   <p>        '), a.put((a.esc || function (a) {return a})(message.formatted.text)), a.put("    </p>"), a.compile()
    };
    ...
    b.blocks.permalinkPopup = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('<div class="dsq-field">    <label>'), a.put(trans("You are anchored to")), a.put('</label>    <input type="text" readonly="true" class="dsq-anchored-to"       value="'), a.put((a.esc || function (a) {return a})(document.location.protocol)), a.put("//"), a.put((a.esc || function (a) {return a})(document.location.host)),
            a.put((a.esc || function (a) {return a})(document.location.pathname)), a.put((a.esc || function (a) {return a})(document.location.search)), a.put("#comment-"), a.put((a.esc || function (a) {return a})(postId)), a.put('"/></div>'), a.compile()
    };
    ...
    b.blocks.loginPopup = function (d, f) {
        ...
        with (g)return a.put('  <div class="dsq-tabbed-modal" id="dsq-tabbed-login-modal">    <ul class="dsq-modal-tabs">      '), guestTab && (a.put('      <li id="dsq-login-tab-guest"><a href="#dsq-login-guest" '),
            forum.allow_anon_post || a.put(' style="display: none !important"'), a.put("><span></span>"), a.put(trans("Guest")), a.put("</a></li>      ")), a.put("      "), config.sso && (a.put('<li id="dsq-login-tab-sso"><a href="#dsq-login-sso"><span></span>'), a.put((a.esc || function (a) {return a})(config.sso.name)), a.put("</a></li>")), a.put("      "), forum.disqus_auth_disabled || a.put('      <li id="dsq-login-tab-disqus"><a href="#dsq-login-disqus"><span></span>Disqus</a></li>      '), a.put('      <li id="dsq-login-tab-google"><a href="#dsq-login-google"><span></span>Google</a></li>      <li id="dsq-login-tab-twitter"><a href="#dsq-login-twitter"><span></span>Twitter</a></li>      <li id="dsq-login-tab-facebook"><a href="#dsq-login-facebook"><span></span>Facebook</a></li>      <li id="dsq-login-tab-yahoo"><a href="#dsq-login-yahoo"><span></span>Yahoo</a></li>      <li id="dsq-login-tab-openid"><a href="#dsq-login-openid"><span></span>OpenID</a></li>    </ul>    <div class="dsq-tab-container">      <div id="dsq-login-guest" class="dsq-tab-content dsq-auth-form" style="display: none !important">        <p class="dsq-field">          <label for="dsq-field-email" id="dsq-field-email-label">'),
            a.put(trans("Your email")), a.put('</label>          <input type="text"            value="'), config.def_email ? a.put((a.esc || function (a) {return a})(config.def_email)) : session.email && a.put((a.esc || function (a) {return a})(session.email)), a.put('" id="dsq-field-email"/>          </span>        <p class="dsq-field">          <label for="dsq-field-name" id="dsq-field-name-label">'), a.put(trans("Your name")), a.put('</label>          <input type="text"            value="'), config.def_name ? a.put((a.esc || function (a) {return a})(config.def_name)) :
            session.name ? a.put((a.esc || function (a) {return a})(session.name)) : a.put(trans("Guest")), a.put('" id="dsq-field-name" />        </p>        <p>          <span class="dsq-login-add-url">'), a.put(trans("Optional")), a.put(': <a href="#">'), a.put(trans("Link to your website")), a.put('</a></span>        </p>        <p class="dsq-field" style="display:none !important" id="dsq-optional-field-website">          <label for="dsq-field-website" id="dsq-field-website-label">'), a.put(trans("Your website")), a.put('</label>          <input type="text" value="'),
            session.url && a.put((a.esc || function (a) {return a})(session.url)), a.put('" id="dsq-field-website" />        </p>        <p class="dsq-login-subscribe">          <span>            <input id="dsq-subscribe-on-post'), comment && (a.put("-"), a.put((a.esc || function (a) {return a})(comment.id))), a.put('" type="checkbox"              '), request.subscribe_on_post && a.put('checked="true"'), a.put('/>          </span>          <label for="dsq-subscribe-on-post'), comment && (a.put("-"), a.put((a.esc || function (a) {return a})(comment.id))),
            ...
            a.put((a.esc || function (a) {return a})(config.sso.button)), a.put('"/></span></p>          </div>          <div class="dsq-remote-authentication" style="display:none !important">            <img src="'), a.put((a.esc || function (a) {return a})(settings.media_url)), a.put('/images/dsq-loader.gif" />            <p>'), a.put(b.interpolate(trans("Connecting to %(account)s"), {account: config.sso.name})), a.put("</p>          </div>          <p><small>"), a.put(trans("You might need to disable your popup blocker to sign in.")),
    ...
    b.blocks.commentMessage = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('  <div class="'), a.put((a.esc || function (a) {return a})(cls)), a.put('" id="dsq-comment-message-'), a.put((a.esc || function (a) {return a})(comment.id)), a.put('">    '), comment.killed ? (a.put("      <em>"), a.put(trans("Comment removed.")), a.put("</em>    ")) : comment.approved ? (a.put("      "), a.put((a.esc || function (a) {return a})(comment.message)), a.put("      "), comment.last_modified_by == "moderator" ?
            (a.put('        <p class="dsq-editedtxt">('), a.put(trans("Edited by a moderator")), a.put(")</p>      ")) : comment.last_modified_by == "author" && comment.has_replies && (a.put('        <p class="dsq-editedtxt">('), a.put(trans("Edited by author")), a.put(" "), a.put((a.esc || function (a) {return a})(comment.last_modified_date)), a.put(")</p>      ")), a.put("    ")) : (a.put("      <em>"), a.put(trans("This comment was flagged for review.")), a.put("</em>    ")), a.put("  </div>"), a.compile()
    };
    b.blocks.popup = function (d, f) {
        ...
        with (g)return a.put('  <div class="dsq-popup-container '), strict && a.put("dsq-cleanslate "), a.put('">    <table>      <tbody>        <tr>          <td class="dsq-popup-tl"></td>          <td class="dsq-popup-b"></td>          <td class="dsq-popup-tr"></td>        </tr>        <tr>          <td class="dsq-popup-b"></td>          <td class="dsq-popup-body">            <div class="dsq-popup-wrapper">                <div class="dsq-popup-title">                    <button type="button" class="dsq-popup-close dsq-button-small" style="float:right; color: #fff">'),
            a.put(trans("Close")), a.put("</button>                    <h3>"), a.put((a.esc || function (a) {return a})(popupHeader)), a.put('</h3>                </div>                <div class="dsq-popup-content">                  '), a.put((a.esc || function (a) {return a})(popupBody)), a.put("                </div>                "), footer && (a.put('                <div class="powered-by">                  <a href="'), a.put((a.esc || function (a) {return a})(settings.disqus_url)), a.put('">                    <img src="'),
            a.put((a.esc || function (a) {return a})(settings.media_url)), a.put('/images/embed/disqus-logo-noborder.png" alt="Disqus Comments" style="margin-bottom:-5px;"/>                  </a>                </div>                ')), a.put('            </div>          </td>          <td class="dsq-popup-b"></td>        </tr>        <tr>          <td class="dsq-popup-bl"></td>          <td class="dsq-popup-b"></td>          <td class="dsq-popup-br"></td>        </tr>      </tbody>    </table>  </div>'), a.compile()
    };
    b.blocks.globalToolbar = function (d, f) {
        ...
        with (g)return a.put('    <div id="dsq-global-toolbar" class="dsq-clearfix">        <ul class="dsq-global-toolbar-right dsq-clearfix">        '), request.is_authenticated && (a.put('            <li class="dsq-messages">                <div id="dsq-messagesx-toolbar-icon" class="'), messagesx.count > 0 && a.put(" dsq-unread "), a.put(' dsq-dropdown-tab dsq-toolbar-item dsq-clearfix" onclick="DISQUS.dtpl.actions.fire(\'messagesx.toggleBar\'); return false;">                    <a href="#" class="dsq-message-count dsq-toolbar-label" id="dsq-messagesx-count">'),
            ...
            a.put('        <li><img src="');
            a.put((a.esc || function (a) {return a})(b.author.avatar));
            a.put('"/> ');
            a.put((a.esc || function (a) {return a})(b.raw_message.replace(/\n/,
                "")));
            a.put("</li>      ")
    ...
    b.blocks.recaptcha = function (d, f) {
        ...
        with (g)return a.put('  <div id="dsq-captcha">      <div id="dsq-captcha-loading">          '),
            a.put('          <img src="'), a.put((a.esc || function (a) {return a})(settings.media_url)), a.put('/images/loading.gif"/>      </div>      <div id="dsq-captcha-container" style="display:none">          <p>'), a.put(trans("Please type in the following words to finish posting.")), a.put("</p>          "), a.put('          <div id="dsq-captcha-form"></div>          <button type="button" class="dsq-button">'), a.put(trans("Continue")), a.put("</button>      </div>  </div>"), a.compile()
    };
    ...
    b.blocks.likeActivity = function (d, f) {
        ...
        with (g)return a.put("  "), b.each(thread.voters, function (b) {
            ...
            a.put((a.esc || function (a) {return a})(b.name));
            a.put('"><a href="');
            a.put((a.esc || function (a) {return a})(b.url));
            a.put("\" onclick=\"return DISQUS.dtpl.actions.fire('profile.show', null, '");
            a.put((a.esc || function (a) {return a})(b.username));
            a.put("', ");
            a.put((a.esc || function (a) {return a})(b.is_moderator));
            a.put('); return false"><img src="');
            a.put((a.esc || function (a) {return a})(b.avatar));
            a.put('"/></a></li>  ')
        }), a.put('  <li class="dsq-like-activity">  '), thread.voters_count > 0 ? (a.put("      "),
            thread.likes - thread.voters_count > 0 ? (a.put("          "), a.put(b.interpolate(trans("and %(count)s %(other)s liked this."), {count: thread.likes - thread.voters_count, other: lang.pluralize(thread.likes - thread.voters_count, "other", "others")}))) : (a.put("          "), a.put((a.esc || function (a) {return a})("liked this."))), a.put("      "), a.put("  ")) : thread.likes > 0 && (a.put("      "), a.put(b.interpolate(trans("%(count)s %(person)s liked this."), {count: thread.likes, person: lang.pluralize(thread.likes, "person", "people")})),
            a.put("  ")), a.put("  </li>"), a.compile()
    };
    b.blocks.threadSettingsPopup = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('  <span id="dsq-thread-settings-status" class="dsq-options-status"></span>  <p>'), a.put(trans("These settings only apply to this thread. To change settings site-wide,  visit the main")), a.put(' <a href="'), a.put((a.esc || function (a) {return a})(urls.settings)), a.put('" target="_blank">'), a.put(trans("settings page")), a.put('</a>.</p>  <div class="dsq-moderate-options">    <table class="dsq-moderator-settings">      <tr>        <td>          <h4>            '),
            ...
            a.put('class="last"'), a.put(">          <h4>"), a.put(trans("Thread information:")), a.put("</h4>          <p><strong>"), a.put(trans("Shortname:")), a.put("</strong> "), a.put((a.esc || function (a) {return a})(forum.url)), a.put("</p>          <p><strong>"), a.put(trans("Thread ID:")), a.put("</strong> "), a.put((a.esc || function (a) {return a})(thread.id)), a.put('</p>          <p class="dsq-thread-identifiers">            <strong>'), thread.identifiers.length == 1 ? a.put(trans("Identifier:")) : a.put(trans("Identifiers:")),
            a.put("</strong> "), a.put((a.esc || function (a) {return a})(thread.identifiers.join(", "))), a.put("          </p>        </td>      </tr>      ")), a.put("      "), forum.reactions_enabled && (a.put('      <tr>        <td class="last">          <h4>'), a.put(trans("Manually scan reactions")), a.put("</h4>          <p>"), a.put(trans("Are you expecting Reactions for this thread, but do not see them? Click here to tell the system to search again.")), a.put('</p>          <p class="dsq-form-actions">            <button type="button" onclick="DISQUS.dtpl.actions.fire(\'reactions.reportMissing\');" class="dsq-button-small">              <span>'),
    ...
    b.blocks.moderateOptionsPopup = function (d, f) {
        ...
        with (g)return a.put('  <div class="dsq-moderate-options">    <table>      '), comment.email &&
            (a.put("      <tr>        <th>"), a.put(trans("Email")), a.put("</th>        <td>"), a.put((a.esc || function (a) {return a})(comment.email)), a.put("</td>      </tr>      ")), a.put("      "), comment.ip && (a.put("      <tr>        <th>"), a.put(trans("IP address")), a.put("</th>        <td>"), a.put((a.esc || function (a) {return a})(comment.ip)), a.put("</td>      </tr>      ")), a.put("      <tr>        <th>"), a.put(trans("Actions")), a.put("</th>        <td>          <ul>            "), request.moderator_can_edit &&
            (a.put('            <li>              <a href="#" onclick="return DISQUS.dtpl.actions.fire(\'comments.edit.new\', '), a.put((a.esc || function (a) {return a})(comment.id)), a.put(');">'), a.put(trans("Edit Comment")), a.put("</a>            </li>            ")), a.put('            <li>              <a href="#" onclick="return DISQUS.dtpl.actions.fire(\'comments.delete\', '), a.put((a.esc || function (a) {return a})(comment.id)), a.put(');">'), a.put(trans("Delete Comment")), a.put('</a>            </li>            <li>              <a href="#" onclick="return DISQUS.dtpl.actions.fire(\'comments.spam\', '),
            a.put((a.esc || function (a) {return a})(comment.id)), a.put(');">'), a.put(trans("Mark Spam")), a.put('</a>            </li>            <li>              <a href="#" onclick="return DISQUS.dtpl.actions.fire(\'comments.blacklist\', '), a.put((a.esc || function (a) {return a})(comment.id)), a.put(');">'), a.put(trans("Add to Blacklist")), a.put("</a>            </li>          </ul>        </td>      </tr>    </table>  </div>  <p>"), a.put(trans("Go to the full")), a.put(' <a href="'), a.put((a.esc || function (a) {return a})(urls.moderate)),
    ...
    b.blocks.pageInfo = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put("  "), request.is_global_moderator && (a.put('    <div class="dsq-global-moderator-extras"         style="display: block; margin-top: 10px; line-height: 20px; font-size: 14px; list-style-type: none; margin-left: 0;">      <strong>Shortname:</strong> '), a.put((a.esc || function (a) {return a})(forum.url)),
            a.put("<br/>      <strong>Thread ID:</strong> "), a.put((a.esc || function (a) {return a})(thread.id)), a.put("<br/>      <strong>Thread slug:</strong> "), a.put((a.esc || function (a) {return a})(thread.slug)), a.put("<br/>      <strong>Switches (Legacy):</strong> "), context.active_switches ? b.each(context.active_switches, function (b) {
            a.put(" ");
            a.put((a.esc || function (a) {return a})(b));
            a.put(", ")
    ...
    b.blocks.editArea = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('  <div class="dsq-textarea-wrapper">    <textarea class="dsq-edit-textarea" id="dsq-edit-textarea-'), a.put((a.esc || function (a) {return a})(comment.id)), a.put('">      '), a.put((a.esc || function (a) {return a})(comment.message)), a.put('    </textarea>    <div id="dsq-edit-iframe-'), a.put((a.esc || function (a) {return a})(comment.id)), a.put('" style="display: none;"></div>  </div>  <div class="dsq-save-edit">    <button type="button" class="dsq-button"      onclick="DISQUS.dtpl.actions.fire(\'comments.edit.send\', '),
            a.put((a.esc || function (a) {return a})(comment.id)), a.put(', this);">      <span>'), a.put(trans("Save Edit")), a.put("</span>    </button>  </div>"), a.compile()
    };
    b.blocks.retweetsPopup = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put("  <p><strong>"), a.put((a.esc || function (a) {return a})(reaction.author_name)), a.put(":</strong> "), a.put((a.esc || function (a) {return a})(reaction.body)), a.put('<br/><a href="'), a.put((a.esc || function (a) {return a})(reaction.url)), a.put('">'), a.put((a.esc ||
            function (a) {return a})(reaction.url)), a.put('<br/></p>  <ul class="dsq-retweets">    '), b.each(reaction.retweets, function (b) {
            a.put('    <li><a href="');
            a.put((a.esc || function (a) {return a})(b.url));
            a.put('">by ');
            a.put((a.esc || function (a) {return a})(b.author_name));
            a.put("</a></li>    ")
        }), a.put("  </ul>  "), a.compile()
    };
    b.blocks.mediaEmbedPopup = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put("  "), media.type == 1 || media.type == 5 ? (a.put('  <p><img src="'), a.put((a.esc || function (a) {return a})(media.location)),
            a.put('" onload="DISQUS.popup.adjustPosition();"/></p>  <p><a href="'), a.put((a.esc || function (a) {return a})(media.location)), a.put('" target="_blank">'), a.put(trans("Original")), a.put("</a></p>  ")) : media.type == 2 ? (a.put('  <div style="width:480px !important;height:385px !important;">    <object width="480" height="385">      <param name="movie" value="http://www.youtube.com/v/'), a.put((a.esc || function (a) {return a})(media.location)), a.put('&hl=en_US&fs=1&"></param>      <param name="allowFullScreen" value="true"></param>      <param name="allowscriptaccess" value="always"></param>      <embed src="http://www.youtube.com/v/'),
            a.put((a.esc || function (a) {return a})(media.location)), a.put('&hl=en_US&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="480" height="385"></embed>    </object>  </div>  ')) : media.type == 4 && (a.put('  <p><img src="'), a.put((a.esc || function (a) {return a})(media.metadata.medium)), a.put('" onload="DISQUS.popup.adjustPosition();"/></p>  <p><a href="'), a.put((a.esc || function (a) {return a})(media.metadata.url)), a.put('" target="_blank">'), a.put(trans("Original")),
            a.put("</a></p>  ")), a.compile()
    };
    b.blocks.postbox_login_options_dropdown = function (d, f) {
        ...
        with (g)return a.put('  <ul class="dsq-login-buttons">    '), b.each(loginOptions, function (b) {
            a.put("      ");
            b.enabled && (a.put("        "), b.userDefined ? (a.put('          <li class="dsq-login-button">            <a href="#" onclick="return DISQUS.dtpl.actions.fire(\''), a.put((a.esc || function (a) {return a})(b.action)), a.put('\');">              <img src="'), a.put((a.esc ||
                function (a) {return a})(b.button_url)), a.put('">            </a>          </li>        ')) : (a.put('          <li class="dsq-login-button dsq-login-button-'), a.put((a.esc || function (a) {return a})(b.name)), a.put('">            <a href="#" onclick="return DISQUS.dtpl.actions.fire(\''), a.put((a.esc || function (a) {return a})(b.action)), a.put("');\"></a>          </li>        ")), a.put("      "));
            a.put("    ")
    ...
    b.blocks.unapprovedCommentMessage =
        function (d, f) {
            var a = new b.Builder, g = DISQUS.extend({}, d, f);
            with (g)return a.put("  "), mustVerify ? (a.put("  "), a.put(trans("You must finish verifying your Disqus Profile email address in order for your comment to appear here.")), a.put('<br/><br/>  <a href="'), a.put((a.esc || function (a) {return a})(urls.verify_email)), a.put('">'), a.put(trans("Click here to verify your email address")), a.put("</a>  ")) : (a.put("  "), a.put(trans("Your comment must be approved by a moderator before appearing here.")), a.put("  ")),
                a.compile()
        };
    b.blocks.userVotesPopup = function (d, f) {
        ...
        with (g)return a.put("  <ul>    "), b.each(users, function (b) {
            ...
            a.put((a.esc || function (a) {return a})(settings.disqus_url));
            a.put("/");
            a.put((a.esc || function (a) {return a})(b.username));
            a.put('" target="_blank">        <img src="');
            a.put((a.esc || function (a) {return a})(b.avatar_url));
            a.put('" alt=""/>        ');
            b.display_name ? a.put((a.esc || function (a) {return a})(b.display_name)) :
                a.put((a.esc || function (a) {return a})(b.username));
            a.put("      </a>    </li>    ")
    ...
    b.blocks.messagesxAchievement =
        function (d, f) {
            var a = new b.Builder, g = DISQUS.extend({}, d, f);
            with (g)return a.put('    <div class="dsq-messagesx-icon">        '), message.formatted.icon ? (a.put('        <img src="'), a.put((a.esc || function (a) {return a})(message.formatted.icon)), a.put('" alt="" />        ')) : (a.put('        <img src="'), a.put((a.esc || function (a) {return a})(settings.media_url)), a.put('/img/disqus-bar/icons/trophey.png" alt="" />        ')), a.put("    </div>   <p>        "), a.put((a.esc || function (a) {return a})(message.formatted.text)),
                a.put("    </p>"), a.compile()
        };
    b.blocks.loadingPopup = function (d, f) {
        var a = new b.Builder, g = DISQUS.extend({}, d, f);
        with (g)return a.put('<div style="text-align: center; padding: 5px 0 10px 0;">  <img src="'), a.put((a.esc || function (a) {return a})(settings.media_url)), a.put('/images/loading.gif" alt=""/></div>'), a.compile()
    };
    b.blocks.blacklistPopup = function (d, f) {
        ...
        with (g)return a.put("  <p>    "), a.put(trans("Adding this person to the blacklist will block him or her from commenting on this site. Check the following types that you would like to add to the blacklist")),
            a.put(":  </p>  "), user.registered && (a.put('  <div class="dsq-blacklist-option">    <input id="dsq-blacklist-username" type="checkbox" checked="true" value="'), a.put((a.esc || function (a) {return a})(user.username)), a.put('"/>    <label for="dsq-blacklist-username"><strong>'), a.put(trans("Username")), a.put("</strong>: "), a.put((a.esc || function (a) {return a})(user.username)), a.put("</label>  </div>  ")), a.put("  "), comment.email && (a.put('  <div class="dsq-blacklist-option">    <input id="dsq-blacklist-email" type="checkbox" checked="true" value="'),
            a.put((a.esc || function (a) {return a})(comment.email)), a.put('"/>    <label for="dsq-blacklist-email"><strong>'), a.put(trans("Email address")), a.put("</strong>: "), a.put((a.esc || function (a) {return a})(comment.email)), a.put("</label>  </div>  ")), a.put('  <div class="dsq-blacklist-option">    <input id="dsq-blacklist-ip" type="checkbox" onclick="DISQUS.nodes.get(\'#dsq-blacklist-ip-warning\').style.display=\'block\';" value="'), a.put((a.esc || function (a) {return a})(comment.ip)), a.put('"/>    <label for="dsq-blacklist-ip"><strong>'),
            a.put(trans("IP address")), a.put("</strong>: "), a.put((a.esc || function (a) {return a})(comment.ip)), a.put('</label>    <p id="dsq-blacklist-ip-warning" style="display:none">      '), a.put(trans("Note: Blocking this person's IP address may also unintentionally      prevent others, who share his/her IP address, from commenting on      this site. This may include people who are sharing the same      computer, living in the same house, or using the same Internet      provider. Only block an IP address as a last resort.")),
            a.put('    </p>  </div>  <div class="dsq-blacklist-submit">    <span>      <input id="dsq-blacklist-retroactive" type="checkbox" value="1"/>      <label for="dsq-blacklist-retroactive">Apply to last 30 days of comments</label>    </span>    <button class="dsq-button" type="button" onclick="DISQUS.dtpl.actions.fire(\'comments.blacklist\', '), a.put((a.esc || function (a) {return a})(comment.id)), a.put(', true);">        '), a.put(trans("Add to Blacklist")), a.put("    </button>  </div>"), a.compile()
    }
});