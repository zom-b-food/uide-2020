...
window.FB || (function (window) {
    ...
    var ES5 = function () {
         ...
         */__d("JSON3", [], function (a, b, c, d, e, f) {
            (function () {
                ...
                try {ba = ba.getUTCFullYear() == -109252 && ba.getUTCMonth() === 0 && ba.getUTCDate() == 1 && ba.getUTCHours() == 10 && ba.getUTCMinutes() == 37 && ba.getUTCSeconds() == 6 && ba.getUTCMilliseconds() == 708;}
                catch (fa) {}
                if (!ba) {
                    ca = Math.floor;
                ...
                if ((m = typeof k.stringify == "function" && !ea)) {
                    ...
                    try {m = k.stringify(0) === "0" && k.stringify(Number()) === "0" && k.stringify(String()) == '""' && k.stringify(g) === j && k.stringify(j) === j && k.stringify() === j && k.stringify(ba) === "1" && k.stringify([ba]) == "[1]" && k.stringify([j]) == "[null]" && k.stringify(null) == "null" && k.stringify([j, g, null]) == "[null,null,null]" && k.stringify({result: [ba, true, false, null, "\0\b\n\f\r\t"]}) == l && k.stringify(null, ba) === "1" && k.stringify([1, 2], null, 1) == "[\n 1,\n 2\n]" && k.stringify(new Date(-8.64e+15)) == '"-271821-04-20T00:00:00.000Z"' && k.stringify(new Date(8.64e+15)) == '"+275760-09-13T00:00:00.000Z"' && k.stringify(new Date(-62198755200000)) == '"-000001-01-01T00:00:00.000Z"' && k.stringify(new Date(-1)) == '"1969-12-31T23:59:59.999Z"';}
                    catch (fa) {m = false;}
                }
                ...
                if (!m || !r) {
                    ...
                    if (!m) {
                        ...
                        q = function (ga, ha, ia, ja, ka, la, ma) {
                            ...
                            oa = g.call(na);
                            if (oa == "[object Boolean]") {return "" + na;}
                            else if (oa == "[object Number]") {return na > -1 / 0 && na < 1 / 0 ? "" + na : "null";}
                        ...
                        k.stringify = function (ga, ha, ia) {
                            ...
                            if (typeof ha == "function" || typeof ha == "object" && ha)if (g.call(ha) == "[object Function]") {ka = ha;}
                            ...
                            if (ia)if (g.call(ia) == "[object Number]") {if ((ia -= ia % 1) > 0)for (ja = "", ia > 10 && (ia = 10); ja.length < ia; ja += " ");}
                    ...
                    if (!r) {
                        ...
                        y = function (ga, ha, ia) {
                            var ja = x(ga, ha, ia);
                            if (ja === j) {delete ga[ha];}
                            else ga[ha] = ja;
                        };
                        x = function (ga, ha, ia) {
                            var ja = ga[ha], ka;
                            if (typeof ja == "object" && ja)if (g.call(ja) == "[object Array]") {for (ka = ja.length; ka--;)y(ja, ka, ia);}
        ...
        __d("ES5", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3"], function (a, b, c, d, e, f) {
            ...
            for (var r in q) {
                ...
                var s = q[r], t = r === r.toLowerCase() ? window[r.replace(/^\w/, function (x) {return x.toUpperCase();})].prototype : window[r];
                for (var u in s) {
    ...
    (function () {
        (function (a) {
            ...
            function l(u, v, w) {k(u, v, undefined, g, w, 1);}
    ...
    __d("sprintf", [], function (a, b, c, d, e, f) {
        function g(h, i) {
            ...
            var j = 0;
            return h.replace(/%s/g, function (k) {return i[j++];});
        }
    ...
    __d("Assert", ["AssertionError", "sprintf"], function (a, b, c, d, e, f) {
        ...
        function i(q) {return ES5(q, 'bind', true, null, Array.prototype.slice.call(arguments, 1));}
    ...
    __d("QueryString", [], function (a, b, c, d, e, f) {
        var g = {encode: function (h) {
            ...
            return i;
        }, appendToUrl: function (h, i) {return h + (~ES5(h, 'indexOf', true, '?') ? '&' : '?') + (typeof i === 'string' ? i : g.encode(i));}};
        e.exports = g;
    });
    __d("sdk.Scribe", ["UrlMap", "QueryString"], function (a, b, c, d, e, f) {
        var g = b('UrlMap'), h = b('QueryString');

        function i(k, l) {(new Image()).src = h.appendToUrl(g.resolve('www', true) + '/common/scribe_endpoint.php', {c: k, m: ES5('JSON', 'stringify', false, l)});}
    ...
    __d("Type", ["copyProperties", "Assert"], function (a, b, c, d, e, f) {
        ...
        function j(n, o, p, q) {
            ...
            n.prototype.parentCall = function (s) {return o.prototype[s].apply(this, Array.prototype.slice.call(arguments, 1));};
            return n;
        }
        ...
        function k(n, o) {
            ...
            for (var q = 0; q < o.length; q++) {
                ...
                ES5(ES5('Object', 'keys', false, r), 'forEach', true, function (s) {p[s] = r[s];});
            }
        }
    ...
    __d("ObservableMixin", ["Assert"], function (a, b, c, d, e, f) {
        ...
        h.prototype = {inform: function (i) {
            ...
            for (var l = 0; l < k.length; l++)try {k[l].apply(this, j);}
            catch (m) {setTimeout(function () {throw m;}, 0);}
            return this;
    ...
    __d("sdk.ErrorHandling", ["UserAgent", "sdk.Scribe", "sdk.Runtime", "wrapFunction", "ManagedError", "SDKConfig"], function (a, b, c, d, e, f) {
        ...
        function p(t, u) {
            return function () {
                ...
                try {return t.apply(this, arguments);}
                catch (v) {
    ...
    __d("sdk.Insights", ["guid", "QueryString", "sdk.Runtime", "UrlMap"], function (a, b, c, d, e, f) {
        ...
        var l = {TYPE: {NOTICE: 'notice', WARNING: 'warn', ERROR: 'error'}, CATEGORY: {DEPRECATED: 'deprecated', APIERROR: 'apierror'}, log: function (m, n, o) {k({lid: 113, payload: ES5('JSON', 'stringify', false, {source: 'jssdk', type: m, category: n, payload: o})});}, impression: function (m, n) {k(m, n);}};
        e.exports = l;
    });
    ...
    __d("FB", ["guid", "dotAccess", "copyProperties", "safeEval", "wrapFunction", "sdk.ErrorHandling", "GlobalCallback", "sdk.Insights", "Log", "sdk.Scribe", "sdk.Runtime", "SDKConfig"], function (a, b, c, d, e, f) {
        ...
        if (i(g, 'api.whitelist.length')) {
            u = {};
            ES5(g.api.whitelist, 'forEach', true, function (ca) {u[ca] = 1;});
        }
        function x(ca, da, ea, fa) {
            var ga;
            if (/^_/.test(ea)) {ga = 'hide';}
            else if (u && !u[da])ga = v;
            switch (ga) {
                case 'hide':
                    return;
                case 'stub':
                    return function () {p.warn('The method FB.%s has been removed from the JS SDK.', da);};
                    break;
                default:
                    return m.guard(function () {
                        ...
                        var ha = ES5(Array.prototype.slice.call(arguments), 'map', true, function (oa) {return typeof oa === 'function' && /^function/.test(oa.toString()) ? m.unguard(oa) : oa;}), ia = ca.apply(fa, ha), ja, ka = true;
        ...
        j(s, {_apiKey: null, _authResponse: null, _logging: true, _inCanvas: z, onlyUseHttps: function () {return r.getSecure() === true;}, onlyUseHttp: function () {return r.setSecure() === false && location.protocol == 'http:';}, _locale: null, _localeIsRtl: false, getDomain: function (ca, da) {
            ...
            if (s._logging)if (window.Debug && window.Debug.writeln) {window.Debug.writeln(ca);}
            else if (window.console)window.console.log(ca);
            if (s.Event)s.Event.fire('fb.log', ca);
        }, $: function (ca) {return document.getElementById(ca);}, dotAccess: i, Runtime: r, guard: m.guard, unguard: m.unguard, wrapFunction: l, safeEval: k});
    ...
    __d("CORSRequest", ["wrapFunction", "QueryString"], function (a, b, c, d, e, f) {
        ...
        function i(l, m) {
            ...
            var q = {send: function (t) {n.send(t);}}, r = g(function () {
                r = o;
            ...
            n.onreadystatechange = function () {
                if (n.readyState == 4)if (n.status == 200) {r();}
                else s();
            };
            return q;
        }
        ...
        function j(l, m, n, o) {
            ...
            var q = i(m, l);
            if (!q)return false;
            q.onload = function (r) {o(ES5('JSON', 'parse', false, r.responseText));};
            q.onerror = function (r) {
                if (r.responseText) {o(ES5('JSON', 'parse', false, r.responseText));}
    ...
    __d("DOMWrapper", [], function (a, b, c, d, e, f) {
        var g, h, i = {setRoot: function (j) {g = j;}, getRoot: function () {return g || document.body;}, setWindow: function (j) {h = j;}, getWindow: function () {return h || window;}};
        e.exports = i;
    });
    __d("Flash", ["DOMWrapper", "QueryString", "UserAgent", "copyProperties", "guid"], function (a, b, c, d, e, f) {
        ...
        function p() {for (var t in l)if (l.hasOwnProperty(t))o(t);}

        function q(t) {return t.replace(/\d+/g, function (u) {return '000'.substring(u.length) + u;});}
        ...
        var s = {embed: function (t, u, v, w) {
            ...
            if (!u)return false;
            return q(u.join('.')) >= q(t);
        }, isAvailable: function () {return !!s.getVersion();}};
        e.exports = s;
    });
    __d("Queue", ["copyProperties"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = {};

        function i(l, m) {return function () {m.apply(l, arguments);};}
        ...
        g(k.prototype, {_dispatch: function (l) {
            ...
            if (this._opts.processor && !this._stopped) {this._opts.processor.call(this, l);}
            ...
            this._dispatch();
            return this;
        }, dispatch: function () {this._dispatch(true);}, stop: function (l) {
            this._stopped = true;
            ...
            this._dispatch();
            return this;
        }, getLength: function () {return this._queue.length;}});
        g(k, {get: function (l, m) {
            var n;
            if (l in h) {n = h[l];}
            else n = h[l] = new k(m);
            return n;
        }, exists: function (l) {return l in h;}, remove: function (l) {return delete h[l];}});
        e.exports = k;
    });
    __d("FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], function (a, b, c, d, e, f) {
        ...
        function p() {
            ...
            var s = i.create(function () {
                ...
                var x;
                try {x = ES5('JSON', 'parse', false, decodeURIComponent(w));}
                catch (y) {x = {error: {type: 'SyntaxError', message: y.message, status: v, raw: w}};}
                m[u](x);
                delete m[u];
            });
    ...
    __d("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], function (a, b, c, d, e, f) {
        ...
        function j(l, m, n, o) {
            ...
            if (p.addEventListener) {p.addEventListener('load', r, false);}
    ...
    __d("URL", ["copyProperties", "QueryString", "Log"], function (a, b, c, d, e, f) {
        ...
        g(o.prototype, {constructor: o, getProtocol: function () {return this._protocol;}, setProtocol: function (p) {
            this._protocol = p;
            return this;
        }, getDomain: function () {return this._domain;}, setDomain: function (p) {
            this._domain = p;
            return this;
        }, getPort: function () {return this._port;}, setPort: function (p) {
            this._port = p;
            return this;
        }, getPath: function () {return this._path;}, setPath: function (p) {
            this._path = p;
            return this;
        }, getSearch: function () {return this._search;}, setSearch: function (p) {
            this._search = p;
            return this;
        }, getFragment: function () {return this._fragment;}, setFragment: function (p) {
            this._fragment = p;
            return this;
        }, getParsedSearch: function () {return h.decode(this._search);}, getParsedFragment: function () {return h.decode(this._fragment);}, isFacebookURL: function () {return n.test(this._domain);}, toString: function () {return (this._protocol ? this._protocol + ':' : '') + (this._domain ? '//' + this._domain : '') + (this._port ? ':' + this._port : '') + this._path + (this._search ? '?' + this._search : '') + (this._fragment ? '#' + this._fragment : '');}, valueOf: function () {return this.toString();}});
        g(o, {getCurrent: function () {return new o(location.href);}, getReferrer: function () {return document.referrer ? new o(document.referrer) : null;}});
        e.exports = o;
    });
    ...
    __d("ApiClient", ["copyProperties", "flattenObject", "sprintf", "CORSRequest", "FlashRequest", "JSONPRequest", "Log", "UrlMap", "URL", "ArgumentError", "Assert", "ApiClientConfig"], function (a, b, c, d, e, f) {
        ...
        function y(ca, da, ea, fa) {
            ...
            var ia = function (ma) {
                ...
                if (t && ma && typeof ma == 'object') {
                    if (ma.error) {if (ma.error == 'invalid_token' || (ma.error.type == 'OAuthException' && ma.error.code == 190))na = true;}
        ...
        function z(ca) {
            ...
            var da, ea = {};
            try {da = new o(ca);}
            catch (fa) {throw new p(fa.message, fa);}
            ES5(Array.prototype.slice.call(arguments, 1), 'forEach', true, function (ja) {ea[typeof ja] = ja;});
        ...
        var ba = {setAccessToken: function (ca) {s = ca;}, setInvalidAccessTokenHandler: function (ca) {t = ca;}, setClientID: function (ca) {u = ca;}, setDefaultParams: function (ca) {v = ca;}, rest: aa, graph: z};
    ...
    __d("sdk.api", ["ApiClient", "sdk.Runtime"], function (a, b, c, d, e, f) {
        ...
        h.subscribe('ClientID.change', function (k) {g.setClientID(k);});
        h.subscribe('AccessToken.change', function (k) {
            i = k;
            g.setAccessToken(k);
        });
        g.setDefaultParams({sdk: 'joey'});
        g.setInvalidAccessTokenHandler(function () {if (i === h.getAccessToken())h.setAccessToken(null);});
        function j() {
            if (typeof arguments[0] === 'string') {g.graph.apply(g, arguments);}
    ...
    FB.provide('Array', {merge: function (a, b) {
        ...
        if (Object.prototype.toString.apply(a) === '[object Array]' || (!(a instanceof Function) && typeof a.length == 'number')) {
            if (a.forEach) {ES5(a, 'forEach', true, b);}
    ...
    FB.provide('EventProvider', {subscribers: function () {
        ...
        ES5(FB.Array, 'forEach', true, c, function (d, e) {if (d == b)c[e] = null;});
    }, monitor: function (a, b) {
        if (!b()) {
            var c = this, d = function () {if (b.apply(b, arguments))c.unsubscribe(a, d);};
            this.subscribe(a, d);
        }
    }, clear: function (a) {delete this.subscribers()[a];}, fire: function () {
        var a = Array.prototype.slice.call(arguments), b = a.shift(), c = this.subscribers()[b];
        if (c)ES5(c, 'forEach', true, function (d) {if (d)d.apply(this, a);});
    }, listen: function (a, event, b) {
        b.wrapper = FB.wrapFunction(b, 'entry', a + ':' + event);
        if (a.addEventListener) {a.addEventListener(event, b.wrapper, false);}
        else if (a.attachEvent)a.attachEvent('on' + event, b.wrapper);
    }, unlisten: function (a, event, b) {
        if (a.removeEventListener) {a.removeEventListener(event, b.wrapper, false);}
        ...
        g(i.prototype, {stub: function (j) {
            ...
            if (m) {
                q = function (t, u) {
                    ...
                    v[t] = u;
                    setTimeout(function () {o._write(ES5('JSON', 'stringify', false, v), k);}, 0);
                };
            }
            else q = function () {};
            if (!p) {
    ...
    __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function (a, b, c, d, e, f) {
        var g = b('Assert'), h = b('JSONRPC'), i = b('Queue'), j = new i(), k = new h(function (m) {j.enqueue(m);}), l = {local: k.local, remote: k.remote, stub: ES5(k.stub, 'bind', true, k), setInQueue: function (m) {
            g.isInstanceOf(i, m);
    ...
    __d("hasArrayNature", [], function (a, b, c, d, e, f) {
        function g(h) {return (!!h && (typeof h == 'object' || typeof h == 'function') && ('length' in h) && !('setInterval' in h) && (Object.prototype.toString.call(h) === "[object Array]" || ('callee' in h) || ('item' in h)));}
    ...
    __d("sdk.computeContentSize", ["DOMWrapper", "createArrayFrom"], function (a, b, c, d, e, f) {
        ...
        function i() {
            ...
            if (k.offsetWidth < k.scrollWidth) {m = k.scrollWidth + k.offsetLeft;}
    ...
    __d("sdk.Canvas.Environment", ["sdk.Runtime", "Log", "sdk.RPC"], function (a, b, c, d, e, f) {
        ...
        function j(m) {
            ...
            i.remote.getPageInfo(function (n) {m(n.result);});
        }
    ...
    __d("sdk.Canvas.Flash", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function (a, b, c, d, e, f) {
        ...
        function n(r) {r.style.visibility = 'hidden';}

        function o(r) {r.style.visibility = '';}
        ...
        h.local.hideFlashObjects = function () {p({state: 'opened'});};
        h.local.showFlashObjects = function () {p({state: 'closed'});};
        var q = {_setHideFlashCallback: function (r) {m = r;}, hideFlashElement: n, showFlashElement: o};
        e.exports = q;
    });
    __d("sdk.Canvas.Navigation", ["sdk.RPC", "Log", "sdk.Runtime"], function (a, b, c, d, e, f) {
        ...
        function k(n) {
            ...
            g.remote.getHash(function (o) {n(o.result);});
        }
    ...
    __d("sdk.Canvas", ["copyProperties", "sdk.RPC", "sdk.Runtime", "sdk.Canvas.IframeHandling", "sdk.Canvas.Environment", "sdk.Canvas.Tti", "sdk.Canvas.Flash", "sdk.Canvas.Navigation"], function (a, b, c, d, e, f) {
        ...
        h.stub('showDialog');
        var o = {isTabIframe: function () {return i.isEnvironment(i.ENVIRONMENTS.PAGETAB);}};
        g(o, j);
        g(o, k);
        g(o, l);
        g(o, m);
    ...
    __d("legacy:fb.ua", ["copyProperties", "FB", "UserAgent"], function (a, b, c, d) {
        ...
        h.mobile = function () {return !f._inCanvas && g.mobile();};
        f.provide('UA', h);
    }, 3);
    __d("insertIframe", ["guid", "GlobalCallback"], function (a, b, c, d, e, f) {
        ...
        function i(j) {
            ...
            if (document.attachEvent) {
                ...
                if (j.width !== undefined)if (j.width == '100%') {p.style.width = j.width;}
    ...
    FB.provide('Content', {_root: null, _hiddenRoot: null, append: function (a, b) {
        if (!b)if (!FB.Content._root) {
            ...
            if (!b) {
                ...
                b.id = 'fb-root';
                if (FB.UA.ie() || !document.body) {FB.Dom.ready(function () {document.body.appendChild(b);});}
        ...
        function g(h) {
            ...
            try {
                for (var l = 0; l < j.length; l++) {
                    ...
                    if (n) {i = i.frames[n[1]];}
                    else if (m === 'opener' || m === 'parent' || m === 'top') {i = i[m];}
                    else return null;
                }
            }
            catch (k) {return null;}
    ...
    __d("DOMEventListener", [], function (a, b, c, d, e, f) {
        ...
        if (window.addEventListener) {
            g = function (j, k, l) {j.addEventListener(k, l, false);};
            h = function (j, k, l) {j.removeEventListener(k, l, false);};
        }
        else if (window.attachEvent) {
            g = function (j, k, l) {j.attachEvent('on' + k, l);};
            h = function (j, k, l) {j.detachEvent('on' + k, l);};
        }
    ...
    __d("XDM", ["guid", "DOMEventListener", "DOMWrapper", "Flash", "Log", "UserAgent"], function (a, b, c, d, e, f) {
        ...
        q.register('fragment', (function () {
            ...
            function u(v) {
                ...
                var x = h.add(w, 'load', function () {
                    x.remove();
                    setTimeout(function () {w.parentNode.removeChild(w);}, 5000);
                });
                s.appendChild(w);
                w.src = v;
            }

            return {isAvailable: function () {return true;}, init: function (v) {
        ...
        q.register('flash', (function () {
            ...
            return {isAvailable: function () {return j.checkMinVersion('8.0.24');}, init: function (x) {
                ...
                w = setTimeout(function () {k.warn('The Flash component did not load within %s ms - ' + 'verify that the container is not set to hidden or invisible ' + 'using CSS as this will cause some browsers to not load ' + 'the components', v);}, v);
                r = true;
            }};
        })());
        q.register('postmessage', (function () {
            var r = false;
            return {isAvailable: function () {return !!o.postMessage;}, init: function (s) {
                ...
                var t = '_FB_' + s.channel, u = {send: function (v, w, x, y) {
                    ...
                    var z = function () {x.postMessage('_FB_' + y + v, w);};
                    if (l.ie() == 8) {setTimeout(z, 0);}
                    else z();
                }};
                if (r) {
                    s.whenReady(u);
    ...
    __d("sdk.XD", ["guid", "resolveWindow", "wrapFunction", "sdk.createIframe", "FB", "XDM", "Log", "QueryString", "Queue", "URL", "sdk.RPC", "sdk.Runtime", "XDConfig"], function (a, b, c, d, e, f) {
        ...
        function ga(ka, la) {
            ...
            switch (ka.xd_action) {
                case 'proxy_ready':
                    ...
                    na.start(function (qa) {ba.send(typeof qa === 'string' ? qa : o.encode(qa), la, oa.contentWindow, z + '_' + ma);});
                    break;
                case 'plugin_ready':
        ...
        function ha(ka, la) {
            ...
            if (typeof ka == 'string') {
                ...
                if (ka.substring(0, 1) == '{') {
                    try {ka = ES5('JSON', 'parse', false, ka);}
                    catch (ma) {
        ...
        r.getOutQueue().start(function (ka) {ia('facebook', 'FB_RPC:' + ka);});
        var ja = {rpc: r, _callbacks: {}, _forever: {}, _channel: z, _origin: aa, onMessage: ha, recv: ha, init: function (ka, la) {
            ...
            ca = true;
        }, sendToFacebook: ia, inform: function (ka, la, ma, na, oa) {ia('facebook', {method: ka, params: ES5('JSON', 'stringify', false, la || {}), behavior: oa || 'p', relation: ma});}, handler: function (ka, la, ma, na) {
    ...
    FB.provide('Dom', {containsCss: function (a, b) {
    ...
    }, addCss: function (a, b) {if (!FB.Dom.containsCss(a, b))a.className = a.className + ' ' + b;}, removeCss: function (a, b) {
        ...
        if (a.currentStyle) {
            b = b.replace(/-(\w)/g, function (e, f) {return f.toUpperCase();});
            c = a.currentStyle[b];
        }
        else {
            b = b.replace(/[A-Z]/g, function (e) {return '-' + e.toLowerCase();});
        ...
        if (b == 'opacity') {
            ...
            if (a.filters)if (a.filters.alpha == undefined) {a.filter = "alpha(opacity=" + c + ")";}
        ...
        else try {document.createStyleSheet().cssText = a;}
        catch (e) {if (document.styleSheets[0])document.styleSheets[0].cssText += a;}
    ...
    (function () {
        ...
        window.onload = function () {
            a();
            if (b)if (typeof b == 'string') {FB.safeEval(b);}
            else b();
        };
    })();
    FB.provide('Intl', (function () {
        ...
        function c(e, f) {
            if (f !== undefined)if (typeof f != 'object') {FB.log('The second arg to FB.Intl.tx() must be an Object for ' + 'FB.Intl.tx(' + e + ', ...)');}
            else {
                var g;
                for (var h in f)if (f.hasOwnProperty(h)) {
                    if (b(f[h])) {g = new RegExp('\{' + h + '\}' + a + '*', 'g');}
    ...
    FB.provide('', {Class: function (a, b, c) {
        ...
        var d = b || function () {};
        d.prototype = c;
        d.prototype.bind = function (e) {return ES5(e, 'bind', true, this);};
        ...
        return FB.Class(a, c ? c : function () {if (e.apply)e.apply(this, arguments);}, d);
    }, CLASSES: {}});
    FB.provide('Type', {isType: function (a, b) {
        while (a)if (a.constructor === b || a === b) {return true;}
    ...
    FB.provide('Dialog', {_dialogs: null, _lastYOffset: 0, _loaderEl: null, _overlayEl: null, _stack: [], _active: null, get: function (a) {return FB.Dialog._dialogs[a];}, _findRoot: function (a) {
        while (a) {
    ...
    }, _hideIPadOverlay: function () {if (FB.UA.ipad())FB.Dialog._overlayEl.className = 'hidden';}, showLoader: function (a, b) {
    ...
    }, _hideLoader: function () {if (FB.Dialog._loaderEl && FB.Dialog._loaderEl == FB.Dialog._active)FB.Dialog._loaderEl.style.top = '-10000px';}, _makeActive: function (a) {
        FB.Dialog._setDialogSizes();
        FB.Dialog._lowerActive();
        FB.Dialog._active = a;
        if (FB.Canvas)FB.Canvas.getPageInfo(function (b) {FB.Dialog._centerActive(b);});
    ...
    }, _removeStacked: function (a) {FB.Dialog._stack = ES5(FB.Dialog._stack, 'filter', true, function (b) {return b != a;});}, _centerActive: function (a) {
        ...
        if (FB.UA.ipad()) {FB.Dialog._centerActive();}
        ...
        if (a) {
            ...
            if (b) {
                FB.Dialog._hideLoader();
                if (FB.Dialog._stack.length > 0) {FB.Dialog.show(FB.Dialog._stack.pop());}
                else {
                    FB.Dialog._lowerActive();
                    FB.Dialog._restoreBodyPosition();
                    FB.Dialog._hideIPadOverlay();
            ...
            window.setTimeout(function () {a.parentNode.removeChild(a);}, 3000);
        }
    }, isActive: function (a) {
        var b = FB.Dialog._findRoot(a);
    ...
    FB.provide('QS', {encode: function (a, b, c) {
        b = b === undefined ? '&' : b;
        c = c === false ? function (e) {return e;} : encodeURIComponent;
        var d = [];
        ES5(FB.Array, 'forEach', true, a, function (e, f) {if (e !== null && typeof e != 'undefined')d.push(c(f) + '=' + c(e));});
        d.sort();
        return d.join(b);
    }, decode: function (a) {
    ...
    __d("legacy:fb.json", ["flattenObject", "FB", "ManagedError"], function (a, b, c, d) {
        ...
        f.provide('JSON', {stringify: function (h) {
            try {return ES5('JSON', 'stringify', false, h);}
            catch (i) {throw new g(i.message, i);}
        }, parse: function (h) {
            try {return ES5('JSON', 'parse', false, h);}
            catch (i) {throw new g(i.message, i);}
        }, flatten: e});
    }, 3);
    ...
    FB.provide('UIServer', {Methods: {}, _loadedNodes: {}, _defaultCb: {}, _resultToken: '"xxRESULTTOKENxx"', _forceHTTPS: false, genericTransform: function (a) {
        ...
        if (FB.TemplateUI && FB.TemplateUI.supportsTemplate(b, a)) {FB.TemplateUI.useCachedUI(b, a);}
        else {
            a.params = FB.JSON.flatten(a.params);
            var c = FB.QS.encode(a.params);
            if (!FB.UA.nativeApp() && FB.UIServer.urlTooLongForIE(a.url + '?' + c)) {a.post = true;}
            else if (c)a.url += '?' + c;
        }
        return a;
    }, urlTooLongForIE: function (a) {return a.length > 2000;}, getDisplayMode: function (a, b) {
        ...
        var b = function () {FB.UIServer._triggerDefault(a.id);};
        ...
        if (a.params && a.params.in_iframe) {
            if (a.ui_created) {FB.Dialog.showLoader(function () {FB.UIServer._triggerDefault(a.id);}, 0);}
            else FB.UIServer.iframe(a);
        }
        else if (FB.UA.nativeApp() && !a.ui_created) {
            a.frame = a.id;
            FB.Native.onready(function () {FB.UIServer.setLoadedNode(a, FB.Native.open(a.url + '#cb=' + a.frameName), 'native');});
        ...
        if (FB.initSitevars.rpc) {FB.XD.rpc.remote.showDialog(a.params, function (b) {a.cb(b.result);});}
        else {
            a.frame = window.name;
            delete a.url;
            delete a.size;
        ...
        if (FB.UA.mobile())if (FB.UA.ipad()) {return {width: 500, height: 590};}
        else if (FB.UA.android()) {return {width: screen.availWidth, height: screen.availHeight};}
        else {
        ...
        var b = function (c) {if (a.id in FB.UIServer._loadedNodes)FB.UIServer.setLoadedNode(a, c, 'iframe');};
        if (a.post) {FB.Content.insertIframe({url: 'about:blank', root: a.root, className: a.className, width: a.size.width, height: a.size.height, id: a.id, onInsert: b, onload: function (c) {FB.Content.submitToTarget({url: a.url, target: c.name, params: a.params});}});}
    ...
    }, _triggerDefault: function (a) {FB.UIServer._xdRecv({frame: a}, FB.UIServer._defaultCb[a] || function () {});}, _popupMonitor: function () {
        var a;
        for (var b in FB.UIServer._loadedNodes)if (FB.UIServer._loadedNodes.hasOwnProperty(b) && b in FB.UIServer._defaultCb) {
            ...
            win = c.node;
            try {
                if (win.closed) {FB.UIServer._triggerDefault(b);}
                else a = true;
            }
            catch (d) {}
        }
        if (a && !FB.UIServer._popupInterval) {FB.UIServer._popupInterval = window.setInterval(FB.UIServer._popupMonitor, 100);}
        ...
        return FB.XD.handler(function (d) {
            ...
            if (!e)return;
            if (d.type == 'resize') {FB.UIServer._handleResizeMessage(a, d);}
            else if (d.type == 'hide') {FB.Dialog.hide(e);}
        ...
        return FB.XD.handler(function (e) {FB.UIServer._xdRecv(e, a);}, c) + '&frame=' + b;
    }, _xdRecv: function (a, b) {
        var c = FB.UIServer.getLoadedNode(a.frame);
        if (c) {
            try {
                if (FB.Dom.containsCss(c, 'FB_UI_Hidden')) {window.setTimeout(function () {c.parentNode.parentNode.removeChild(c.parentNode);}, 3000);}
    ...
    __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], function (a, b, c, d, e, f) {
        ...
        var l = {setDomain: function (m) {
            ...
            j('fbm_', n, o.getTime());
        }, getDomain: function () {return i;}, loadMeta: function () {
            var m = k('fbm_');
            if (m) {
                var n = g.decode(m);
        ...
        }, loadSignedRequest: function () {return k('fbsr_');}, setSignedRequestCookie: function (m, n) {
            if (!m)throw new Error('Value passed to Cookie.setSignedRequestCookie ' + 'was empty.');
            j('fbsr_', m, n);
        }, clearSignedRequestCookie: function () {j('fbsr_', '', 0);}, setRaw: j};
        e.exports = l;
    });
    ...
    __d("Base64", [], function (a, b, c, d, e, f) {
        ...
        }, encodeObject: function (l) {return k.encode(ES5('JSON', 'stringify', false, l));}, decodeObject: function (l) {return ES5('JSON', 'parse', false, k.decode(l));}, encodeNums: function (l) {return String.fromCharCode.apply(String, ES5(l, 'map', true, function (m) {return g.charCodeAt((m | -(m > 63)) & -(m > 0) & 63);}));}};
        e.exports = k;
    });
    ...
    __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.getContextType", "guid", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, b, c, d, e, f) {
        ...
        function w(aa, ba) {
            ...
            if (aa)if (aa.userID) {da = aa.userID;}
        ...
        function y(aa, ba, ca) {
            return function (da) {
                ...
                if (da && da.access_token) {
                    ...
                    if (da.error && da.error === 'not_authorized') {ea = 'not_authorized';}
                    else ea = 'unknown';
                    w(null, ea);
        ...
        function z(aa) {
            ...
            var ca = y(aa, t, 'login_status'), da = r(q.resolve('www', true) + '/dialog/oauth/').setSearch(n.encode({client_id: o.getClientID(), response_type: 'token,signed_request,code', display: 'none', domain: location.hostname, origin: k(), redirect_uri: s.handler(function (ea) {
                ...
                if (ca(ea))u = setTimeout(function () {z();}, 1200000);
            }, 'parent'), sdk: 'joey'}));
    ...
    __d("legacy:fb.auth", ["sdk.Auth", "copyProperties", "FB", "sdk.getContextType", "guid", "Log", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function (a, b, c, d) {
        ...
        }, getAuthResponse: function () {return g.Auth.getAuthResponse();}, getAccessToken: function () {return k.getAccessToken() || null;}, getUserID: function () {return k.getUserID();}, login: function (q, r) {
        ...
        }, logout: function (q) {g.ui({method: 'auth.logout', display: 'hidden'}, q);}});
        if (l.migrate) {
            g.provide('Auth', e);
            ...
            if (o.mobile() && window.postMessage && window.localStorage) {g.Auth.staticAuthCheck(q);}
            ...
            if (g.Auth._loadState && q)g.Auth._refreshTimer = setTimeout(function () {g.getLoginStatus(null, true);}, 1200000);
            return aa;
        }, getAuthResponse: function () {return g._authResponse;}, xdResponseWrapper: function (q, r, s) {
            return function (t) {
                if (t && t.access_token) {
                ...
                else if (!g._authResponse && r) {g.Auth.setAuthResponse(r, 'connected');}
                else if (s === 'logout' || s === 'login_status') {
                    var x;
                    if (t.error && t.error === 'not_authorized') {x = 'not_authorized';}
                    else x = 'unknown';
    ...
    __d("sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "sdk.Runtime", "CanvasPrefetcherConfig"], function (a, b, c, d, e, f) {
        ...
        function p() {
            ...
            if (n == k.AUTOMATIC)ES5(ES5('Object', 'keys', false, u), 'forEach', true, function (v) {
                var w = u[v];
                ES5(h(document.getElementsByTagName(v)), 'forEach', true, function (x) {if (x[w])o.push(x[w]);});
            });
    ...
    FB.provide('UIServer.Methods', {'stream.share': {size: {width: 670, height: 340}, url: 'sharer.php', transform: function (a) {
        ...
        return a;
    }}, 'fbml.dialog': {size: {width: 575, height: 300}, url: 'render_fbml.php', loggedOutIframe: true, transform: function (a) {return a;}}, 'auth.logintofacebook': {size: {width: 530, height: 287}, url: 'login.php', transform: function (a) {
        ...
        return a;
    }, getXdRelation: function (a) {return FB.UIServer.MobileIframableMethod.getXdRelation(a);}}, feed: FB.UIServer.MobileIframableMethod, 'permissions.oauth': {url: 'dialog/oauth', size: {width: (FB.UA.mobile() ? null : 627), height: (FB.UA.mobile() ? null : 326)}, transform: function (a) {
        if (!FB._apiKey) {
        ...
        if (!FB._apiKey) {FB.log('FB.logout() called before calling FB.init().');}
        else if (!FB.getAuthResponse()) {FB.log('FB.logout() called without an access token.');}
        else {
    ...
    FB.provide('XFBML', {_renderTimeout: 30000, _widgetPipeThreshold: 0, getElements: function (a, b, c) {
        ...
        e = ES5(e, 'filter', true, function (f) {return !f.hasChildNodes() || (f.childNodes.length === 1 && f.childNodes[0].nodeType === 3);});
        ...
        ES5(FB.XFBML._tagInfos, 'forEach', true, function (f) {
            ...
            var g;
            if (e[f.localName] !== undefined) {g = e[f.localName];}
        ...
        window.setTimeout(function () {if (c > 0)FB.log(c + ' XFBML tags failed to render in ' + FB.XFBML._renderTimeout + 'ms.');}, FB.XFBML._renderTimeout);
        d();
    }, registerTag: function (a) {FB.XFBML._tagInfos.push(a);}, shouldUseWidgetPipe: function () {
    ...
    }, getAttr: function (a, b) {return (a.getAttribute(b) || a.getAttribute(b.replace(/_/g, '-')) || a.getAttribute(b.replace(/-/g, '_')) || a.getAttribute(b.replace(/-/g, '')) || a.getAttribute(b.replace(/_/g, '')) || a.getAttribute('data-' + b) || a.getAttribute('data-' + b.replace(/_/g, '-')) || a.getAttribute('data-' + b.replace(/-/g, '_')) || a.getAttribute('data-' + b.replace(/-/g, '')) || a.getAttribute('data-' + b.replace(/_/g, '')) || null);}, _processElement: function (a, b, c) {
        var d = a._element;
        if (d) {
            ...
            if (FB.XFBML.IframePluginTags[e] || FB.CLASSES[b.className.substr(3)]) {f();}
            else FB.log('Tag ' + b.className + ' was not found.');
        }
    }, _getDomElements: function (a, b, c) {
        var d = b + ':' + c;
        if (FB.UA.firefox()) {return a.getElementsByTagNameNS(document.body.namespaceURI, d);}
        else if (FB.UA.ie() < 9) {
            try {
        ...
        {localName: 'subscribe'},
        {localName: 'want'}
    ], _widgetPipeEnabledTagCount: 0, _widgetPipeIsEnabled: function () {return FB.widgetPipeEnabledApps && FB.widgetPipeEnabledApps[FB._apiKey] !== undefined;}});
    (function () {
        try {if (document.namespaces && !document.namespaces.item.fb)document.namespaces.add('fb');}
        catch (a) {}
    }());
    __d("XFBML", ["FB", "Log", "createArrayFrom", "dotAccess"], function (a, b, c, d, e, f) {
        ...
        function p(s) {
            var t = {};
            ES5(i(s.attributes), 'forEach', true, function (u) {t[u.name] = u.value;});
            return t;
        }
        ...
        function q(s, t, u) {
            ...
            ES5(i(s.getElementsByTagName('*')), 'forEach', true, function (aa) {
                var ba, ca;
                if ((ba = k[aa.nodeName.toLowerCase()])) {ca = n(aa);}
                ...
                var fa = function () {
                    if (aa.getAttribute('fb-xfbml-state') == 'parsed') {g.Event.subscribe('xfbml.render', fa);}
                    else {
            ...
            var z = 30000;
            window.setTimeout(function () {if (w > 0)h.warn('%s tags failed to render in %s ms', w, z);}, z);
            y();
        }
        ...
        var r = {registerTag: function (s) {
            ...
            l[t] = s.className;
        }, parse: function (s, t) {q(s || document.body, t || function () {}, true);}, parseNew: function () {q(document.body, function () {}, false);}};
        e.exports = r;
    });
    ...
    __d("RegisterTags", ["XFBML", "PluginCustomClass", "PluginTags"], function (a, b, c, d, e, f) {
        ...
        function j(k) {return k.length > 0 ? k.charAt(0).toUpperCase() + k.substr(1) : '';}

        ES5(ES5('Object', 'keys', false, i), 'forEach', true, function (k) {g.registerTag({xmlns: 'fb', localName: k.replace(/_/g, '-'), className: 'FB.XFBML.IframePlugin'});});
        ES5(h, 'forEach', true, function (k) {g.registerTag({xmlns: 'fb', localName: k, className: 'FB.XFBML.' + ES5(k.split('-'), 'map', true, j).join('')});});
    });
    FB.Class('XFBML.IframePlugin', function (a, b, c) {
        ...
        function e(n) {FB.Event.fire('xfbml.resize', {width: n.width, height: n.height, pluginID: FB.XFBML.getAttr(a, 'plugin-id')});}

        var f = {string: function (n) {return n;}, bool: function (n) {return (/^(?:true|1|yes|on)$/i).test(n);}, url: function (n) {return FB.URI.resolve(n);}, px: function (n) {return (/^(\d+)(?:px)?$/).test(n) ? parseInt(RegExp.$1, 10) : undefined;}};
        ...
        j.locale = FB._locale;
        j.sdk = 'joey';
        var k = ES5(function (n) {this.fire('xd.' + n.type, n);}, 'bind', true, this);
        j.channel = FB.XD.handler(k, 'parent.parent', true);
        var l = FB.guid();
        this.subscribe('xd.verify', function (n) {FB.XD.sendToFacebook(l, {method: 'xd/verify', params: ES5('JSON', 'stringify', false, n.token), behavior: FB.Arbiter.BEHAVIOR_PERSISTENT});});
    ...
    ES5(ES5('Object', 'keys', false, FB.XFBML.IframePluginTags), 'forEach', true, function (a) {FB.XFBML.registerTag({xmlns: 'fb', localName: a.replace(/_/g, '-'), className: 'FB.XFBML.IframePlugin'});});
    ...
    FB.Class('XFBML.Element', function (a, b, c) {this.dom = a;}, FB.copy({getAttribute: function (a, b, c) {
    ...
    FB.subclass('XFBML.IframeWidget', 'XFBML.Element', null, {_iframeName: null, _showLoader: true, _refreshOnAuthChange: false, _allowReProcess: false, _fetchPreCachedLoader: false, _visibleAfter: 'load', _widgetPipeEnabled: false, _borderReset: false, getUrlBits: function () {throw new Error('Inheriting class needs to implement getUrlBits().');}, setupAndValidate: function () {return true;}, oneTimeSetup: function () {}, getSize: function () {}, getIframeName: function () {
    ...
    }, getIframeTitle: function () {}, getChannelUrl: function () {
        if (!this._channelUrl) {
            var a = this;
            this._channelUrl = FB.XD.handler(function (b) {a.fire('xd.' + b.type, b);}, 'parent.parent', true);
        }
        return this._channelUrl;
    }, getIframeNode: function () {return this.dom.getElementsByTagName('iframe')[0];}, arbiterInform: function (event, a, b) {FB.XD.sendToFacebook(this.getIframeName(), {method: event, params: ES5('JSON', 'stringify', false, a || {}), behavior: b || FB.Arbiter.BEHAVIOR_PERSISTENT});}, _arbiterInform: function (event, a, b) {
        var c = 'parent.frames["' + this.getIframeNode().name + '"]';
        FB.Arbiter.inform(event, a, c, b);
    }, getDefaultWebDomain: function () {return 'www';}, getDefaultStaticDomain: function () {return 'cdn';}, process: function (a) {
        if (this._done) {
        ...
        if (this._visibleAfter != 'immediate') {FB.Dom.addCss(this.dom, 'fb_hide_iframes');}
        ...
        this._resizeFlow(b);
        this.loaded = false;
        this.subscribe('iframe.onload', ES5(function () {this.loaded = true;}, 'bind', true, this));
        ...
        return a;
    }, _getWidgetPipeShell: function () {return FB.getDomain('www') + 'common/widget_pipe_shell.php';}, _oneTimeSetup: function () {
        ...
        this.subscribe('xd.verify', ES5(function (a) {this.arbiterInform('xd/verify', a.token);}, 'bind', true, this));
        this.oneTimeSetup();
    ...
    }, _getQS: function () {return FB.copy({api_key: FB._apiKey, locale: FB._locale, sdk: 'joey', ref: this.getAttribute('ref')}, this.getUrlBits().params);}, _getURL: function () {
    ...
    }, _postRequest: function () {FB.Content.submitToTarget({url: this._getURL(), target: this.getIframeNode().name, params: this._getQS()});}});
    FB.provide('XFBML.IframeWidget', {widgetPipeIframeCount: 0, masterWidgetPipeIframe: null, allWidgetPipeIframes: {}, batchWidgetPipeRequests: function () {
        ...
        FB.Content.insertIframe({url: 'about:blank', root: e, name: c, className: 'fb_hidden fb_invisible', onload: function () {FB.Content.submitToTarget({url: FB._domain.www + 'plugins/pipe/', target: c, params: b}, 1);}});
    ...
    FB.subclass('XFBML.CreateEventButton', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        ...
        return true;
    }, getUrlBits: function () {return {name: 'create_event_button', params: this._attr};}});
    FB.subclass('Waitable', 'Obj', function () {}, {set: function (a) {this.setProperty('value', a);}, error: function (a) {this.fire("error", a);}, wait: function (a, b) {
    ...
    FB.subclass('Data.Query', 'Waitable', function () {
        ...
        switch (this.where.type) {
            ...
            case 'index':
                ...
                break;
            case 'in':
                if (this.where.value.length == 1) {a += this.where.key + '=' + this._encode(this.where.value[0]);}
                else a += this.where.key + ' in (' + ES5(this.where.value, 'map', true, this._encode).join(',') + ')';
                break;
        }
        return a;
    }, _encode: function (a) {return typeof(a) == 'string' ? FB.String.quote(a) : a;}, toString: function () {return '#' + this.name;}, _toFields: function (a) {return ES5(a.split(','), 'map', true, function (b) {return ES5(b, 'trim', true);});}, _parseWhere: function (s) {
        ...
        if (type == 'index') {result = {type: 'index', key: re[1], value: value};}
    ...
    FB.provide('Data', {query: function (a, b) {
        ...
        if (typeof(b) == 'string') {
            var e = b;
            b = function (f) {return FB.safeEval(e);};
        }
        ...
        return c;
    }, process: function (a) {FB.Data._process(a);}, _getValue: function (a) {return FB.Type.isType(a, FB.Waitable) ? a.value : a;}, _selectByIndex: function (a, b, c, d) {
        ...
        FB.Data._waitToProcess();
        return e;
    }, _waitToProcess: function () {if (FB.Data.timer < 0)FB.Data.timer = setTimeout(function () {FB.Data._process();}, 10);}, _process: function (a) {
        FB.Data.timer = -1;
        ...
        for (var d = 0; d < c.length; d++) {
            var e = c[d];
            if (e.where.type == 'index' && !e.hasDependency()) {FB.Data._mergeIndexQuery(e, b);}
            else b[e.name] = e;
        }
        var f = {q: {}};
        FB.copy(f.q, b, true, function (g) {return g.toFql();});
        if (a)f.access_token = a;
        FB.api('/fql', 'GET', f, function (g) {
            if (g.error) {ES5(ES5('Object', 'keys', false, b), 'forEach', true, function (h) {b[h].error(new Error(g.error.message));});}
            else ES5(g.data, 'forEach', true, function (h) {b[h.name].set(h.fql_result_set);});
        });
        ...
        f.wait(function (g) {a.set(ES5(g, 'filter', true, function (h) {return h[c] == d;}));});
    }, timer: -1, queue: []});
    FB.provide('Frictionless', {_allowedRecipients: {}, _useFrictionless: false, _updateRecipients: function () {
        ...
        FB.api('/me/apprequestformerrecipients', function (a) {
            if (!a || a.error)return;
            ES5(a.data, 'forEach', true, function (b) {FB.Frictionless._allowedRecipients[b.recipient_id] = true;}, false);
        });
    }, init: function () {
        FB.Frictionless._useFrictionless = true;
        FB.getLoginStatus(function (a) {if (a.status == 'connected')FB.Frictionless._updateRecipients();});
        FB.Event.subscribe('auth.login', function (a) {if (a.authResponse)FB.Frictionless._updateRecipients();});
        ...
        a = ES5(a, 'map', true, function (d) {return ES5(d, 'trim', true);});
        var b = true, c = false;
    ...
    FB.Dom.ready(function () {FB.require('DOMWrapper').setRoot(FB.Content.appendHidden(document.createElement('div')));});
    ...
    FB.provide('', {initSitevars: {}, init: function (a) {
        ...
        if (FB._apiKey) {
            if (a.authResponse) {FB.Auth.setAuthResponse(a.authResponse, 'connected');}
                ...
                catch (c) {FB.Cookie.clearSignedRequestCookie();}
                FB.Cookie.loadMeta();
            }
        ...
        if (FB.XFBML && a.xfbml) {
            if (FB.XFBML.IframeWidget)FB.Event.subscribe('xfbml.parse', function () {FB.XFBML.IframeWidget.batchWidgetPipeRequests();});
            window.setTimeout(function () {
                if (FB.initSitevars.parseXFBMLBeforeDomReady) {
                    FB.XFBML.parse();
                    var e = window.setInterval(function () {FB.XFBML.parse();}, 100);
        ...
        if (!FB._initialized) {
            ...
            FB.Runtime.subscribe('AccessToken.change', function (e) {if (!e && FB.Runtime.getLoginStatus() === 'connected')FB.getLoginStatus(null, true);});
        }
        ...
        ES5(FB.Array.toArray(document.getElementsByTagName('script')), 'forEach', true, function (b) {
            if (b.src) {
                ...
                if (c) {
                    ...
                    ES5(FB.Array, 'forEach', true, d, function (e, f) {if (e == '0')d[f] = 0;});
                    FB.init(d);
                }
            }
        });
    ...
    FB.provide('UIServer.Methods', {'pay.prompt': {transform: function (a) {
        var b = FB.XD.handler(function (c) {a.cb(ES5('JSON', 'parse', false, c.response));}, 'parent.frames[' + (window.name || 'iframe_canvas') + ']');
        a.params.channel = b;
    ...
    FB.provide('UIServer.Methods', {pay: {size: {width: 555, height: 120}, noHttps: true, connectDisplay: 'popup', transform: function (a) {
        ...
        var b = FB.XD.handler(function (c) {a.cb(c.response ? ES5('JSON', 'parse', false, c.response) : null);}, 'parent.frames[' + (window.name || 'iframe_canvas') + ']');
        a.params.channel = b;
        a.params.uiserver = true;
        FB.Arbiter.inform('Pay.Prompt', a.params);
        return false;
    }}});
    FB.provide('Helper', {isUser: function (a) {return a < 2.2e+09 || (a >= 1e+14 && a <= 100099999989999) || (a >= 8.9e+13 && a <= 89999999999999);}, getLoggedInUser: function () {return FB.getUserID();}, upperCaseFirstChar: function (a) {
        ...
        if (a)if (typeof a === 'string') {FB.safeEval(a);}
    ...
    FB.provide('TemplateData', {_initialized: false, _version: 0, _response: null, _localStorageTimeout: 60 * 60 * 24, _enabled: true, enabled: function () {return FB.TemplateData._enabled && FB.TemplateData._initialized && FB.TemplateData.supportsLocalStorage() && FB.Runtime.getLoginStatus() == 'connected' && FB.TemplateData.getResponse();}, supportsLocalStorage: function () {
        ...
        try {a._response = a._response || (a.supportsLocalStorage() && ES5('JSON', 'parse', false, localStorage.FB_templateDataResponse || "null"));}
        catch (b) {a._response = null;}
    ...
    }, clear: function () {FB.TemplateData.saveResponse(null);}, update: function (a) {
    ...
    FB.subclass('TemplateUI', 'Obj', function (a, b) {
        ...
        FB.XD.handler(ES5(this, 'bind', true, function (g) {if (g.type == 'getParams')this.setProperty('getParamsCb', g.returnCb);}), 'parent', true, this.cachedCall.frameName);
        if (c) {
    ...
    FB.provide('TemplateUI', {
        ...
        }, initCache: function () {FB.TemplateUI._timer = setInterval(function () {FB.TemplateUI.populateCache(true);}, 2000);}, supportsTemplate: function (a, b) {return FB.TemplateData.enabled() && FB.TemplateUI.paramsAllowTemplate(a, b.params) && b.params.display === 'touch' && FB.UA.mobile();}, paramsAllowTemplate: function (a, b) {
        ...
        }, isFrictionlessAppRequest: function (a, b) {return a === 'apprequests' && FB.Frictionless && FB.Frictionless._useFrictionless;}, willWriteOnGet: function (a, b) {return FB.TemplateUI.isFrictionlessAppRequest(a, b) && b.to && FB.Frictionless.isAllowed(b.to);}
    });
    FB.subclass('XFBML.Activity', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', _refreshOnAuthChange: true, setupAndValidate: function () {
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'activity', params: this._attr};}});
    FB.subclass('XFBML.ButtonElement', 'XFBML.Element', null, {_allowedSizes: ['icon', 'small', 'medium', 'large', 'xlarge'], onClick: function () {throw new Error('Inheriting class needs to implement onClick().');}, setupAndValidate: function () {return true;}, getButtonMarkup: function () {return this.getOriginalHTML();}, getOriginalHTML: function () {return this._originalHTML;}, process: function () {
    ...
    }, getUrlBits: function () {return {name: 'facepile', params: this._attr};}});
    ...
    FB.subclass('XFBML.Comments', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function () {
        ...
        if (!a.href) {
            ...
            if (!a.xid) {
                ...
                if (b > 0) {a.xid = encodeURIComponent(document.URL.substring(0, b));}
            ...
            if (c) {
                a.fb_comment_id = c;
                this.subscribe('render', ES5(function () {if (!window.location.hash)window.location.hash = this.getIframeNode().id;}, 'bind', true, this));
            }
        }
        this._attr = a;
        return true;
    ...
    }, getUrlBits: function () {return {name: 'comments', params: this._attr};}, getDefaultWebDomain: function () {
        if (this._attr.mobile) {return 'https_m';}
        ...
        var e = 40, f = {}, g = {}, h = null, i = a.style, j = setInterval(ES5(function () {
            ...
            ES5(FB.Array, 'forEach', true, b, ES5(function (l, m) {
                ...
                ES5(FB.Array, 'forEach', true, f[m], function (p, q) {
                    if (isNaN(g[m][q].numPart) && g[m][q].textPart == '?') {o = p.numPart + p.textPart;}
                    else if (isNaN(p.numPart)) {o = p.textPart;}
    ...
    FB.subclass('XFBML.ConnectBar', 'XFBML.Element', null, {_initialHeight: null, _initTopMargin: 0, _picFieldName: 'pic_square', _page: null, _displayed: false, _notDisplayed: false, _container: null, _animationSpeed: 0, process: function () {
        ...
        var d = this;
        ES5(FB.Array.toArray(b.getElementsByTagName('a')), 'forEach', true, function (g) {g.onclick = ES5(d._clickHandler, 'bind', true, d);});
        this._page = document.body;
        var e = 0;
        if (this._page.parentNode) {e = Math.round((parseFloat(FB.Dom.getStyle(this._page.parentNode, 'height')) - parseFloat(FB.Dom.getStyle(this._page, 'height'))) / 2);}
        else e = parseInt(FB.Dom.getStyle(this._page, 'marginTop'), 10);
        e = isNaN(e) ? 0 : e;
        this._initTopMargin = e;
        if (!window.XMLHttpRequest) {c.className += " fb_connect_bar_container_ie6";}
        else {
        ...
        if (FB.UA.ie()) {f.backgroundPositionY = this._initialHeight + 'px';}
        ...
        if (FB.UA.ie()) {a.backgroundPositionY = '0px';}
        else a.backgroundPosition = '? 0px';
        var b = (this._animationSpeed == 0) ? 0 : 300;
        FB.Anim.ate(this._page, a, b);
        FB.Anim.ate(this._container, {top: (-1 * this._initialHeight) + 'px'}, b, function (c) {c.parentNode.removeChild(c);});
    ...
    FB.subclass('XFBML.Degrees', 'XFBML.IframeWidget', null, {_showLoader: false, setupAndValidate: function () {
        ...
        return true;
    }, getSize: function () {return {width: 500, height: 25};}, getUrlBits: function () {return {name: 'degrees', params: this._attr};}});
    ...
    FB.subclass('XFBML.Fan', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', setupAndValidate: function () {
        ...
        if (!a)if ((!this._attr.connections || this._attr.connections === '0') && !this._attr.stream) {a = 65;}
        else if (!this._attr.connections || this._attr.connections === '0') {a = 375;}
        else if (!this._attr.stream) {a = 250;}
        else a = 550;
        if (this._attr.logobar)a += 25;
        this._attr.height = a;
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'fan', params: this._attr};}});
    ...
    }, {_visibleAfter: 'load', _showLoader: false, getSize: function () {return {width: this._iframeWidth, height: this._iframeHeight};}, getUrlBits: function () {return {name: 'comment_widget_shell', params: this._attr};}});
    ...
    FB.subclass('XFBML.EdgeWidget', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _showLoader: false, _rootPadding: null, setupAndValidate: function () {
    ...
    }, getSize: function () {return {width: this._getWidgetWidth(), height: this._getWidgetHeight()};}, _getWidgetHeight: function () {
        ...
        if (k < l[a].min) {k = l[a].min;}
        else if (k > l[a].max)k = l[a].max;
        return k;
    }, _getLayout: function () {return this._getAttributeFromList('layout', 'standard', ['standard', 'button_count', 'box_count', 'simple']);}, _shouldShowFaces: function () {return this._getLayout() === 'standard' && this._getBoolAttribute('show-faces', true);}, _handleEdgeCommentDialogPresentation: function (a) {
        if (!this.isValid())return;
    ...
    }, _getHeightOffset: function (a) {return parseFloat(a['anchorGeometry[y]']) + parseFloat(a['anchorPosition[y]']) + this._rootPadding.top;}, _getWidthOffset: function (a) {
        ...
        if (FB._localeIsRtl) {g = f < c;}
        else if ((c + f) > e)g = true;
        if (g)b += parseFloat(a['anchorGeometry[x]']) - f;
        return b;
    }, _getCommonEdgeCommentWidgetOpts: function (a, b) {return {colorscheme: this._attr.colorscheme, commentNode: b, controllerID: a.controllerID, nodeImageURL: a.nodeImageURL, nodeRef: this._attr.ref, nodeTitle: a.nodeTitle, nodeURL: a.nodeURL, nodeSummary: a.nodeSummary, width: parseFloat(a.width), height: parseFloat(a.height), relativeHeightOffset: this._getHeightOffset(a), relativeWidthOffset: this._getWidthOffset(a), error: a.error, siderender: a.siderender, extended_social_context: a.extended_social_context, anchorTargetX: parseFloat(a['query[anchorTargetX]']) + this._rootPadding.left, anchorTargetY: parseFloat(a['query[anchorTargetY]']) + this._rootPadding.top};}, _handleEdgeCommentDialogDismissal: function (a) {
        if (this._commentWidgetNode) {
            this.dom.removeChild(this._commentWidgetNode);
            delete this._commentWidgetNode;
        }
    }, _handleEdgeCommentDialogHide: function () {if (this._commentWidgetNode)this._commentWidgetNode.style.display = "none";}, _handleEdgeCommentDialogShow: function () {if (this._commentWidgetNode)this._commentWidgetNode.style.display = "block";}, _fireEventAndInvokeHandler: function (a, b) {
    ...
    }, {_showLoader: true, getUrlBits: function () {return {name: 'send_button_form_shell', params: this._attr};}, oneTimeSetup: function () {this.subscribe('xd.messageSent', ES5(this._onMessageSent, 'bind', true, this));}, _onMessageSent: function () {FB.Event.fire('message.send', this._attr.nodeURL, this);}});
    FB.subclass('XFBML.Send', 'XFBML.EdgeWidget', null, {setupAndValidate: function () {
        ...
        this._rootPadding = {left: parseFloat(FB.Dom.getStyle(this.dom, 'paddingLeft')), top: parseFloat(FB.Dom.getStyle(this.dom, 'paddingTop'))};
        return true;
    }, getUrlBits: function () {return {name: 'send', params: this._attr};}, _createEdgeCommentWidget: function (a, b) {
        var c = this._getCommonEdgeCommentWidgetOpts(a, b);
        return new FB.XFBML.SendButtonFormWidget(c);
    }, getSize: function () {return {width: FB.XFBML.Send.Dimensions.width, height: FB.XFBML.Send.Dimensions.height};}});
    FB.provide('XFBML.Send', {Dimensions: {width: 80, height: 25}});
    FB.subclass('XFBML.Like', 'XFBML.EdgeWidget', null, {_widgetPipeEnabled: false, getUrlBits: function () {return {name: 'like', params: this._attr};}, _createEdgeCommentWidget: function (a, b) {
        if ('send' in this._attr && 'widget_type' in a && a.widget_type == 'send') {
            var c = this._getCommonEdgeCommentWidgetOpts(a, b);
            return new FB.XFBML.SendButtonFormWidget(c);
        }
        else return this._callBase("_createEdgeCommentWidget", a, b);
    }, getIframeTitle: function () {return 'Like this content on Facebook.';}});
    FB.subclass('XFBML.LikeBox', 'XFBML.EdgeWidget', null, {_visibleAfter: 'load', setupAndValidate: function () {
        ...
        if (this._attr.connections === '0') {this._attr.show_faces = false;}
        ...
        var a = this._attr.height;
        if (!a)if (!this._attr.show_faces && !this._attr.stream) {a = 62;}
        else {
            a = 95;
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'likebox', params: this._attr};}, _onLiked: function () {FB.Helper.fireEvent('edge.create', this);}, _onUnliked: function () {FB.Helper.fireEvent('edge.remove', this);}});
    FB.subclass('XFBML.LiveStream', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', setupAndValidate: function () {
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {
    ...
    FB.subclass('XFBML.LoginButton', 'XFBML.IframeWidget', null, {_showLoader: false, setupAndValidate: function () {
        ...
        if (b)this.subscribe('xd.refreshLoginStatus', ES5(function () {FB.getLoginStatus(ES5(function (c) {FB.Helper.invokeHandler(b, this, [c]);}, 'bind', true, this));}, 'bind', true, this));
        return true;
    }, oneTimeSetup: function () {
    ...
    }, getSize: function () {return {width: this._attr.width, height: 94};}, getUrlBits: function () {return {name: 'login_button', params: this._attr};}});
    FB.subclass('XFBML.Name', 'XFBML.Element', null, {process: function () {
        ...
        var a = [];
        if (this._firstnameonly) {a.push('first_name');}
        else if (this._lastnameonly) {a.push('last_name');}
        else a.push('name');
        if (this._subjectId) {
            a.push('sex');
        ...
        FB.Event.monitor('auth.statusChange', ES5(this, 'bind', true, function () {
            ...
            if (!this._uid)return;
            if (FB.Helper.isUser(this._uid)) {b = FB.Data._selectByIndex(a, 'user', 'uid', this._uid);}
            else b = FB.Data._selectByIndex(['name', 'id'], 'profile', 'id', this._uid);
            b.wait(ES5(this, 'bind', true, function (c) {
                if (this._subjectId == this._uid) {this._renderPronoun(c[0]);}
        ...
        if (this._uid == FB.Connect.get_loggedInUser() && this._getBoolAttribute('use-you', true)) {
            if (this._possessive) {
                if (this._reflexive) {b = 'your own';}
                else b = 'your';
            }
            else if (this._reflexive) {b = 'yourself';}
            else b = 'you';
        }
        else switch (a.sex) {
            case 'male':
                if (this._possessive) {b = this._reflexive ? 'his own' : 'his';}
                else if (this._reflexive) {b = 'himself';}
                else if (c) {b = 'him';}
                else b = 'he';
                break;
            case 'female':
                if (this._possessive) {b = this._reflexive ? 'her own' : 'her';}
                else if (this._reflexive) {b = 'herself';}
                else if (c) {b = 'her';}
                else b = 'she';
                break;
            default:
                if (this._getBoolAttribute('use-they', true)) {
                    if (this._possessive) {
                        if (this._reflexive) {b = 'their own';}
                        else b = 'their';
                    }
                    else if (this._reflexive) {b = 'themselves';}
                    else if (c) {b = 'them';}
                    else b = 'they';
                }
                else if (this._possessive) {
                    if (this._reflexive) {b = 'his/her own';}
                    else b = 'his/her';
                }
                else if (this._reflexive) {b = 'himself/herself';}
                else if (c) {b = 'him/her';}
                else b = 'he/she';
                break;
        }
        ...
        if (this._uid == FB.Helper.getLoggedInUser() && this._getBoolAttribute('use-you', true)) {
            if (this._reflexive) {
                if (this._possessive) {b = 'your own';}
                else b = 'yourself';
            }
            else if (this._possessive) {b = 'your';}
            else b = 'you';
        }
        else if (a) {
            if (null === a.first_name)a.first_name = '';
            if (null === a.last_name)a.last_name = '';
            if (this._firstnameonly && a.first_name !== undefined) {b = FB.String.escapeHTML(a.first_name);}
        ...
        if (b) {
            if (this._getBoolAttribute('capitalize', false))b = FB.Helper.upperCaseFirstChar(b);
            if (a && this._linked) {c = FB.Helper.getProfileLink(a, b, this.getAttribute('href', null));}
            else c = b;
        }
    ...
    FB.subclass('XFBML.PageEvents', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        ...
        return true;
    }, getUrlBits: function () {return {name: 'page_events', params: this._attr};}});
    FB.subclass('XFBML.ProfilePic', 'XFBML.Element', null, {process: function () {
        ...
        FB.Event.monitor('auth.statusChange', ES5(this, 'bind', true, function () {
            ...
            if (FB.Runtime.getLoginStatus() !== 'unknown' && f) {FB.Data._selectByIndex(['name', b], FB.Helper.isUser(f) ? 'user' : 'profile', FB.Helper.isUser(f) ? 'uid' : 'id', f).wait(g);}
            else g();
        }));
    }});
    ...
    FB.subclass('XFBML.Recommendations', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', _refreshOnAuthChange: true, setupAndValidate: function () {
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'recommendations', params: this._attr};}});
    FB.subclass('XFBML.RecommendationsBar', 'XFBML.IframeWidget', null, {getUrlBits: function () {return {name: 'recommendations_bar', params: this._attr};}, setupAndValidate: function () {
        function a(j, k) {
            ...
            return function () {
                if (!m) {
                    ...
                    if (o - l < j) {m = window.setTimeout(n, j - (o - l));}
                    else n();
                }
                return true;
            };
        ...
        function c(j) {return Math.max(parseInt(j, 10) || 30, 10);}
        ...
        this.animate = false;
        this.subscribe('xd.signal_animation', ES5(function () {this.animate = true;}, 'bind', true, this));
        return true;
    }, getSize: function () {return {height: 25, width: (this._attr.action == 'recommend' ? 140 : 96)};}, calculateVisibility: function () {
    ...
    FB.subclass('XFBML.Rectangle', 'XFBML.IframeWidget', null, {_widgetPipeEnabled: true, setupAndValidate: function () {
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'test_rectangle', params: this._attr};}});
    FB.subclass('XFBML.Registration', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _baseHeight: 167, _fieldHeight: 28, _skinnyWidth: 520, _skinnyBaseHeight: 173, _skinnyFieldHeight: 52, setupAndValidate: function () {
        ...
        if (this._attr.onvalidate)this.subscribe('xd.validate', ES5(this, 'bind', true, function (a) {
            var b = ES5('JSON', 'parse', false, a.value), c = ES5(function (e) {this.arbiterInform('Registration.Validation', {errors: e, id: a.id});}, 'bind', true, this), d = FB.Helper.executeFunctionByName(this._attr.onvalidate, b, c);
            if (d)c(d);
        }));
        ...
        return true;
    }, getSize: function () {return {width: this._attr.width, height: this._getHeight()};}, _getHeight: function () {
        if (this._attr.height)return this._attr.height;
        var a;
        if (!this._attr.fields) {a = ['name'];}
        else try {a = ES5('JSON', 'parse', false, this._attr.fields);}
        catch (b) {a = this._attr.fields.split(/,/);}
        if (this._attr.width < this._skinnyWidth) {return this._skinnyBaseHeight + a.length * this._skinnyFieldHeight;}
        else return this._baseHeight + a.length * this._fieldHeight;
    }, getUrlBits: function () {return {name: 'registration', params: this._attr};}, getDefaultWebDomain: function () {return 'https_www';}, _onAuthLogin: function () {
    ...
    FB.subclass('XFBML.ShareButton', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        ...
        return true;
    }, getUrlBits: function () {return {name: 'share_button', params: this._attr};}, getSize: function () {return {height: 60, width: 200};}});
    ...
    }, getSize: function () {return {width: this._attr.width, height: this._attr.height};}, getUrlBits: function () {return {name: 'social_context', params: this._attr};}});
    void(0);
