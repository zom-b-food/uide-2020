...
(function () {
    ...
    STMBLPN.trim = function (str) {return str.replace(/^\s+|\s+$/g, '');};
    ...
    }, ready: function (f) {/in/.test(document.readyState) ? setTimeout('STMBLPN.events.ready(' + f + ')', 9) : f();}};
    ...
    STMBLPN.isNode = function (o) {return(typeof Node === "object" ? o instanceof Node : typeof o === "object" && typeof o.nodeType === "number" && typeof o.nodeName === "string");};
...
(function () {
    if (STMBLPN && STMBLPN.Widget) {return;}
    STMBLPN.Widget = function (opts) {this.init(opts);};
    (function () {
        ...
        STMBLPN.Widget.prototype = function () {
            ...
            return {
                init: function (opts) {
                    ...
                    if (this.selfContainer) {STMBLPN.byId(this.id).appendChild(iframe);}
                    else {
                        if (parent)
