...
window.FB || (function () {
    ...
    __d("FB", ["guid", "dotAccess", "copyProperties", "safeEval", "wrapFunction", "sdk.ErrorHandling", "GlobalCallback", "sdk.Insights", "Log", "sdk.Scribe", "QueryString", "UrlMap", "sdk.Runtime", "SDKConfig"], function (a, b, c, d, e, f) {
        ...
        if (i(g, 'api.whitelist.length')) {
            w = {};
            ES5(g.api.whitelist, 'forEach', true, function (fa) {w[fa] = 1;});
        }
        function z(fa, ga, ha, ia) {
            var ja;
            if (/^_/.test(ha)) {ja = 'hide';}
            else if (w && !w[ga])ja = x;
            switch (ja) {
                case 'hide':
                    return;
                case 'stub':
                    return function () {p.warn('The method FB.%s has been removed from the JS SDK.', ga);};
                    break;
                default:
                    return m.guard(function () {
                        ...
                        var ka = ES5(Array.prototype.slice.call(arguments), 'map', true, function (ra) {return typeof ra === 'function' && /^function/.test(ra.toString()) ? m.unguard(ra) : ra;}), la = fa.apply(ia, ka), ma, na = true;
        ...
        j(u, {_apiKey: null, _authResponse: null, _userStatus: 'unknown', _logging: true, _inCanvas: ba, _https: da, onlyUseHttps: function () {return u._https === true;}, onlyUseHttp: function () {return u._https === false && location.protocol == 'http:';}, _locale: null, _localeIsRtl: false, getDomain: function (fa, ga) {
            ...
            if (u._logging)if (window.Debug && window.Debug.writeln) {window.Debug.writeln(fa);}
            else if (window.console)window.console.log(fa);
            if (u.Event)u.Event.fire('fb.log', fa);
        }, $: function (fa) {return document.getElementById(fa);}, dotAccess: i, Runtime: t, guard: m.guard, unguard: m.unguard, wrapFunction: l, safeEval: k});
    ...
    __d("sdk.Canvas.IframeHandling", ["sdk.Runtime", "Log", "sdk.RPC", "sdk.computeContentSize"], function (a, b, c, d, e, f) {
        ...
        i.stub('setSize');
        var o = {setSize: m, setAutoGrow: n, setAutoResize: function () {h.error('FB.setAutoResize() is no longer functional and will be ' + 'removed on September 5th. This code will throw an exception then. ' + 'Use FB.setAutoGrow() instead.');}};
        e.exports = o;
    });
    ...
    FB.provide('Content', {_root: null, _hiddenRoot: null, append: function (a, b) {
        ...
        if (document.attachEvent) {
            ...
            if (a.width !== undefined)if (a.width == '100%') {g.style.width = a.width;}
    ...
    __d("XDM", ["copyProperties", "guid", "DOMEventListener", "DOMWrapper", "Flash", "Log", "UserAgent"], function (a, b, c, d, e, f) {
        ...
        r.register('fragment', (function () {
            ...
            function v(w) {
                ...
                var y = i.add(x, 'load', function () {
                    y.remove();
                    setTimeout(function () {x.parentNode.removeChild(x);}, 5000);
                });
                t.appendChild(x);
                x.src = w;
            }

            return {isAvailable: function () {return true;}, init: function (w) {
        ...
        r.register('flash', (function () {
            ...
            return {isAvailable: function () {return k.checkMinVersion('8.0.24');}, init: function (y) {
                ...
                x = setTimeout(function () {l.warn('The Flash component did not load within %s ms - ' + 'verify that the container is not set to hidden or invisible ' + 'using CSS as this will cause some browsers to not load ' + 'the components', w);}, w);
                s = true;
            }};
        })());
        r.register('postmessage', (function () {
            var s = false;
            return {isAvailable: function () {return !!p.postMessage;}, init: function (t) {
                ...
                var u = '_FB_' + t.channel, v = {send: function (w, x, y, z) {
                    ...
                    var aa = function () {y.postMessage('_FB_' + z + w, x);};
                    if (m.ie() == 8) {setTimeout(aa, 0);}
                    else aa();
                }};
                if (s) {
                    t.whenReady(v);
    ...
    __d("sdk.XD", ["guid", "resolveWindow", "wrapFunction", "FB", "XDM", "Log", "QueryString", "Queue", "URL", "sdk.RPC", "sdk.Runtime", "XDConfig"], function (a, b, c, d, e, f) {
        ...
        function fa(la, ma) {
            ...
            switch (la.xd_action) {
                case 'proxy_ready':
                    ...
                    oa.start(function (ra) {aa.send(typeof ra === 'string' ? ra : n.encode(ra), ma, pa.contentWindow, y + '_' + na);});
                    break;
                case 'plugin_ready':
        ...
        function ga(la, ma) {
            ...
            if (typeof la == 'string') {
                ...
                if (la.substring(0, 1) == '{') {
                    try {la = ES5('JSON', 'parse', false, la);}
                    catch (na) {
        ...
        q.getOutQueue().start(function (la) {ja('facebook', 'FB_RPC:' + la);});
        var ka = {rpc: q, _callbacks: {}, _forever: {}, _channel: y, _origin: z, onMessage: ga, recv: ga, init: function (la, ma) {
            ...
            ba = true;
        }, sendToFacebook: ja, inform: function (la, ma, na, oa, pa) {ja('facebook', {method: la, params: ES5('JSON', 'stringify', false, ma || {}), behavior: pa || 'p', relation: na});}, handler: function (la, ma, na, oa) {
            oa = oa || h();
    ...
    FB.provide('UIServer', {Methods: {}, _loadedNodes: {}, _defaultCb: {}, _resultToken: '"xxRESULTTOKENxx"', _forceHTTPS: false, genericTransform: function (a) {
        ...
        b(a);
    }, _xdResult: function (a, b, c, d) {return (FB.UIServer._xdNextHandler(function (e) {a && a(e.result && e.result != FB.UIServer._resultToken && ES5('JSON', 'parse', false, e.result));}, b, c, d) + '&result=' + encodeURIComponent(FB.UIServer._resultToken));}});
    FB.provide('', {getLoginStatus: function (a, b) {
    ...
    }, getAuthResponse: function () {return FB._authResponse;}, getAccessToken: function () {return (FB._authResponse && FB._authResponse.accessToken) || null;}, getUserID: function () {return FB._userID;}, login: function (a, b) {
        ...
        FB.Auth.login(a, b);
    }, logout: function (a) {FB.ui({method: 'auth.logout', display: 'hidden'}, a);}});
    FB.provide('Auth', {_callbacks: [], _xdStorePath: 'xd_localstorage/', login: function (a, b) {FB.ui(FB.copy({method: 'permissions.oauth', display: FB.require('SDKConfig').useAsync && FB._inCanvas ? 'async' : 'popup', domain: location.hostname}, b || {}), a);}, fetchLoginStatus: function (a) {
        if (FB.UA.mobile() && window.postMessage && window.localStorage) {FB.Auth.staticAuthCheck(a);}
        ...
        if (FB.Auth._loadState && a)FB.Auth._refreshTimer = window.setTimeout(function () {FB.getLoginStatus(null, true);}, 1200000);
        return j;
        ...
        return 1;
    }, xdHandler: function (a, b, c, d, e) {return FB.UIServer._xdNextHandler(FB.Auth.xdResponseWrapper(a, d, e), b, c, true);}, xdResponseWrapper: function (a, b, c) {
        return function (d) {
            if (d && d.access_token) {
            ...
            else if (!FB._authResponse && b) {FB.Auth.setAuthResponse(b, 'connected');}
            else if (c === 'logout' || c === 'login_status') {
                var h;
                if (d.error && d.error === 'not_authorized') {h = 'not_authorized';}
                else h = 'unknown';
    ...
    FB.provide('UIServer.Methods', {'permissions.oauth': {url: 'dialog/oauth', size: {width: (FB.UA.mobile() ? null : 627), height: (FB.UA.mobile() ? null : 326)}, transform: function (a) {
        ...
        else if (!FB._authResponse) {FB.log('FB.logout() called without an access token.');}
        else {
    ...
    FB.provide('UIServer.Methods', {'stream.share': {size: {width: 670, height: 340}, url: 'sharer.php', transform: function (a) {
        ...
        return a;
    }, getXdRelation: function (a) {return FB.UIServer.MobileIframableMethod.getXdRelation(a);}}, feed: FB.UIServer.MobileIframableMethod});
    ...
    FB.Class('XFBML.IframePlugin', function (a, b) {
        ...
        function d(m) {FB.Event.fire('xfbml.resize', {width: m.width, height: m.height, pluginID: FB.XFBML.getAttr(a, 'plugin-id')});}

        var e = {string: function (m) {return m;}, bool: function (m) {return (/^(?:true|1|yes|on)$/i).test(m);}, url: function (m) {return FB.URI.resolve(m);}, px: function (m) {return (/^(\d+)(?:px)?$/).test(m) ? parseInt(RegExp.$1, 10) : undefined;}};
        ...
        i.locale = FB._locale;
        i.sdk = 'joey';
        var j = ES5(function (m) {this.fire('xd.' + m.type, m);}, 'bind', true, this);
        i.channel = FB.XD.handler(j, 'parent.parent', true);
        var k = FB.guid();
        this.subscribe('xd.verify', function (m) {FB.XD.sendToFacebook(k, {method: 'xd/verify', params: ES5('JSON', 'stringify', false, m.token), behavior: FB.Arbiter.BEHAVIOR_PERSISTENT});});
    ...
    FB.Class('XFBML.Element', function (a, b) {this.dom = a;}, FB.copy({getAttribute: function (a, b, c) {
    ...
    }, getEnabled: function () {return FB.Cookie._enabled;}, loadMeta: function () {
    ...
    FB.provide('', {initSitevars: {}, init: function (a) {
        ...
        if (FB.XFBML && a.xfbml) {
            ...
            window.setTimeout(function () {
                if (FB.initSitevars.parseXFBMLBeforeDomReady) {
                    FB.XFBML.parse();
                    var d = window.setInterval(function () {FB.XFBML.parse();}, 100);
        ...
        if (!FB._initialized) {
            ...
            FB.Runtime.subscribe('AccessToken.change', function (d) {if (!d && FB.Runtime.getLoginStatus() === 'connected')FB.getLoginStatus(null, true);});
        }
    }});
    window.setTimeout(function () {
    ...
    FB.provide('TemplateData', {_initialized: false, _version: 0, _response: null, _localStorageTimeout: 60 * 60 * 24, _enabled: true, enabled: function () {return FB.TemplateData._enabled && FB.TemplateData._initialized && FB.TemplateData.supportsLocalStorage() && FB._userStatus == 'connected' && FB.TemplateData.getResponse();}, supportsLocalStorage: function () {
    ...
    FB.subclass('XFBML.ActivityLog', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        ...
        return true;
    }, getUrlBits: function () {return {name: 'activity_log', params: this._attr};}});
    ...
    FB.subclass('XFBML.ProfilePic', 'XFBML.Element', null, {process: function () {
        ...
        FB.Event.monitor('auth.statusChange', ES5(this, 'bind', true, function () {
            ...
            if (FB._userStatus && f) {FB.Data._selectByIndex(['name', b], FB.Helper.isUser(f) ? 'user' : 'profile', FB.Helper.isUser(f) ? 'uid' : 'id', f).wait(g);}
            else g();
        }));
    }});
