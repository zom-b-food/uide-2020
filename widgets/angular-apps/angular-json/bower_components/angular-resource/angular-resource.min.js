...
(function (J, f, C) {
    ...
    function D(t, e) {
        e = e || {};
        f.forEach(e, function (f, k) {delete e[k]});
    ...
    f.module("ngResource", ["ng"]).provider("$resource", function () {
        ...
        this.$get = ["$http", "$log", "$q", function (k, F, G) {
            ...
            function z(l, g, s, h) {
                ...
                function H(a) {return a.resource}

                function d(a) {D(a || {}, this)}
                    ...
                    d[q] = function (b, A, m, e) {
                        ...
                        n = k(v).then(function (b) {
                            ...
                            if (c) {
                                ...
                                a.isArray ? (p.length = 0, u(c, function (b) {"object" === typeof b ? p.push(new d(b)) : p.push(b)})) : (D(c, p), p.$promise = m)
                            }
                            p.$resolved = !0;
                            b.resource = p;
                            return b
                ...
                d.bind = function (a) {return z(l, r({}, g, a), s)};
                return d
            }
            ...
            w.prototype = {setUrlParams: function (l, g, e) {
                ...
                u(h.urlParams, function (a, e) {
                    ...
                    f.isDefined(k) && null !== k ? (d = encodeURIComponent(k).replace(/%40/gi, "@").replace(/%3A/gi, ":").replace(/%24/g, "$").replace(/%2C/gi, ",").replace(/%20/g, "%20").replace(/%26/gi, "&").replace(/%3D/gi, "=").replace(/%2B/gi, "+"), c = c.replace(new RegExp(":" + e + "(\\W|$)", "g"), function (b, a) {return d + a})) : c = c.replace(new RegExp("(/?):" + e + "(\\W|$)", "g"), function (b, a, c) {return"/" == c.charAt(0) ? c : a + c})
                });
                h.defaults.stripTrailingSlashes && (c = c.replace(/\/+$/, "") || "/");
                c = c.replace(/\/\.(?=\w+($|\?))/, ".");
                l.url = r + c.replace(/\/\\\./, "/.");
                u(g, function (a, c) {h.urlParams[c] || (l.params = l.params || {}, l.params[c] = a)})
            }};
            return z
        }]
    })
