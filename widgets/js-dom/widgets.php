...
<link type="text/css" rel="stylesheet" href="/widgets/js-dom/widget.css"/>
<style type="text/css">
    label.flushleft {
        font-size: 1.25em;
        white-space: nowrap;
...
<script type="text/javascript">
    ...
    <div id="container">
        ...
        <p>Dynamic widget that builds a URL based on user input from two select fields and then writes an array of
            itself with clickable links built at runtime that opens content in a lightwindow.
        </p>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="1" height="144px;">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="enable" id="select2" class="select2" multiple=""
                                                            size="2">
