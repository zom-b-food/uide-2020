<div class="container animated fadeInUp">
    <div class="mb-30">
        ...
        <p class="section-sub">Have a job opportunity you want to discuss? Or maybe ideas about
            creating
            your own site? Maybe a redesign? Some new functionality? Or something new altogether?
            I'd
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <iframe id="contact" class="contact-info" width="100%" height="580" src="../contact/index.php"
            ...
            <address>
                ...
                <div class="mail">
                    ...
                    <p>
                        ...
                        <a href="http://www.myuikit.com" target="_blank">www.myuikit.com</a>
                    </p>
                </div>
            </address>
        </div>
