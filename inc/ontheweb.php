            ...
            <div class="col-sm">
                <div class="border-box">
                    <a href="http://www.adam-marsh.com" target="_blank">
                        <img src="/dist/img/a-m.jpg" alt="clients">
                    </a>
                    <p class="text-center"><a href="http://www.adam-marsh.com" target="_blank">www.adam-marsh.com</a>
                    </p>
                </div>
            </div>
            <div class="col-sm">
                <div class="border-box">
                    <a href="http://www.myuikit.com" target="_blank">
                        <img src="/dist/img/uikit.jpg" alt="clients">
                    </a>
                    <p class="text-center"><a href="http://www.myuikit.com" target="_blank">www.myuikit.com</a>
                    </p>
                </div>
            </div>
            <div class="col-sm">
            ...
            <div class="col-sm">
                <div class="border-box">
                    <a href="http://www.thefogandwave.com" target="_blank">
                        <img src="/dist/img/m-b.jpg" alt="clients">
                    </a>
                    <p class="text-center"><a href="http://www.thefogandwave.com"
                            target="_blank">www.thefogandwave.com</a>
                    </p>
                </div>
            </div>
        </div>
