...
<head>
	...
	<%@ include file="/pages/demos/demoIncs.jsp" %>
...
<div class="footer">
	...
	<div class="grid10">
		...
		<div class="col9">
			<a href="/"><img src="${contextPath}/resources/images/ui/logo.jpg" alt="Adam Marsh" class="footer-logo"></a>
		</div>
	</div>
	<div class="grid10">
