    ...
    grunt.initConfig({
        ...
        cssc: {
            build: {
                ...
                files: {
                    'assets/css/wp1.min.css': 'assets/css/wp1.css',
                    'assets/css/wp1-components.min.css': 'assets/css/wp1-components.css'
                }
            }
        },
        ...
        sass: {
            build: {
                files: {
                    'assets/css/wp1.css': 'assets/scss/wp1.scss',
                    'assets/css/wp1-components.css': 'assets/scss/components.scss'
