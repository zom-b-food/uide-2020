...
final class OE_Menu_Icons_Settings {
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfuly updated.', 'ocean-extra' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfuly reset.', 'ocean-extra' ),
		);
