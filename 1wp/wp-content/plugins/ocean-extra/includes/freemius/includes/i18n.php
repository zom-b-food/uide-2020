<?php
	...
	$fs_text = array(
		...
		'email-updated-message'                    => _fs_text( 'Your email was successfuly updated. You should receive an email with confirmation instructions in few moments.' ),
		'name-updated-message'                     => _fs_text( 'Your name was successfuly updated.' ),
		'x-updated'                                => _fs_text( 'You have successfuly updated your %s.' ),
		...
		'premium-activated-message'                => _fs_text( 'Premium %s version was successfuly activated.' ),
		'successful-version-upgrade-message'       => _fs_text( 'The upgrade of %s was successfuly completed.' ),
		'activation-with-plan-x-message'           => _fs_text( 'Your account was successfuly activated with the %s plan.' ),
		...
		'addon-successfuly-purchased-message'     => _fs_x( '%s Add-on was successfuly purchased.',
			'%s - product name, e.g. Facebook add-on was successfuly...' ),
		'addon-successfuly-upgraded-message'      => _fs_text( 'Your %s Add-on plan was successfuly upgraded.' ),
		'email-verified-message'                   => _fs_text( 'Your email has been successfuly verified - you are AWESOME!' ),
		'plan-upgraded-message'                    => _fs_text( 'Your plan was successfuly upgraded.' ),
		'plan-changed-to-x-message'                => _fs_text( 'Your plan was successfuly changed to %s.' ),
		...
		'trial-started-message'                    => _fs_text( 'Your trial has been successfuly started.' ),
		'license-activated-message'                => _fs_text( 'Your license was successfuly activated.' ),
		'no-active-license-message'                => _fs_text( 'It looks like your site currently doesn\'t have an active license.' ),
		'license-deactivation-message'             => _fs_text( 'Your license was successfuly deactivated, you are back to the %s plan.' ),
		...
		'plan-x-downgraded-message'                => _fs_text( 'Your plan was successfuly downgraded. Your %s plan license will expire in %s.' ),
		...
		'trial-cancel-message'                     => _fs_text( 'Your %s free trial was successfuly cancelled.' ),
		...
		'curl-missing-sysadmin-desc'               => _fs_text( 'Great, please install cURL and enable it in your php.ini file. In addition, search for the \'disable_functions\' directive in your php.ini file and remove any disabled methods starting with \'curl_\'. To make sure it was successfuly activated, use \'phpinfo()\'. Once activated, deactivate the %s and reactivate it back again.' ),
		...
		'plugin-x-activation-message'              => _fs_x( '%s activation was successfuly completed.',
			'pluginX activation was successfuly...' ),
		...
		'addon-trial-cancelled-message'            => _fs_text( '%s free trial was successfuly cancelled. Since the add-on is premium only it was automatically deactivated. If you like to use it in the future, you\'ll have to purchase a license.' ),
		#endregion
		#--------------------------------------------------------------------------------
