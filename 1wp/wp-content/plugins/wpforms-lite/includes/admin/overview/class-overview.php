	...
	public function notices() {
		...
		if ( $deleted && 'error' !== $deleted ) {
			$notice = array(
				...
				'msg'  => sprintf( _n( '%s form was successfuly deleted.', '%s forms were successfuly deleted.', $deleted, 'wpforms-lite' ), $deleted ),
			);
		}
		...
		if ( $duplicated && 'error' !== $duplicated ) {
			$notice = array(
				...
				'msg'  => sprintf( _n( '%s form was successfuly duplicated.', '%s forms were successfuly duplicated.', $duplicated, 'wpforms-lite' ), $duplicated ),
			);
		}
