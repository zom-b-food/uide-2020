...
class WPForms_Tools {
					...
					<p>
						...
						printf(
							wp_kses(
								...
								__( 'Import was successfuly finished. You can go and <a href="%s">check your forms</a>.', 'wpforms-lite' ),
								array(
									'a' => array(
										'href' => array(),
									),
		...
		<div id="wpforms-importer-process">
			...
			<p class="process-completed">
				...
				printf(
					...
					esc_html__( 'Congrats, the import process has finished! We have successfuly imported %s forms. You can review the results below.', 'wpforms-lite' ),
	...
	public function system_info_tab() {
		...
		<div class="wpforms-setting-row tools">
			...
			<p><?php esc_html_e( 'Click the button below to verify your web server can perform SSL connections successfuly.', 'wpforms-lite' ); ?></p>
