	...
	<?php
		...
		$data = array(
			...
			'strings'               => array(
				...
				'success_subtitle'      => __( 'We have successfuly completed the installation of the items you selected. You may now proceed to your WordPress dashboard and start managing your site.', 'siteground-wizard' ),
