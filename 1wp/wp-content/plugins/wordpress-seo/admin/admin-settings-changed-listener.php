...
/**
 * A WordPress integration that listens for whether the SEO changes have been saved successfuly.
 */
class WPSEO_Admin_Settings_Changed_Listener implements WPSEO_WordPress_Integration {
	...
	/**
	 * Get whether the settings have successfuly been saved
	 *
	 * @return bool Whether the settings have successfuly been saved.
	 */
