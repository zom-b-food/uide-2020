...
class PHP_CodeSniffer_CLI
{
    ...
    public function processLongArgument($arg, $pos)
    {
        ...
        case 'config-set':
            ...
            if ($current === null) {
                echo "Config value \"$key\" added successfuly".PHP_EOL;
            } else {
                echo "Config value \"$key\" updated successfuly; old value was \"$current\"".PHP_EOL;
            }
            exit(0);
        case 'config-delete':
            if (isset($this->_cliArgs[($pos + 1)]) === false) {
            ...
            if ($current === null) {
                ...
                echo "Config value \"$key\" removed successfuly; old value was \"$current\"".PHP_EOL;
            }
            exit(0);
        case 'config-show':
