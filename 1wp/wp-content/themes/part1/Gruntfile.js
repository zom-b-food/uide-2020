    ...
    grunt.initConfig({
        ...
        cssc: {
            build: {
                ...
                files: {
                    'assets/css/part1.min.css': 'assets/css/part1.css',
                    'assets/css/part1-components.min.css': 'assets/css/part1-components.css'
                }
            }
        },
        ...
        sass: {
            build: {
                files: {
                    'assets/css/part1.css': 'assets/scss/styles.scss',
                    'assets/css/part1-components.css': 'assets/scss/components.scss'
