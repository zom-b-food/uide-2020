    ...
    grunt.initConfig({
        ...
        cssc: {
            build: {
                ...
                files: {
                    'assets/css/part3.min.css': 'assets/css/part3.css',
                    'assets/css/part3-components.min.css': 'assets/css/part3-components.css'
                }
            }
        },
        ...
        sass: {
            build: {
                files: {
                    'assets/css/part3.css': 'assets/scss/styles.scss',
                    'assets/css/part3-components.css': 'assets/scss/components.scss'
