    ...
    grunt.initConfig({
        ...
        cssc: {
            build: {
                ...
                files: {
                    'assets/css/part2.min.css': 'assets/css/part2.css',
                    'assets/css/part2-components.min.css': 'assets/css/part2-components.css'
                }
            }
        },
        ...
        sass: {
            build: {
                files: {
                    'assets/css/part2.css': 'assets/scss/styles.scss',
                    'assets/css/part2-components.css': 'assets/scss/components.scss'
