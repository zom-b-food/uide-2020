                 ...
                 <div class="row">
                     <div class="col-6">
                         <div class="input-group buttons">
                             <button type="button" class="btn btn-default btn-sm float-left" style="">Cancel</button>

                         </div>
                     </div>
                     <div class="col-6">
                         <div class="input-group buttons">
                             <button type="submit" class="btn btn-primary btn-sm float-right" style="">Submit</button>
                         </div>
                     </div>
                 </div>
                 <hr />
                                 ...
                                 <div class="row">
                                     <div class="col-5">
                                         ...
                                         <p>First Given Name: <span class="bold">Bart</span><br />
                                             ...
                                             Additional Phone: <span class="bold">154-985-9898</span><br />
