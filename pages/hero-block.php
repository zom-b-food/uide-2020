    ...
    <body id="top" class="has-header-search">
                                    ...
                                    <div class="megamenu-row">
                                        ...
                                        <div class="col3">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="shortcode-hero-block.html">Hero Block</a></li>
            ...
            <div class="container">
                <div class="row equal-height-row">
                    ...
                    <div class="col-md-5 hero-thumb equal-height-column">
                        <img src="../dist/img/mockup/ipad.png" class="img-responsive " alt="Image">
                    </div>
                </div>
            </div><!-- /.container -->
        </section>
        ...
        <section class="banner-5 bg-fixed parallax-bg overlay dark-5 padding-top-100" data-stellar-background-ratio="0.5">
            ...
            <div class="mocup-wrapper text-center">
                <img src="../dist/img/mockup/mockup.png" alt="">
            </div>
        </section>
        ...
        <div class="container section-padding">
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="../dist/img/mockup/ipad-2.png" class="img-responsive " alt="Image">
                </div>
            </div>
        </div><!-- /.container -->
