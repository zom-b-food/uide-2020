...
<body id="top" class="has-header-search">
								...
								<div class="megamenu-row">
									<div class="col3">
										...
										<ul class="list-unstyled clearfix">
											...
											<li><a href="op-index-coffeeshop.html" target="_blank">Home
													Coffee Shop</a></li>
										</ul>
									</div>
									<div class="col3">
										...
										<ul class="list-unstyled clearfix">
											<li><a href="creative-index.html" target="_blank">Creative
													Demo</a></li>
											<li><a href="corporate-index.html" target="_blank">Corporate
													Demo</a></li>
											<li><a href="agency-index.html" target="_blank">Agency Demo</a>
											</li>
											<li><a href="construction-index.html"
													target="_blank">Construction Demo</a></li>
											<li><a href="seo-index.html" target="_blank">SEO Demo</a></li>
											<li><a href="restaurant-index.html" target="_blank">Restaurant
													Demo</a></li>
										</ul>
									</div>
									<div class="col3">
										<h2>Onepage Demo</h2>
										<ul class="list-unstyled clearfix">
											<li><a href="op-index-1.html" target="_blank">materialize
													Onepage</a></li>
											<li><a href="op-index-portfolio.html" target="_blank">Onepage
													Portfoilo</a></li>
											<li><a href="op-index-event.html" target="_blank">Onepage
													Event</a></li>
											<li><a href="op-index-book.html" target="_blank">Book Landing
													Page</a></li>
											<li><a href="op-index-app.html" target="_blank">App Landing Page
													1</a></li>
											<li><a href="op-index-app-2.html" target="_blank">App Landing
													Page 2</a></li>
										</ul>
									</div>
									<div class="col3">
										...
										<ul class="list-unstyled clearfix">
											...
											<li><a href="coming-soon-1.html" target="_blank">Coming Soon
													One</a></li>
											<li><a href="coming-soon-2.html" target="_blank">Coming Soon
													Two</a></li>
										</ul>
									</div>
							...
							<ul class="dropdown">
								<li><a href="#">Sliders</a>
									<ul class="dropdown">
										<li><a href="#">Slider Revolution</a>
											<ul class="dropdown">
												<li><a href="slider-revoulation-fullscreen.html">Full
														Screen</a></li>
												<li><a href="slider-revoulation-fullwidth.html">Full
														Width</a></li>
												<li><a href="slider-revoulation-kenburns.html">Kenburns</a>
												</li>
											</ul>
										</li>
										<li><a href="#">Parallax</a>
											<ul class="dropdown">
												<li><a href="slider-revoulation-parallax-1.html">Parallax
														Slider</a></li>
												<li><a href="slider-revoulation-parallax-book.html">Parallax
														Book</a></li>
											</ul>
										</li>
										...
										<li><a href="#">Hero Unit</a>
											<ul class="dropdown">
												...
												<li><a href="hero-static-left.html">Hero Static Left</a>
												</li>
												<li><a href="hero-static-right.html">Hero Static Right</a>
												</li>
											</ul>
										</li>
								...
								<li><a href="#">Menu Style Group 1</a>
									<ul class="dropdown">
										...
										<li><a href="agency-index.html" target="_blank">Full Screen Menu</a>
										</li>
									</ul>
								</li>
								...
								<li><a href="#">Wide Style</a>
									<ul class="dropdown">
										...
										<li><a href="#">Wide Gutter Less</a>
											<ul class="dropdown">
												<li><a href="portfolio-6-fullwidth-gutterless.html">6
														Column</a></li>
												<li><a href="portfolio-5-fullwidth-gutterless.html">5
														Column</a></li>
												<li><a href="portfolio-4-fullwidth-gutterless.html">4
														Column</a></li>
												<li><a href="portfolio-3-fullwidth-gutterless.html">3
														Column</a></li>
												<li><a href="portfolio-2-fullwidth-gutterless.html">2
														Column</a></li>
											</ul>
										</li>
									</ul>
								...
								<li><a href="#">Card Style</a>
									<ul class="dropdown">
										...
										<li><a href="#">Card Full Width</a>
											<ul class="dropdown">
												<li><a href="portfolio-card-6-fullwidth.html">6 Column</a>
												</li>
												<li><a href="portfolio-card-5-fullwidth.html">5 Column</a>
												</li>
												<li><a href="portfolio-card-4-fullwidth.html">4 Column</a>
												</li>
											</ul>
										</li>
									</ul>
								...
								<li><a href="#">Title Style</a>
									<ul class="dropdown">
										...
										<li><a href="#">Title Width Style</a>
											<ul class="dropdown">
												<li><a href="portfolio-title-5-fullwidth.html">5 Column</a>
												</li>
												<li><a href="portfolio-title-4-fullwidth.html">4 Column</a>
												</li>
												<li><a href="portfolio-title-3-fullwidth.html">3 Column</a>
												</li>
												<li><a href="portfolio-title-2-fullwidth.html">2 Column</a>
												</li>
											</ul>
										</li>
									</ul>
								...
								<li><a href="#">Masonry Style</a>
									<ul class="dropdown">
										...
										<li><a href="#">Masonry Full Width</a>
											<ul class="dropdown">
												<li><a href="portfolio-masonry-3-fullwidth.html">3
														Column</a></li>
												<li><a href="portfolio-masonry-2-fullwidth.html">2
														Column</a></li>
											</ul>
										</li>
										<li><a href="#">Masonry Gutter Less</a>
											<ul class="dropdown">
												<li><a href="portfolio-masonry-3-gutterless.html">3
														Column</a></li>
												<li><a href="portfolio-masonry-2-gutterless.html">2
														Column</a></li>
											</ul>
										</li>
										<li><a href="#">Masonry Gutterless Full</a>
											<ul class="dropdown">
												<li><a href="portfolio-masonry-3-gutterless-full.html">3
														Column</a></li>
												<li><a href="portfolio-masonry-2-gutterless-full.html">2
														Column</a></li>
											</ul>
										</li>
									</ul>
							...
							<ul class="dropdown">
								...
								<li><a href="#">Masonry</a>
									<ul class="dropdown ">
										...
										<li><a href="blog-grid-masonry-2-sidebar.html">Masonry 2 Sidebar</a>
										</li>
										<li><a href="blog-grid-masonry-3.html">Masonry 3 Column</a></li>
										<li><a href="blog-grid-masonry-4.html">Masonry 4 Column</a></li>
										<li><a href="blog-grid-masonry-4-fullwidth.html">Masonry Fullwidth</a>
										</li>
									</ul>
								</li>
								...
								<div class="megamenu-row">
									<div class="col3">
										...
										<ul class="list-unstyled">
											...
											<li class="active"><a href="shortcode-clients.html">Clients</a>
											</li>
										</ul>
									</div>
									<div class="col3">
	...
	<section class="page-title ptb-50">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>Shortcode Clients</h2>
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li><a href="#">Shortcodes</a></li>
						<li class="active">Shortcode Clients</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<section class="section-padding">
		<div class="container">
			<div class="text-center mb-80">
				...
				<p>Clients &amp; Brands Gutter Style</p>
			</div>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/intel.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/envato.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/studio.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/google.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
				</div><!-- /.row -->
	...
	<!-- gutter-less style start -->
	<section class="padding-bottom-100">
		<div class="container">
			<div class="text-center mb-80">
				<h2>Clients &amp; Brands</h2>
				<p>Clients &amp; Brands No Gutter</p>
			</div>
	...
	<!-- gutter-less style end -->


	<!-- grid gutter style start -->
	<section class="padding-bottom-100">
		<div class="container">
			<div class="text-center mb-80">
				<h2>Clients &amp; Brands</h2>
				<p>Clients &amp; Brands Grid Gutter Style</p>
			</div>
			...
			<div class="clients-grid grid-gutter">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/kp.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/dell.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/sw.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
					...
					<div class="col-md-3 col-sm-6">
						<div class="border-box">
							<a href="#">
								<img src="../dist/img/client-logo/hp.png" alt="clients">
							</a>
						</div><!-- /.border-box -->
					</div><!-- /.col-md-3 -->
	...
	<section class="padding-bottom-100">
		<div class="container">
			<div class="text-center mb-80">
				<h2>Clients &amp; Brands</h2>
				<p>Clients &amp; Brands Grid No Gutter</p>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<span class="copy-text">Copyright &copy; 2016 <a href="#">Materialize</a> &nbsp; | &nbsp;
							All Rights Reserved &nbsp; | &nbsp; Designed By <a href="#">TrendyTheme</a></span>
						<div class="footer-intro">
							<p>Penatibus tristique velit vestibulum adipiscing habitant aenean feugiat at
								condimentum aptent odio orci vulputate hac mollis a.Vestibulum adipiscing
								gravida justo a ac euismod vitae.</p>
						</div>
					</div><!-- /.col-md-12 -->
				</div><!-- /.row -->
			</div><!-- /.container -->
